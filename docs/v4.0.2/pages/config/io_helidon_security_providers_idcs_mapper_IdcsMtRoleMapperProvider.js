...
<dl>
<dt slot=title><span class="merged" id="all.1Bb0lk" title="原文 : IdcsMtRoleMapperProvider (security.providers.idcs.mapper) Configuration">IdcsMtRoleMapperProvider (security.providers.idcs.mapper)構成</span></dt>
...
<p><span class="merged" id="all.31kiUh.6" title="原文 : This type provides the following service implementations:">このタイプでは、次のサービス実装が提供されます:</span></p>
...
<thead>
<tr>
<th><span class="merged" id="all.2XKMH3.59"  title="原文:: key">キー</span></th>
<th><span class="merged" id="all.2ZwVVB.59"  title="原文:: type">タイプ</span></th>
<th><span class="merged" id="all.G3u1e.59"  title="原文:: default value">デフォルト値</span></th>
<th><span class="merged" id="all.20ls8M.59"  title="原文:: description">説明</span></th>
</tr>
</thead>
<tbody>
<tr>
...
<td class="">&#160;</td>
<td class=""><doc-view>
<p><span class="merged" id="all.d3OFQ.spl1" title="原文 : Configure token handler for IDCS Application name.">IDCSアプリケーション名のトークン・ハンドラを構成します。</span> <span class="merged" id="all.d3OFQ.spl2" title="原文 : By default the header IdcsMtRoleMapperProvider#IDCS_APP_HEADER is used.">デフォルトでは、ヘッダー<code>IdcsMtRoleMapperProvider#IDCS_APP_HEADER</code>が使用されます。</span> </p>
...
<td class="">&#160;</td>
<td class=""><doc-view>
<p><span class="merged" id="all.23oLhn.spl1" title="原文 : Configure token handler for IDCS Tenant ID.">IDCSテナントIDのトークン・ハンドラを構成します。</span> <span class="merged" id="all.23oLhn.spl2" title="原文 : By default the header IdcsMtRoleMapperProvider#IDCS_TENANT_HEADER is used.">デフォルトでは、ヘッダー<code>IdcsMtRoleMapperProvider#IDCS_TENANT_HEADER</code>が使用されます。</span> </p>
