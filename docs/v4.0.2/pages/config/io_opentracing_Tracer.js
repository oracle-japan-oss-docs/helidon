...
<dl>
<dt slot=title><span class="merged" id="all.2ZSqgl.1" title="原文 : io.opentracing.Tracer Configuration">io.opentracing.Tracer構成</span></dt>
<dd slot="desc"><p><span class="merged" id="all.3AC9OM.1" title="原文 : Zipkin tracer configuration">Zipkinトレーサ構成</span></p>
...
<h2 id="_configuration_options"><span class="merged" id="all.3SKgM1.104"  title="原文:: Configuration options">構成オプション</span></h2>
<div class="section">
...
<th><span class="merged" id="all.2ZwVVB.106"  title="原文:: type">タイプ</span></th>
