...
<dl>
<dt slot=title><span class="merged" id="all.MXtbI" title="原文 : Proxy (webclient.api) Configuration">Proxy (webclient.api)構成</span></dt>
<dd slot="desc"><p><span class="merged" id="all.3oMyT" title="原文 : Type: io.helidon.webclient.api.Proxy">タイプ: <a href="/apidocs/io.helidon.webclient.api/io/helidon/webclient/api/Proxy.html" target="_blank">io.helidon.webclient.api.Proxy</a></span></p>
</dd>
</dl>
</v-card-text>
</v-card>
...
<h2 id="_configuration_options"><span class="merged" id="all.3SKgM1.71"  title="原文:: Configuration options">構成オプション</span></h2>
<div class="section">
...
<th><span class="merged" id="all.2ZwVVB.74"  title="原文:: type">タイプ</span></th>
...
<td class=""><doc-view>
<p><span class="merged" id="all.4XWlEF" title="原文 : ProxyType (NONE, SYSTEM, HTTP)">ProxyType (NONE, SYSTEM, HTTP)</span></p>
