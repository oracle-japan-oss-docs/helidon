...
<dl>
<dt slot=title><span class="merged" id="all.I9TFx" title="原文 : AccessLogFeature (webserver.accesslog) Configuration">AccessLogFeature (webserver.accesslog)構成</span></dt>
<dd slot="desc"><p><span class="merged" id="all.2p0e71" title="原文 : Type: io.helidon.webserver.accesslog.AccessLogFeature">タイプ: <a href="/apidocs/io.helidon.webserver.accesslog/io/helidon/webserver/accesslog/AccessLogFeature.html" target="_blank">io.helidon.webserver.accesslog.AccessLogFeature</a></span></p>
...
<ul class="ulist">
<li>
<p><span class="merged" id="all.1upsag"  title="原文: io.helidon.webserver.spi.ServerFeatureProvider"><code>io.helidon.webserver.spi.ServerFeatureProvider</code></span></p>
...
<h2 id="_configuration_options"><span class="merged" id="all.3SKgM1.81"  title="原文:: Configuration options">構成オプション</span></h2>
<div class="section">
...
<th><span class="merged" id="all.2ZwVVB.84"  title="原文:: type">タイプ</span></th>
...
<td class=""><doc-view>
<p><span class="merged" id="all.1HO27M" title="原文 : Whether this feature will be enabled.">この機能を有効にするかどうか。</span></p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.1k8TO9.spl1" title="原文 : Name of the logger used to obtain access log logger from System#getLogger(String).">System#getLogger(String)からアクセス・ログ・ロガーを取得するために使用するロガーの名前。</span> <span class="merged" id="all.1k8TO9.spl2" title="原文 : Defaults to AccessLogFeature#DEFAULT_LOGGER_NAME.">デフォルトは<code>AccessLogFeature#DEFAULT_LOGGER_NAME</code>です。</span> </p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.V60k5.23"  title="原文:: string[]">string[]</span></p>

</doc-view>
</td>
<td class="">&#160;</td>
<td class=""><doc-view>
<p><span class="merged" id="all.11F0ik.spl1" title="原文 : List of sockets to register this feature on.">この機能を登録するソケットのリスト。</span> <span class="merged" id="all.11F0ik.spl2" title="原文 : If empty, it would get registered on all sockets.">空の場合は、すべてのソケットに登録されます。</span> <span class="merged" id="all.11F0ik.spl3" title="原文 : The logger used will have the expected logger with a suffix of the socket name.">使用するロガーには、ソケット名のサフィクスを持つ予期されるロガーが含まれます。</span> </p>
...
<tr>
<td class=""><span class="merged" id="all.1d5M0z"  title="原文: weight"><code>weight</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.40Xztn.1"  title="原文:: double">double</span></p>

</doc-view>
</td>
<td class=""><span class="merged" id="all.3NqvMr"  title="原文: 1000.0"><code>1000.0</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.5laEM.spl1" title="原文 : Weight of the access log feature.">アクセス・ログ機能の重み。</span> <span class="merged" id="all.5laEM.spl2" title="原文 : We need to log access for anything happening on the server, so weight is high: io.helidon.webserver.accesslog.AccessLogFeature#WEIGHT.">サーバーで何が起こってもアクセスを記録する必要があるため、重みが高くなります: <code>io.helidon.webserver.accesslog.AccessLogFeature#WEIGHT</code>。</span> </p>
