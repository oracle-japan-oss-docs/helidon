...
<dd slot="desc"><p><span class="merged" id="all.1iwYMB" title="原文 : Type: io.helidon.security.providers.httpsign.SignedHeadersConfig.HeadersConfig">タイプ: <a href="/apidocs/io.helidon.security.providers.httpsign.SignedHeadersConfig/io/helidon/security/providers/httpsign/SignedHeadersConfig/HeadersConfig.html" target="_blank">io.helidon.security.providers.httpsign.SignedHeadersConfig.HeadersConfig</a></span></p>
</dd>
</dl>
</v-card-text>
</v-card>
...
<div class="section">
<div class="block-title"><span class="merged" id="all.271SGn.52" title="原文 : Optional configuration options"><span>オプションの構成オプション</span></span></div>
...
<th><span class="merged" id="all.2ZwVVB.58"  title="原文:: type">タイプ</span></th>
