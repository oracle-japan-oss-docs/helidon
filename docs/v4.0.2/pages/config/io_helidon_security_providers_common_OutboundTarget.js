...
<dd slot="desc"><p><span class="merged" id="all.3s0JHY" title="原文 : Type: io.helidon.security.providers.common.OutboundTarget">タイプ: <a href="/apidocs/io.helidon.security.providers.common/io/helidon/security/providers/common/OutboundTarget.html" target="_blank">io.helidon.security.providers.common.OutboundTarget</a></span></p>
</dd>
</dl>
</v-card-text>
</v-card>
...
<th><span class="merged" id="all.2ZwVVB.49"  title="原文:: type">タイプ</span></th>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2uEvOb.90"  title="原文:: string">文字列</span></p>
...
<th><span class="merged" id="all.2ZwVVB.50"  title="原文:: type">タイプ</span></th>
