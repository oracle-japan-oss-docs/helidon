...
<p><span class="merged" id="all.gZT4l" title="原文 : Type: io.helidon.security.providers.header.HeaderAtnProvider">タイプ: <a href="/apidocs/io.helidon.security.providers.header/io/helidon/security/providers/header/HeaderAtnProvider.html" target="_blank">io.helidon.security.providers.header.HeaderAtnProvider</a></span></p>
...
<p><span class="merged" id="all.31kiUh.2" title="原文 : This type provides the following service implementations:">このタイプでは、次のサービス実装が提供されます:</span></p>
...
<h2 id="_configuration_options"><span class="merged" id="all.3SKgM1.48"  title="原文:: Configuration options">構成オプション</span></h2>
<div class="section">
...
<th><span class="merged" id="all.2ZwVVB.52"  title="原文:: type">タイプ</span></th>
