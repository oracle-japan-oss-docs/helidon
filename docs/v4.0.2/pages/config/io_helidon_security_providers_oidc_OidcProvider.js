...
<p><span class="merged" id="all.4HsETo" title="原文 : Type: io.helidon.security.providers.oidc.OidcProvider">タイプ: <a href="/apidocs/io.helidon.security.providers.oidc/io/helidon/security/providers/oidc/OidcProvider.html" target="_blank">io.helidon.security.providers.oidc.OidcProvider</a></span></p>
...
<p><span class="merged" id="all.31kiUh.9" title="原文 : This type provides the following service implementations:">このタイプでは、次のサービス実装が提供されます:</span></p>
...
<th><span class="merged" id="all.2ZwVVB.63"  title="原文:: type">タイプ</span></th>
...
<td class=""><doc-view>
<p><span class="merged" id="all.491Ej4.spl1" title="原文 : Configure base scopes.">ベース・スコープを構成します。</span> <span class="merged" id="all.491Ej4.spl2" title="原文 : By default, this is DEFAULT_BASE_SCOPES.">デフォルトでは、これは<code>DEFAULT_BASE_SCOPES</code>です。</span> <span class="merged" id="all.491Ej4.spl3" title="原文 : If scope has a qualifier, it must be used here.">スコープに修飾子がある場合は、ここで使用する必要があります。</span> </p>

</doc-view>
</td>
</tr>
<tr>
<td class=""><span class="merged" id="all.36JO30"  title="原文: check-audience"><code>check-audience</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.2XHIO8.73"  title="原文:: boolean">boolean</span></p>

</doc-view>
</td>
<td class=""><span class="merged" id="all.42DdBS.20"  title="原文: false"><code>false</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.2EK1u" title="原文 : Configure audience claim check.">オーディエンス要求チェックを構成します。</span></p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2KNkAg.15"  title="原文:: Duration">期間</span></p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2XHIO8.74"  title="原文:: boolean">boolean</span></p>

</doc-view>
</td>
<td class=""><span class="merged" id="all.xEiHU.38"  title="原文: true"><code>true</code></span></td>
<td class=""><doc-view>
...
<tr>
<td class=""><span class="merged" id="all.17Sy2N"  title="原文: cookie-name-tenant"><code>cookie-name-tenant</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.2uEvOb.116"  title="原文:: string">文字列</span></p>

</doc-view>
</td>
<td class=""><span class="merged" id="all.3u8fdb"  title="原文: HELIDON_TENANT"><code>HELIDON_TENANT</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.2Wf1SU.spl1" title="原文 : The name of the cookie to use for the tenant name.">テナント名に使用するcookieの名前。</span> <span class="merged" id="all.2Wf1SU.spl2" title="原文 : Defaults to DEFAULT_TENANT_COOKIE_NAME.">デフォルトは<code>DEFAULT_TENANT_COOKIE_NAME</code>です。</span> </p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2XHIO8.75"  title="原文:: boolean">boolean</span></p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2XHIO8.76"  title="原文:: boolean">boolean</span></p>

</doc-view>
</td>
<td class=""><span class="merged" id="all.xEiHU.39"  title="原文: true"><code>true</code></span></td>
<td class=""><doc-view>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2cqsnT.2" title="原文 : CrossOriginConfig"><router-link to="/config/io_helidon_cors_CrossOriginConfig">CrossOriginConfig</router-link></span></p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2XHIO8.77"  title="原文:: boolean">boolean</span></p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2XHIO8.78"  title="原文:: boolean">boolean</span></p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2XHIO8.79"  title="原文:: boolean">boolean</span></p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.21ZylF.9" title="原文 : Resource"><router-link to="/config/io_helidon_common_configurable_Resource">Resource</router-link></span></p>
...
<tr>
<td class=""><span class="merged" id="all.SQea4"  title="原文: optional-audience"><code>optional-audience</code></span></td>
<td class=""><doc-view>
...
<td class=""><doc-view>
<p><span class="merged" id="all.1nCC5o" title="原文 : Allow audience claim to be optional.">オーディエンス要求をオプションとして許可します。</span></p>
...
<tr>
<td class=""><span class="merged" id="all.11wE92"  title="原文: query-param-tenant-name"><code>query-param-tenant-name</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.2uEvOb.123"  title="原文:: string">文字列</span></p>

</doc-view>
</td>
<td class=""><span class="merged" id="all.3RrrWU"  title="原文: h_tenant"><code>h_tenant</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.ijkRo.spl1" title="原文 : Name of a query parameter that contains the tenant name when the parameter is used.">パラメータの使用時にテナント名を含む問合せパラメータの名前。</span> <span class="merged" id="all.ijkRo.spl2" title="原文 : Defaults to #DEFAULT_TENANT_PARAM_NAME.">デフォルトは#DEFAULT_TENANT_PARAM_NAMEです。</span> </p>
...
<td class=""><span class="merged" id="all.42DdBS.27"  title="原文: false"><code>false</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.4D6cT9.spl1" title="原文 : By default, the client should redirect to the identity server for the user to log in.">デフォルトでは、クライアントは、ユーザーがログインできるようにアイデンティティ・サーバーにリダイレクトする必要があります。</span> <span class="merged" id="all.4D6cT9.spl2" title="原文 : This behavior can be overridden by setting redirect to false.">この動作は、リダイレクトをfalseに設定することでオーバーライドできます。</span> <span class="merged" id="all.4D6cT9.spl3" title="原文 : When token is not present in the request, the client will not redirect and just return appropriate error response code.">トークンがリクエストに存在しない場合、クライアントはリダイレクトされず、適切なエラー・レスポンス・コードを返します。</span> </p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2uEvOb.124"  title="原文:: string">文字列</span></p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2uEvOb.125"  title="原文:: string">文字列</span></p>
...
<td class=""><span class="merged" id="all.42DdBS.28"  title="原文: false"><code>false</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.e1ZPT.spl1" title="原文 : Can be set to true to force the use of relative URIs in all requests, regardless of the presence or absence of proxies or no-proxy lists.">プロキシまたは非プロキシ・リストが存在するかどうかに関係なく、すべてのリクエストで相対URIを強制的に使用するように<code>true</code>に設定できます。</span> <span class="merged" id="all.e1ZPT.spl2" title="原文 : By default, requests that use the Proxy will have absolute URIs.">デフォルトでは、プロキシを使用するリクエストは絶対URIを持ちます。</span> <span class="merged" id="all.e1ZPT.spl3" title="原文 : Set this flag to true if the host is unable to accept absolute URIs.">ホストが絶対URIを受け入れることができない場合は、このフラグを<code>true</code>に設定します。</span> <span class="merged" id="all.e1ZPT.spl4" title="原文 : Defaults to DEFAULT_RELATIVE_URIS.">デフォルトは<code>DEFAULT_RELATIVE_URIS</code>です。</span> </p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2uEvOb.126"  title="原文:: string">文字列</span></p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2uEvOb.127"  title="原文:: string">文字列</span></p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.21ZylF.10" title="原文 : Resource"><router-link to="/config/io_helidon_common_configurable_Resource">Resource</router-link></span></p>
...
<tr>
<td class=""><span class="merged" id="all.468r3F"  title="原文: tenants"><code>tenants</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.H90Jp" title="原文 : TenantConfig"><router-link to="/config/io_helidon_security_providers_oidc_common_TenantConfig">TenantConfig</router-link></span></p>

</doc-view>
</td>
<td class="">&#160;</td>
<td class=""><doc-view>
<p><span class="merged" id="all.LS2k2" title="原文 : Configurations of the tenants">テナントの構成</span></p>
