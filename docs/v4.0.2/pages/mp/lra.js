...
<li>
<p><span class="merged" id="all.1N6U52.11" title="原文 : Maven Coordinates"><router-link @click.native="this.scrollFix('#maven-coordinates')" to="#maven-coordinates">Maven連携</router-link></span></p>
...
<li>
<p><span class="merged" id="all.26FILD.10" title="原文 : Configuration"><router-link @click.native="this.scrollFix('#_configuration')" to="#_configuration">構成</router-link></span></p>
...
<ul class="ulist">
<li>
<p><span class="merged" id="all.2P20Vf" title="原文 : Coordinator"><router-link @click.native="this.scrollFix('#_coordinator')" to="#_coordinator">コーディネータ</router-link></span></p>

</li>
<li>
<p><span class="merged" id="all.ZXOOH" title="原文 : Helidon LRA Coordinator"><router-link @click.native="this.scrollFix('#_helidon_lra_coordinator')" to="#_helidon_lra_coordinator">Helidon LRAコーディネータ</router-link></span></p>

</li>
<li>
<p><span class="merged" id="all.3o9P98" title="原文 : Narayana"><router-link @click.native="this.scrollFix('#_narayana')" to="#_narayana">Narayana</router-link></span></p>
...
<div class="section">
<p><span class="merged" id="all.40L5DP.spl1" title="原文 : Distributed transactions for microservices are known as SAGA design patterns and are defined by the MicroProfile Long Running Actions specification.">マイクロサービスの分散トランザクションはSAGA設計パターンと呼ばれ、<a href="https://download.eclipse.org/microprofile/microprofile-lra-2.0/microprofile-lra-spec-2.0.html" target="_blank">「MicroProfile長時間実行アクションの指定」</a>によって定義されます。</span> <span class="merged" id="all.40L5DP.spl2" title="原文 : Unlike well known XA protocol, LRA is asynchronous and therefore much more scalable.">既知のXAプロトコルとは異なり、LRAは非同期であるため、よりスケーラブルです。</span> <span class="merged" id="all.40L5DP.spl3" title="原文 : Every LRA JAX-RS resource (participant) defines endpoints to be invoked when transaction needs to be completed or compensated.">すべてのLRA JAX-RSリソース(<router-link @click.native="this.scrollFix('#_participant')" to="#_participant">「参加者」</router-link>)は、トランザクションを<em>「完了」</em>または<em>「補償」</em>にする必要がある場合に起動されるエンドポイントを定義します。</span> </p>
...
<div class="section">
<p><span class="merged" id="all.38PYqq" title="原文 : To enable Long Running Actions add the following dependency to your project’s pom.xml (see Managing Dependencies).">Long Running Actionを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<h2 id="_configuration"><span class="merged" id="all.Pfqvy.11"  title="原文:: Configuration">構成</span></h2>
<div class="section">
<markup
lang="text"
title="Type"
...
<td class=""><span class="merged" id="all.2uEvOb.236"  title="原文:: string">文字列</span></td>
<td class=""><span class="merged" id="all.3ksUox.1"  title="原文: http://localhost:8070/lra-coordinator"><code>http://localhost:8070/lra-coordinator</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.2bJERr.1" title="原文 : Url of coordinator.">コーディネータのURL。</span></p>
...
<td class="">&#160;</td>
<td class=""><doc-view>
<p><span class="merged" id="all.1tN1k2.1" title="原文 : Propagate LRA headers LRA_HTTP_CONTEXT_HEADER and LRA_HTTP_PARENT_CONTEXT_HEADER through non-LRA endpoints.">LRA以外のエンドポイントを介して、LRAヘッダー<code>LRA_HTTP_CONTEXT_HEADER</code>および<code>LRA_HTTP_PARENT_CONTEXT_HEADER</code>を伝播します。</span></p>
...
<td class=""><span class="merged" id="all.2uEvOb.237"  title="原文:: string">文字列</span></td>
<td class="">&#160;</td>
<td class=""><doc-view>
<p><span class="merged" id="all.DCZlm.1" title="原文 : Url of the LRA enabled service overrides standard base uri, so coordinator can call load-balancer instead of the service.">LRA対応サービスのURLは標準ベースURIをオーバーライドするため、コーディネータはサービスではなくロード・バランサをコールできます。</span></p>
...
<td class=""><span class="merged" id="all.2uEvOb.238"  title="原文:: string">文字列</span></td>
<td class="">&#160;</td>
<td class=""><doc-view>
<p><span class="merged" id="all.3IBeQU.1" title="原文 : Timeout for synchronous communication with coordinator.">コーディネータとの同期通信のタイムアウト。</span></p>
...
<td class=""><span class="merged" id="all.2uEvOb.239"  title="原文:: string">文字列</span></td>
<td class="">&#160;</td>
<td class=""><doc-view>
<p><span class="merged" id="all.U3036.1" title="原文 : Timeout unit for synchronous communication with coordinator.">コーディネータとの同期通信のタイムアウト単位。</span></p>
...
<p><span class="merged" id="all.46VWPs" title="原文 : For more information continue to MicroProfile Long Running Actions specification.">詳細については、<a href="https://download.eclipse.org/microprofile/microprofile-lra-2.0/microprofile-lra-spec-2.0.html" target="_blank">「MicroProfile長時間実行アクションの指定」</a>を参照してください。</span></p>
...
<h2 id="_additional_information"><span class="merged" id="all.1BotSu.9"  title="原文:: Additional Information">追加情報</span></h2>
<div class="section">

<h3 id="_coordinator"><span class="merged" id="all.2hLDun"  title="原文:: Coordinator">コーディネータ</span></h3>
<div class="section">
...
<h3 id="_helidon_lra_coordinator"><span class="merged" id="all.2Nir8Y" title="原文 : Helidon LRA Coordinator">Helidon LRAコーディネータ</span></h3>
<div class="section">
<div class="admonition caution">
...
<li>
<p><span class="merged" id="all.10RplW" title="原文 : MicroProfile Long Running Actions specification"><a href="https://download.eclipse.org/microprofile/microprofile-lra-2.0/microprofile-lra-spec-2.0.html" target="_blank">MicroProfile長時間実行アクションの指定</a></span></p>
...
<li>
<p><span class="merged" id="all.20BZBX" title="原文 : Helidon LRA Client JavaDoc"><a href="https://helidon.io/docs/v4/apidocs/io.helidon.lra.coordinator.client/module-summary.html" target="_blank">Helidon LRAクライアントJavaDoc</a></span></p>
