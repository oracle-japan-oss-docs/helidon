...
<div class="section">
<p><span class="merged" id="all.3p9NnG" title="原文 : To enable MicroProfile Fault Tolerance either add a dependency on the helidon-microprofile bundle or add the following dependency to your project’s pom.xml (see Managing Dependencies).">MicroProfileフォルト・トレランスを有効にするには、<router-link to="/mp/introduction/microprofile">helidon-microprofile bundle</router-link>に依存関係を追加するか、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<td class=""><span class="merged" id="all.1NFsBE.spl1" title="原文 : Defines an upper bound on a method’s execution time.">メソッドの実行時間の上限を定義します。</span> <span class="merged" id="all.1NFsBE.spl2" title="原文 : Default value is 1 second.">デフォルト値は1秒です。</span> </td>
</tr>
<tr>
<td class=""><doc-view>
<div class="listing">
...
<div class="section">
<p><span class="merged" id="all.1pitOr.spl1" title="原文 : Helidon’s implementation uses two types of thread pools: normal and scheduled.">Helidon実装では、次のタイプのスレッド・プールを使用: 通常およびスケジュール済。</span> <span class="merged" id="all.1pitOr.spl2" title="原文 : The default core size of these executors is 20; however, that can be configured using an application.yaml file as follows:">これらのエグゼキュータのデフォルトのコア・サイズは20ですが、次のように<code>application.yaml</code>ファイルを使用して構成できます:</span> </p>
...
<div class="section">
<p><span class="merged" id="all.4Z5tYy" title="原文 : For additional information about this API, see the MicroProfile Fault Tolerance Javadocs.">このAPIの詳細は、<a href="https://download.eclipse.org/microprofile/microprofile-fault-tolerance-4.0.2/apidocs" target="_blank">「MicroProfileフォルト・トレランスJavadoc」</a>を参照してください。</span></p>
...
<ul class="ulist">
<li>
<p><span class="merged" id="all.BHzKo" title="原文 : MicroProfile Fault Tolerance"><a href="https://download.eclipse.org/microprofile/microprofile-fault-tolerance-4.0.2/microprofile-fault-tolerance-spec-4.0.2.html}" target="_blank">MicroProfileフォルト・トレランス</a></span></p>
