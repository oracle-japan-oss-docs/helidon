...
<h2 id="_overview"><span class="merged" id="all.YrpRV.38"  title="原文:: Overview">概要</span></h2>
<div class="section">
<p><span class="merged" id="all.25RQsS.spl1" title="原文 : Helidon implements MicroProfile Reactive Streams Operators specification which defines reactive operators and provides a standardized tool for manipulation with Reactive Streams.">Helidonは、リアクティブ・オペレータを定義し、<a href="https://www.reactive-streams.org/" target="_blank">「リアクティブ・ストリーム」</a>で操作するための標準化されたツールを提供する<a href="https://download.eclipse.org/microprofile/microprofile-reactive-streams-operators-3.1.1/microprofile-reactive-streams-operators-spec-3.1.1.html" target="_blank">「MicroProfileリアクティブ・ストリーム・オペレータ」</a>仕様を実装します。</span> <span class="merged" id="all.25RQsS.spl2" title="原文 : You can use MicroProfile Reactive Streams Operators when you want to maintain source-level portability between different implementations.">異なる実装間でソース・レベルの移植性を維持する場合は、MicroProfileリアクティブ・ストリーム・オペレータを使用できます。</span> </p>
...
<div class="section">
<p><span class="merged" id="all.2Jgp3X" title="原文 : To enable Reactive Streams either add a dependency on the helidon-microprofile bundle or add the following dependency to your project’s pom.xml (see Managing Dependencies).">リアクティブ・ストリームを有効にするには、<router-link to="/mp/introduction/microprofile">helidon-microprofile bundle</router-link>への依存関係を追加するか、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<h2 id="_usage"><span class="merged" id="all.JUOSC.25"  title="原文:: Usage">使用</span></h2>
<div class="section">
...
<ul class="ulist">
<li>
<p><span class="merged" id="all.27d8i0" title="原文 : MicroProfile Reactive Streams Operators Specification"><a href="https://download.eclipse.org/microprofile/microprofile-reactive-streams-operators-3.1.1/microprofile-reactive-streams-operators-spec-3.1.1.html" target="_blank">MicroProfileリアクティブ・ストリーム・オペレータの指定</a></span></p>

</li>
<li>
<p><span class="merged" id="all.1pZzi1" title="原文 : MicroProfile Reactive Streams Operators JavaDoc"><a href="https://download.eclipse.org/microprofile/microprofile-reactive-streams-operators-3.1.1/apidocs" target="_blank">MicroProfileリアクティブ・ストリーム・オペレータJavaDoc</a></span></p>
