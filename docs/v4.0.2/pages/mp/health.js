...
<div class="section">
<p><span class="merged" id="all.2CbxAl" title="原文 : To enable MicroProfile Health add the helidon-microprofile bundle dependency to your project’s pom.xml (see Managing Dependencies).">MicroProfile Healthを有効にするには、プロジェクトの<code>pom.xml</code>に<router-link to="/mp/introduction/microprofile">helidon-microprofile bundle</router-link>依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<tbody>
<tr>
<td class=""><span class="merged" id="all.jXESw" title="原文 : liveness">リブネス</span></td>
...
<tr>
<td class=""><span class="merged" id="all.3qcozD"  title="原文:: readiness">レディネス</span></td>
...
<tr>
<td class=""><span class="merged" id="all.4BVIxi"  title="原文:: startup">起動</span></td>
...
<p><span class="merged" id="all.3Tirmk.1" title="原文 : Type: io.helidon.webserver.observe.health.HealthObserver">タイプ: <a href="/apidocs/io.helidon.webserver.observe.health/io/helidon/webserver/observe/health/HealthObserver.html" target="_blank">io.helidon.webserver.observe.health.HealthObserver</a></span></p>
...
<ul class="ulist">
<li>
<p><span class="merged" id="all.26gZXx.6"  title="原文: io.helidon.webserver.observe.spi.ObserveProvider"><code>io.helidon.webserver.observe.spi.ObserveProvider</code></span></p>

</li>
</ul>


<h3 id="_configuration_options"><span class="merged" id="all.3SKgM1.107"  title="原文:: Configuration options">構成オプション</span></h3>
<div class="section">
...
<th><span class="merged" id="all.2ZwVVB.110"  title="原文:: type">タイプ</span></th>
...
<tbody>
<tr>
<td class=""><span class="merged" id="all.37dtLI.1"  title="原文: details"><code>details</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.2XHIO8.163"  title="原文:: boolean">boolean</span></p>

</doc-view>
</td>
<td class=""><span class="merged" id="all.42DdBS.52"  title="原文: false"><code>false</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.3fRHYx.1.spl1" title="原文 : Whether details should be printed.">詳細を印刷するかどうか。</span> <span class="merged" id="all.3fRHYx.1.spl2" title="原文 : By default, health only returns a io.helidon.http.Status#NO_CONTENT_204 for success, io.helidon.http.Status#SERVICE_UNAVAILABLE_503 for health down, and io.helidon.http.Status#INTERNAL_SERVER_ERROR_500 in case of error with no entity.">デフォルトでは、ヘルスは、成功の場合はio.helidon.http.Status#NO_CONTENT_204、ヘルス終了の場合はio.helidon.http.Status#SERVICE_UNAVAILABLE_503、エンティティがないエラーの場合はio.helidon.http.Status#INTERNAL_SERVER_ERROR_500のみが戻されます。</span> <span class="merged" id="all.3fRHYx.1.spl3" title="原文 : When details are enabled, health returns io.helidon.http.Status#OK_200 for success, same codes otherwise and a JSON entity with detailed information about each health check executed.">詳細が有効な場合、ヘルスでは、成功の場合はio.helidon.http.Status#OK_200、それ以外の場合は同じコード、実行された各ヘルス・チェックに関する詳細情報を含むJSONエンティティが返されます。</span> </p>
...
<tr>
<td class=""><span class="merged" id="all.2QMdx0.6"  title="原文: endpoint"><code>endpoint</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.2uEvOb.205"  title="原文:: string">文字列</span></p>

</doc-view>
</td>
<td class=""><span class="merged" id="all.4HLPu5.2"  title="原文: health"><code>health</code></span></td>
<td class=""><doc-view>
...
<tr>
<td class=""><span class="merged" id="all.1Ea3gI.1"  title="原文: use-system-services"><code>use-system-services</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.2XHIO8.164"  title="原文:: boolean">boolean</span></p>

</doc-view>
</td>
<td class=""><span class="merged" id="all.xEiHU.84"  title="原文: true"><code>true</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.2WvLJ5.1.spl1" title="原文 : Whether to use services discovered by java.util.ServiceLoader.">java.util.ServiceLoaderで検出されたサービスを使用するかどうか。</span> <span class="merged" id="all.2WvLJ5.1.spl2" title="原文 : By default, all io.helidon.health.spi.HealthCheckProvider based health checks are added.">デフォルトでは、すべてのio.helidon.health.spi.HealthCheckProviderベースのヘルス・チェックが追加されます。</span> </p>
...
<p><span class="merged" id="all.14AIUG" title="原文 : Properties may be set in application.yaml or in microprofile-config.properties, in both cases using the health prefix.">プロパティは、<code>health</code>プレフィクスを使用して、<code>application.yaml</code>または<code>microprofile-config.properties</code>で設定できます。</span></p>
...
<ul class="colist">
<li data-value="1"><span class="merged" id="all.4MVzqG" title="原文 : The endpoint setting specifies the root path for the health endpoint."><code>endpoint</code>設定は、ヘルス・エンドポイントのルート・パスを指定します。</span></li>
</ul>
...
<div class="section">
<p><span class="merged" id="all.3rNKCd" title="原文 : Generate Helidon MP Quickstart project following these instructions.">これらの<router-link to="/mp/guides/quickstart">「手順」</router-link>に従って、Helidon MPクイックスタート・プロジェクトを生成します。</span></p>
...
<div class="section">
<p><span class="merged" id="all.15lLTH" title="原文 : Helidon has a set of built-in health checks that can report various conditions:">Helidonには、様々な条件をレポートできる一連の組込みヘルス・チェックがあります:</span></p>
...
<ul class="colist">
<li data-value="1"><span class="merged" id="all.3RP0iD.1" title="原文 : Annotation indicating this is a liveness health check.">これがリブネス・ヘルス・チェックであることを示す注釈。</span></li>
...
<p><span class="merged" id="all.1002SQ" title="原文 : Full example code is available here.">完全なサンプル・コードは<a href="https://github.com/oracle/helidon/tree/4.0.2/examples/microprofile" target="_blank">こちら</a>です。</span></p>
...
<p><span class="merged" id="all.1002SQ.1" title="原文 : Full example code is available here.">完全なサンプル・コードは<a href="https://github.com/oracle/helidon/tree/4.0.2/examples/microprofile" target="_blank">こちら</a>です。</span></p>
...
<ul class="ulist">
<li>
<p><span class="merged" id="all.3tLNuU" title="原文 : Helidon MicroProfile Health JavaDoc"><a href="/apidocs/io.helidon.microprofile.health/module-summary.html" target="_blank">Helidon MicroProfileヘルスJavaDoc</a></span></p>

</li>
<li>
<p><span class="merged" id="all.2XN6Iq" title="原文 : Helidon Built-in Checks JavaDoc"><a href="/apidocs/io.helidon.health.checks/module-summary.html" target="_blank">Helidon組込みチェックJavaDoc</a></span></p>
