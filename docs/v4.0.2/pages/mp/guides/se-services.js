...
<tr>
<td class=""><span class="merged" id="all.17vEm3.11" title="原文 : Java&#160;SE&#160;21 (Open&#160;JDK&#160;21)"><a href="https://www.oracle.com/technetwork/java/javase/downloads" target="_blank">Java SE 21</a> (<a href="http://jdk.java.net" target="_blank">JDK 21を開く</a>)</span></td>
<td class=""><span class="merged" id="all.3uVV7D.11" title="原文 : Helidon requires Java 21+.">HelidonにはJava 21+が必要です。</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.UWTyd.11" title="原文 : Maven 3.8+"><a href="https://maven.apache.org/download.cgi" target="_blank">Maven 3.8+</a></span></td>
<td class=""><span class="merged" id="all.47RJEf.11" title="原文 : Helidon requires Maven 3.8+.">HelidonにはMaven 3.8+が必要です。</span></td>
</tr>
<tr>
...
<p><span class="merged" id="all.PTdLq.spl1" title="原文 : Helidon MP supports WebServer routing which brings possibility for reusing io.helidon.webserver.HttpService implementations in Helidon MP.">Helidon MPは、Helidon MPで<code>io.helidon.webserver.HttpService</code>実装を再利用できるようにする<router-link to="/mp/server">「WebServerルーティング」</router-link>をサポートしています。</span> <span class="merged" id="all.PTdLq.spl2" title="原文 : Such feature can be quite useful for common solutions for filtering, auditing, logging or augmenting REST endpoints in hybrid Helidon SE/MP environment.">このような機能は、ハイブリッドHelidon SE/MP環境でRESTエンドポイントをフィルタリング、監査、ロギングまたは拡張するための一般的なソリューションに非常に役立ちます。</span> </p>

<p><span class="merged" id="all.4908wa" title="原文 : Let’s define simple Helidon SE Service for adding special header to every REST response:">すべてのRESTレスポンスに特別なヘッダーを追加するための単純なHelidon SEサービスを定義します:</span></p>
