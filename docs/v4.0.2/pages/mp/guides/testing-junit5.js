...
<tr>
<td class=""><span class="merged" id="all.17vEm3.13" title="原文 : Java&#160;SE&#160;21 (Open&#160;JDK&#160;21)"><a href="https://www.oracle.com/technetwork/java/javase/downloads" target="_blank">Java SE 21</a> (<a href="http://jdk.java.net" target="_blank">JDK 21を開く</a>)</span></td>
<td class=""><span class="merged" id="all.3uVV7D.13" title="原文 : Helidon requires Java 21+.">HelidonにはJava 21+が必要です。</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.UWTyd.13" title="原文 : Maven 3.8+"><a href="https://maven.apache.org/download.cgi" target="_blank">Maven 3.8+</a></span></td>
<td class=""><span class="merged" id="all.47RJEf.13" title="原文 : Helidon requires Maven 3.8+.">HelidonにはMaven 3.8+が必要です。</span></td>
</tr>
<tr>
...
<div class="section">
<p><span class="merged" id="all.1tvV3G" title="原文 : First you’ll need to create a test class with an empty test method, and annotate it with @HelidonTest:">まず、空のテスト・メソッドでテスト・クラスを作成し、<code>@HelidonTest</code>で注釈を付ける必要があります:</span></p>
...
<p><span class="merged" id="all.89GNb" title="原文 : Here’s an example showing how these approaches are used to execute the same endpoint with different configuration:">次に、異なる構成で同じエンドポイントを実行するためにこれらのアプローチが使用される例を示します:</span></p>
