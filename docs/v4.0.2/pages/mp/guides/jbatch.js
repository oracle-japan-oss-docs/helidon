...
<tr>
<td class=""><span class="merged" id="all.17vEm3.6" title="原文 : Java&#160;SE&#160;21 (Open&#160;JDK&#160;21)"><a href="https://www.oracle.com/technetwork/java/javase/downloads" target="_blank">Java SE 21</a> (<a href="http://jdk.java.net" target="_blank">JDK 21を開く</a>)</span></td>
<td class=""><span class="merged" id="all.3uVV7D.6" title="原文 : Helidon requires Java 21+.">HelidonにはJava 21+が必要です。</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.UWTyd.6" title="原文 : Maven 3.8+"><a href="https://maven.apache.org/download.cgi" target="_blank">Maven 3.8+</a></span></td>
<td class=""><span class="merged" id="all.47RJEf.6" title="原文 : Helidon requires Maven 3.8+.">HelidonにはMaven 3.8+が必要です。</span></td>
</tr>
<tr>
...
<div class="admonition note">
<p class="admonition-inline"><span class="merged" id="all.2tfs86" title="原文 : You must specify the fully qualified names in the ref properties, like “jobs.io.helidon.examples.jbatch.MyItemReader”, otherwise it will not work.">"jobs.io.helidon.examples.jbatch.MyItemReader"のように、<code>ref</code>プロパティに完全修飾名を指定する必要があります。指定しないと、機能しません。</span></p>
</div>
