...
<dl>
<dt slot=title><span class="merged" id="all.23tLLU"  title="原文:: Helidon MP 2.x Upgrade Guide">Helidon MP 2.xアップグレード・ガイド</span></dt>
<dd slot="desc"><p><span class="merged" id="all.3qkRTh.spl1" title="原文 : In Helidon 2.x we have made some changes to APIs and runtime behavior.">Helidon 2.xでは、APIおよびランタイム動作にいくつか変更を加えました。</span> <span class="merged" id="all.3qkRTh.spl2" title="原文 : This guide will help you migrate a Helidon MP 1.x application to 2.x.">このガイドは、Helidon MP 1.xアプリケーションを2.xに移行する際に役立ちます。</span> </p>
</dd>
</dl>
</v-card-text>
</v-card>
...
<h2 id="_java_11_runtime"><span class="merged" id="all.2Qxnfe"  title="原文:: Java 11 Runtime">Java 11 Runtime</span></h2>
<div class="section">
<p><span class="merged" id="all.3qDTVL.spl1" title="原文 : Java 8 is no longer supported in Helidon 2.">Java 8は、Helidon 2でサポートされなくなりました。</span> <span class="merged" id="all.3qDTVL.spl2"  title="原文:: Java 11 or newer is required.">Java 11以上が必要です。</span> </p>

</div>


<h2 id="_tracing"><span class="merged" id="all.4Mk18P"  title="原文:: Tracing">トレース</span></h2>
<div class="section">
...
<h2 id="_metrics"><span class="merged" id="all.4LL0ot.1"  title="原文:: Metrics">メトリクス</span></h2>
<div class="section">
