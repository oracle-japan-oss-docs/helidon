...
<div class="section">
<p><span class="merged" id="all.4BUptU.1" title="原文 : For this 30 minute tutorial, you will need the following:">この30分のチュートリアルでは、次のものが必要です:</span></p>
...
<tbody>
<tr>
<td class=""><span class="merged" id="all.3J4a7U.6" title="原文 : A Helidon MP Application">Helidon MPアプリケーション</span></td>
<td class=""><span class="merged" id="all.13muNj.6" title="原文 : You can use your own application or use the Helidon MP Quickstart to create a sample application.">独自のアプリケーションを使用するか、<router-link to="/mp/guides/quickstart">「Helidon MPクイックスタート」</router-link>を使用してサンプル・アプリケーションを作成できます。</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.17vEm3.9" title="原文 : Java&#160;SE&#160;21 (Open&#160;JDK&#160;21)"><a href="https://www.oracle.com/technetwork/java/javase/downloads" target="_blank">Java SE 21</a> (<a href="http://jdk.java.net" target="_blank">JDK 21を開く</a>)</span></td>
<td class=""><span class="merged" id="all.3uVV7D.9" title="原文 : Helidon requires Java 21+.">HelidonにはJava 21+が必要です。</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.UWTyd.9" title="原文 : Maven 3.8+"><a href="https://maven.apache.org/download.cgi" target="_blank">Maven 3.8+</a></span></td>
<td class=""><span class="merged" id="all.47RJEf.9" title="原文 : Helidon requires Maven 3.8+.">HelidonにはMaven 3.8+が必要です。</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.3ND1mN.9"  title="原文:: Docker 18.09+"><a href="https://docs.docker.com/install/" target="_blank">Docker 18.09+</a></span></td>
...
<tr>
<td class=""><span class="merged" id="all.4Lo77h.9"  title="原文:: Kubectl 1.16.5+"><a href="https://kubernetes.io/docs/tasks/tools/install-kubectl/" target="_blank">Kubectl 1.16.5+</a></span></td>
<td class=""><span class="merged" id="all.1JBSOB.9" title="原文 : If you want to deploy to Kubernetes, you need kubectl and a Kubernetes cluster (you can install one on your desktop.">Kubernetesにデプロイする場合は、<code>kubectl</code>およびKubernetesクラスタが必要です (<router-link to="/about/kubernetes">「デスクトップにインストール」</router-link>できます)。</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.1B8POk"  title="原文:: curl"><a href="https://curl.se/download.html" target="_blank">curl</a></span></td>
...
<p class="admonition-inline"><span class="merged" id="all.3QPxqi.spl1" title="原文 : MicroProfile contains features like Metrics, Health Check, Streams Operators, Open Tracing, OpenAPI, REST client, and fault tolerance.">MicroProfileには、メトリクス、ヘルス・チェック、ストリーム・オペレータ、オープン・トレース、OpenAPI、RESTクライアント、フォルト・トレランスなどの機能が含まれます。</span> <span class="merged" id="all.3QPxqi.spl2" title="原文 : You can find detailed information about MicroProfile on the Eclipse MicroProfile site.">MicroProfileの詳細は、<a href="https://projects.eclipse.org/projects/technology.microprofile" target="_blank">Eclipse MicroProfile</a>サイトを参照してください。</span> </p>
</div>
...
<div class="admonition tip">
<p class="admonition-inline"><span class="merged" id="all.3Eqiw4.spl1" title="原文 : Technically, your own main class is not needed unless you want to control the startup sequence.">技術的には、起動シーケンスを制御する場合を除き、独自のメイン・クラスは必要ありません。</span> <span class="merged" id="all.3Eqiw4.spl2" title="原文 : You can set the mainClass property to io.helidon.microprofile.cdi.Main and it will use Helidon’s default main class."><code>mainClass</code>プロパティを<code>io.helidon.microprofile.cdi.Main</code>に設定すると、Helidonのデフォルトのメイン・クラスが使用されます。</span> </p>
</div>
...
<li data-value="2"><span class="merged" id="all.22EjHN.spl1" title="原文 : The RequestScoped annotation defines that this bean is request scoped."><code>RequestScoped</code>注釈は、このBeanがリクエスト・スコープであることを定義します。</span> <span class="merged" id="all.22EjHN.spl2" title="原文 : The request scope is active only for the duration of one web service invocation and it is destroyed at the end of that invocation.">リクエスト・スコープは、1つのwebサービス呼出しの間のみアクティブになり、その呼出しの最後に破棄されます。</span> <span class="merged" id="all.22EjHN.spl3" title="原文 : You can learn more about scopes and contexts, and how they are used from the Specification.">スコープとコンテキスト、およびそれらの使用方法の詳細は、<a href="https://jakarta.ee/specifications/cdi/4.0.1/jakarta-cdi-spec-4.0.1.html" target="_blank">「仕様」</a>を参照してください。</span> </li>
...
<p><span class="merged" id="all.pN3vX.spl1" title="原文 : A main class is also required to start up the server and run the application.">サーバーを起動してアプリケーションを実行するには、メイン・クラスも必要です。</span> <span class="merged" id="all.pN3vX.spl2" title="原文 : If you don’t use Helidon’s built-in main class you can define your own:">Helidonの組込みメイン・クラスを使用しない場合は、独自のクラスを定義できます:</span> </p>
...
<div class="admonition tip">
<p class="admonition-inline"><span class="merged" id="all.4Zgrex" title="原文 : You can learn more about options for configuring the Helidon Server on the Server Configuration page.">Helidon Serverの構成オプションの詳細は、<router-link to="/mp/server">「サーバー構成」</router-link>ページを参照してください。</span></p>
</div>
...
<div class="admonition tip">
<p class="admonition-inline"><span class="merged" id="all.1XMza7" title="原文 : To learn more about Helidon MP configuration please see the Config section of the documentation.">Helidon MP構成の詳細は、ドキュメントの<router-link to="/mp/config/introduction">Config</router-link>の項を参照してください。</span></p>
</div>
...
handlers=io.helidon.logging.jul.HelidonConsoleHandler <span class="conum" data-value="1" />
...
<h2 id="_metrics"><span class="merged" id="all.4LL0ot"  title="原文:: Metrics">メトリクス</span></h2>
<div class="section">
...
<div class="admonition tip">
<p class="admonition-inline"><span class="merged" id="all.3paN6v" title="原文 : You can find details of the available annotations in the MicroProfile Metrics Specification.">使用可能な注釈の詳細は、<a href="https://microprofile.io/project/eclipse/microprofile-metrics" target="_blank">「MicroProfileメトリクス仕様」</a>を参照してください。</span></p>
</div>
...
<p><span class="merged" id="all.WvxBO.spl1" title="原文 : Rebuild and run the application.">アプリケーションを再ビルドして実行します。</span> <span class="merged" id="all.WvxBO.spl2" title="原文 : Make some calls to the endpoint (http://localhost:8080/greet) so there will be some data to report.">レポートするデータがいくつか存在するように、エンドポイント(<a class="bare" href="http://localhost:8080/greet" target="_blank">http://localhost:8080/greet</a>)をコールします。</span> <span class="merged" id="all.WvxBO.spl3" title="原文 : Then obtain the application metrics as follows:">次に、次のようにアプリケーション・メトリクスを取得します:</span> </p>
...
<p><span class="merged" id="all.4BsCpL" title="原文 : Learn more about using Helidon and MicroProfile metrics in the Metrics Guide."><router-link to="/mp/guides/metrics">「メトリクス・ガイド」</router-link>でのHelidonおよびMicroProfileメトリクスの使用についてさらに学習します。</span></p>
...
<ul class="colist">
<li data-value="1"><span class="merged" id="all.16kfZR.spl1" title="原文 : This class has the MicroProfile Liveness annotation which tells Helidon that this class provides a custom health check.">このクラスには、このクラスがカスタム・ヘルス・チェックを提供することをHelidonに伝えるMicroProfile <code>Liveness</code>注釈があります。</span> <span class="merged" id="all.16kfZR.spl2" title="原文 : You can learn more about the available annotations in the MicroProfile Health Protocol and Wireformat document.">使用可能な注釈の詳細は、<a href="https://download.eclipse.org/microprofile/microprofile-health-4.0/microprofile-health-spec-4.0.html##_protocol_and_wireformat" target="_blank">「MicroProfile Health ProtocolおよびWireformat」</a>ドキュメントを参照してください。</span> </li>
...
<p><span class="merged" id="all.2sZXOi" title="原文 : Learn more about health checks in the Health Check Guide."><router-link to="/mp/guides/health">「ヘルス・チェック・ガイド」</router-link>のヘルス・チェックについてさらに学習します。</span></p>

</div>


<h2 id="_build_a_docker_image"><span class="merged" id="all.3PwUaB"  title="原文:: Build a Docker Image">Dockerイメージのビルド</span></h2>
<div class="section">
...
>FROM container-registry.oracle.com/java/openjdk:21 as build <span class="conum" data-value="1" />
...
<li data-value="4"><span class="merged" id="all.s8Jzz" title="原文 : Copy the binary and libraries from the first stage.">最初のステージからバイナリとライブラリをコピーします。</span></li>
<li data-value="5"><span class="merged" id="all.44tVZp" title="原文 : Set the initial command and expose port 8080.">初期コマンドを設定し、ポート8080を公開します。</span></li>
</ul>
...
<div class="section">
<p><span class="merged" id="all.178sc6.spl1" title="原文 : If you don’t have access to a Kubernetes cluster, you can install one on your desktop.">Kubernetesクラスタにアクセスできない場合は、<router-link to="/about/kubernetes">「デスクトップにインストール」</router-link>を使用できます。</span> <span class="merged" id="all.178sc6.spl2" title="原文 : Then deploy the example:">次に、例をデプロイします:</span> </p>
...
<p><span class="merged" id="all.ZMYeE" title="原文 : Create a file called app.yaml in the project’s root directory with the following content:">プロジェクトのルート・ディレクトリに、次の内容の<code>app.yaml</code>というファイルを作成します:</span></p>
...
<ul class="ulist">
<li>
<p><span class="merged" id="all.3dnGpn" title="原文 : Eclipse MicroProfile"><a href="https://projects.eclipse.org/projects/technology.microprofile" target="_blank">Eclipse MicroProfile</a></span></p>

</li>
<li>
<p><span class="merged" id="all.2Ax3rJ" title="原文 : Contexts and Dependency Injection Specification"><a href="https://jakarta.ee/specifications/cdi/4.0.1/jakarta-cdi-spec-4.0.1.html" target="_blank">Contexts and Dependency Injection仕様</a></span></p>

</li>
<li>
<p><span class="merged" id="all.31EnL4" title="原文 : Server Configuration"><router-link to="/mp/server">サーバー構成</router-link></span></p>

</li>
<li>
<p><span class="merged" id="all.6XuZs" title="原文 : Config"><router-link to="/mp/config/introduction">Config</router-link></span></p>

</li>
<li>
<p><span class="merged" id="all.2TYXSy" title="原文 : MicroProfile Metrics Specification"><a href="https://microprofile.io/project/eclipse/microprofile-metrics" target="_blank">MicroProfileメトリクス仕様</a></span></p>

</li>
<li>
<p><span class="merged" id="all.2l5wgz" title="原文 : Metrics Guide"><router-link to="/mp/guides/metrics">メトリクス・ガイド</router-link></span></p>

</li>
<li>
<p><span class="merged" id="all.2J8S0l" title="原文 : MicroProfile Health Protocol and Wireformat"><a href="https://download.eclipse.org/microprofile/microprofile-health-4.0/microprofile-health-spec-4.0.html##_protocol_and_wireformat" target="_blank">MicroProfile Health ProtocolおよびWireformat</a></span></p>

</li>
<li>
<p><span class="merged" id="all.1TpiPe" title="原文 : Install Kubernetes on your desktop"><router-link to="/about/kubernetes">デスクトップへのKubernetesのインストール</router-link></span></p>
