...
<tr>
<td class=""><span class="merged" id="all.17vEm3.3" title="原文 : Java&#160;SE&#160;21 (Open&#160;JDK&#160;21)"><a href="https://www.oracle.com/technetwork/java/javase/downloads" target="_blank">Java SE 21</a> (<a href="http://jdk.java.net" target="_blank">JDK 21を開く</a>)</span></td>
<td class=""><span class="merged" id="all.3uVV7D.3" title="原文 : Helidon requires Java 21+.">HelidonにはJava 21+が必要です。</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.UWTyd.3" title="原文 : Maven 3.8+"><a href="https://maven.apache.org/download.cgi" target="_blank">Maven 3.8+</a></span></td>
<td class=""><span class="merged" id="all.47RJEf.3" title="原文 : Helidon requires Maven 3.8+.">HelidonにはMaven 3.8+が必要です。</span></td>
</tr>
<tr>
...
<p><span class="merged" id="all.4Jk7Uc" title="原文 : Next change the project’s pom.xml to use your main class:">次に、メイン・クラスを使用するようにプロジェクトの<code>pom.xml</code>を変更します:</span></p>
...
<p><span class="merged" id="all.2U9x90" title="原文 : This property will be used to set the Main-Class attribute in the application jar’s MANIFEST.">このプロパティは、アプリケーションjarのMANIFESTで<code>Main-Class</code>属性を設定するために使用されます。</span></p>
...
<p class="admonition-inline"><span class="merged" id="all.2Jc31m.spl1" title="原文 : Because environment variable names are restricted to alphanumeric characters and underscores, Helidon adds aliases to the environment configuration source, allowing entries with dotted and/or hyphenated keys to be overridden.">環境変数名は英数字およびアンダースコアに制限されるため、Helidonは環境構成ソースに別名を追加し、ドットまたはハイフン(あるいはその両方)のキーを持つエントリを上書きできます。</span> <span class="merged" id="all.2Jc31m.spl2" title="原文 : For example, this mapping allows an environment variable named &quot;APP_GREETING&quot; to override an entry key named &quot;app.greeting&quot;.">たとえば、このマッピングを使用すると、"APP_GREETING"という環境変数で"app.greeting"というエントリ・キーをオーバーライドできます。</span> <span class="merged" id="all.2Jc31m.spl3" title="原文 : In the same way, an environment variable named &quot;APP_dash_GREETING&quot; will map to &quot;app-greeting&quot;.">同様に、"APP_dash_GREETING"という名前の環境変数が"app-greeting"にマップされます。</span> <span class="merged" id="all.2Jc31m.spl4" title="原文 : See Microprofile Config Specifications for more information.">詳細は、<a href="https://download.eclipse.org/microprofile/microprofile-config-3.0.3/microprofile-config-spec-3.0.3.html" target="_blank">「Microprofile構成仕様」</a>を参照してください。</span> </p>
</div>
...
<h2 id="_references"><span class="merged" id="all.3oSja0.1"  title="原文:: References">リファレンス</span></h2>
<div class="section">
...
<ul class="ulist">
<li>
<p><span class="merged" id="all.11RRpP" title="原文 : MicroProfile Config specification"><a href="https://download.eclipse.org/microprofile/microprofile-config-3.0.3/microprofile-config-spec-3.0.3.html" target="_blank">MicroProfile構成の指定</a></span></p>

</li>
<li>
<p><span class="merged" id="all.KO2mR" title="原文 : MicroProfile Config Javadoc"><a href="https://download.eclipse.org/microprofile/microprofile-config-3.0.3/apidocs" target="_blank">MicroProfile構成Javadoc</a></span></p>

</li>
<li>
<p><span class="merged" id="all.2mjhzP" title="原文 : Helidon Javadoc"><a href="/apidocs/index.html?overview-summary.html" target="_blank">Helidon Javadoc</a></span></p>
