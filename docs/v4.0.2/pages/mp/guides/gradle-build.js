...
<dd slot="desc"><p><span class="merged" id="all.2aGrlk" title="原文 : This guide describes Helidon’s support for Gradle projects.">このガイドでは、HelidonでのGradleプロジェクトのサポートについて説明します。</span></p>
</dd>
</dl>
</v-card-text>
</v-card>
...
<div class="section">
<p><span class="merged" id="all.lCdUx.spl1" title="原文 : While most of Helidon’s examples use Maven, you can also use Helidon with a Gradle project.">Helidonのほとんどの例ではMavenを使用していますが、GradleプロジェクトでHelidonを使用することもできます。</span> <span class="merged" id="all.lCdUx.spl2" title="原文 : Gradle 8.4+ is required to build Helidon 4 projects.">Helidon 4プロジェクトを構築するには、Gradle 8.4+が必要です。</span> </p>
...
<div class="section">
<p><span class="merged" id="all.2jpVXy" title="原文 : The Helidon Quickstart Example contains a build.gradle file that you can use as an example for building your Helidon application using Gradle.">Helidon <a href="https://github.com/oracle/helidon/tree/4.0.2/examples/quickstarts/helidon-quickstart-mp" target="_blank">「クイックスタートの例」</a>には、Gradleを使用してHelidonアプリケーションを構築するための例として使用できる<code>build.gradle</code>ファイルが含まれています。</span></p>
