...
<h2 id="_overview"><span class="merged" id="all.YrpRV.40"  title="原文:: Overview">概要</span></h2>
<div class="section">
...
<div class="section">
<p><span class="merged" id="all.1OtigJ" title="原文 : To enable Scheduling add the following dependency to your project’s pom.xml (see Managing Dependencies).">スケジューリングを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<h2 id="_usage"><span class="merged" id="all.JUOSC.26"  title="原文:: Usage">使用</span></h2>
<div class="section">
...
<td class=""><span class="merged" id="all.sJRZu"  title="原文:: seconds">秒</span></td>
...
<td class=""><span class="merged" id="all.9VJRj.spl1" title="原文 : Boolean, equivalent concurrentExecution property of @Scheduled."><code>@Scheduled</code>のブール、同等の<code>concurrentExecution</code>プロパティ。</span> <span class="merged" id="all.9VJRj.spl2" title="原文 : Default true.">デフォルトの<code>true</code>。</span> </td>
</tr>
</tbody>
</table>
</div>
...
<li>
<p><span class="merged" id="all.21rQgC" title="原文 : Helidon Scheduling JavaDoc"><a href="/apidocs/io.helidon.microprofile.scheduling/io/helidon/microprofile/scheduling/package-summary.html" target="_blank">HelidonスケジュールJavaDoc</a></span></p>
