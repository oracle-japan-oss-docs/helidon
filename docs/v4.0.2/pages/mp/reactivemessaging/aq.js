...
<h2 id="_contents"><span class="merged" id="all.1Q34Zl.24"  title="原文:: Contents">目次</span></h2>
<div class="section">
<ul class="ulist">
<li>
...
<div class="section">
<p><span class="merged" id="all.2JUob4.spl1" title="原文 : Connecting streams to Oracle AQ with Reactive Messaging couldn’t be easier.">リアクティブ・メッセージングを使用したOracle AQへのストリームの接続はより簡単にはできないでしょう。</span> <span class="merged" id="all.2JUob4.spl2" title="原文 : This connector extends Helidon’s JMS connector with Oracle’s AQ-specific API.">このコネクタは、OracleのAQ固有のAPIを使用してHelidonのJMSコネクタを拡張します。</span> </p>
...
<div class="section">
<p><span class="merged" id="all.23QILI" title="原文 : To enable AQ Connector add the following dependency to your project’s pom.xml (see Managing Dependencies).">AQコネクタを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<h2 id="_configuration"><span class="merged" id="all.Pfqvy.20"  title="原文:: Configuration">構成</span></h2>
<div class="section">
...
<tr>
<td class=""><span class="merged" id="all.2FqwBE.2"  title="原文: username"><code>username</code></span></td>
...
<tr>
<td class=""><span class="merged" id="all.xgZgv.3"  title="原文: password"><code>password</code></span></td>
...
<h3 id="_configured_jms_factory"><span class="merged" id="all.1vUU4U" title="原文 : Configured JMS Factory">構成済JMSファクトリ</span></h3>
<div class="section">
<p><span class="merged" id="all.yACkL" title="原文 : The simplest possible usage is leaving construction of AQjmsConnectionFactory to the connector.">最も簡単な使用方法は、<code>AQjmsConnectionFactory</code>をコネクタに残すことです。</span></p>
...
<p><span class="merged" id="all.1BQDTE" title="原文 : Its also possible and preferable to refer to configured datasource, in our example Oracle UCP datasource:">また、<router-link to="/mp/persistence">構成済データソース</router-link>を参照することもでき、推奨されます(この例では<router-link to="/mp/persistence">Oracle UCPデータソース</router-link>):</span></p>
...
<div class="section">
<p><span class="merged" id="all.2GlmGb" title="原文 : If you need more advanced configurations, connector can work with injected AQjmsConnectionFactory:">より高度な構成が必要な場合、コネクタはインジェクトされた<code>AQjmsConnectionFactory</code>を操作できます:</span></p>
...
<h2 id="_usage"><span class="merged" id="all.JUOSC.19"  title="原文:: Usage">使用</span></h2>
<div class="section">
