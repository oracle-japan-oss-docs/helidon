...
<div class="section">
<p><span class="merged" id="all.2sFw8e" title="原文 : To enable Mock Connector add the following dependency to your project’s pom.xml (see Managing Dependencies).">Mock Connectorを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<h2 id="_usage"><span class="merged" id="all.JUOSC.22"  title="原文:: Usage">使用</span></h2>
<div class="section">
...
<td class=""><span class="merged" id="all.4JM9z7.18"  title="原文:: Description">説明</span></td>
</tr>
<tr>
...
<li data-value="10"><span class="merged" id="all.3205e6" title="原文 : Actual JUnit 5 test method which is going to block the thread until 3 items are intercepted on test-channel-out channel’s downstream and assert those with expected values."><code>test-channel-out</code>チャネルのダウンストリームで3つのアイテムがインターセプトされ、予想される値を持つアイテムがアサートされるまで、スレッドをブロックする実際のJUnit 5テスト・メソッド。</span></li>
</ul>
