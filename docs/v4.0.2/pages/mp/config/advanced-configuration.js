...
<p><span class="merged" id="all.4OBSxb" title="原文 : Important Note: To enable support for HOCON and JSON types, add the following dependency to your project’s pom.xml."><strong>重要なノート:</strong> <code>HOCON</code>および<code>JSON</code>タイプのサポートを有効にするには、プロジェクトpom.xmlに次の依存関係を追加します。</span></p>
