...
<h2 id="_usage"><span class="merged" id="all.JUOSC"  title="原文:: Usage">使用</span></h2>
<div class="section">
...
<h4 id="_references"><span class="merged" id="all.3oSja0"  title="原文:: References">リファレンス</span></h4>
<div class="section">
...
<td class=""><span class="merged" id="all.3a7gMM" title="原文 : Polling period duration, defaults to 10 seconds (&apos;PT10S`) See javadoc">ポーリング期間、デフォルトは10秒('PT10S`)<br><a href="https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/time/Duration.html#parse(java.lang.CharSequence)" target="_blank">javadoc</a>を参照してください</span></td>
</tr>
<tr>
...
<td class=""><span class="merged" id="all.R8Bl7.spl1" title="原文 : To enable watching file for changes using the Java WatchService.">Java <code>WatchService</code>を使用してファイルの変更を監視するには。</span> <span class="merged" id="all.R8Bl7.spl2" title="原文 :  See link:https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/nio/file/WatchService.html"><br>link:https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/nio/file/WatchService.htmlを参照してください</span> </td>
</tr>
</tbody>
</table>
</div>
...
<h4 id="_encryption"><span class="merged" id="all.Nhjlz"  title="原文:: Encryption">暗号化</span></h4>
<div class="section">
...
<p><span class="merged" id="all.3g1HE1.2" title="原文 : Type: org.eclipse.microprofile.config.Config">タイプ: org.eclipse.microprofile.config.Config</span></p>

<p><span class="merged" id="all.I7R8X.2" title="原文 : This is a standalone configuration type, prefix from configuration root: mp.config">これはスタンドアロン構成タイプであり、構成ルートからのプレフィクスです: <code>mp.config</code></span></p>


<h3 id="_configuration_options"><span class="merged" id="all.3SKgM1.106"  title="原文:: Configuration options">構成オプション</span></h3>
<div class="section">
...
<th><span class="merged" id="all.2ZwVVB.108"  title="原文:: type">タイプ</span></th>
...
<tbody>
<tr>
<td class=""><span class="merged" id="all.4RLyMe.2"  title="原文: profile"><code>profile</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.2uEvOb.204"  title="原文:: string">文字列</span></p>

</doc-view>
</td>
<td class="">&#160;</td>
<td class=""><doc-view>
<p><span class="merged" id="all.6kgKE.2" title="原文 : Configure an explicit profile name.">明示的なプロファイル名を構成します。</span></p>
...
<ul class="ulist">
<li>
<p><span class="merged" id="all.KPkJh" title="原文 : MicroProfile Config Specifications"><a href="https://download.eclipse.org/microprofile/microprofile-config-3.0.3/microprofile-config-spec-3.0.3.html}" target="_blank">MicroProfile構成仕様</a></span></p>

</li>
<li>
<p><span class="merged" id="all.4NV23O" title="原文 : MicroProfile Config Javadocs"><a href="https://download.eclipse.org/microprofile/microprofile-fault-tolerance-4.0.2/apidocs" target="_blank">MicroProfile構成Javadoc</a></span></p>
