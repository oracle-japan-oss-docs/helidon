...
<div class="section">
<p><span class="merged" id="all.1ry3jF.spl1" title="原文 : HashiCorp Vault is a commonly used Vault in many microservices.">HashiCorp Vaultは、多くのマイクロサービスでよく使用されているVaultです。</span> <span class="merged" id="all.1ry3jF.spl2" title="原文 : The APIs are REST-based and Helidon implements them using WebClient.">APIはRESTベースで、Helidonは<router-link to="/se/webclient">WebClient</router-link>を使用して実装します。</span> </p>
...
<div class="section">
<p><span class="merged" id="all.2iotqg" title="原文 : To enable HashiCorp Vault add the following dependency to your project’s pom.xml (see Managing Dependencies).">HashiCorp Vaultを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<h2 id="_usage"><span class="merged" id="all.JUOSC.3"  title="原文:: Usage">使用</span></h2>
<div class="section">
...
<h2 id="_references"><span class="merged" id="all.3oSja0.2"  title="原文:: References">リファレンス</span></h2>
<div class="section">
<ul class="ulist">
<li>
<p><span class="merged" id="all.3DUjsq" title="原文 : Hashicorp Vault Usage Examples"><a href="https://github.com/oracle/helidon/tree/4.0.2/examples/integrations/vault" target="_blank">Hashicorp Vaultの使用例</a></span></p>
