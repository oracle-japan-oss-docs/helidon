...
<h2 id="_what_is_helidon_2"><span class="merged" id="all.47cEUE.1" title="原文 : What is Helidon?">Helidonとは何ですか。</span></h2>
<div class="section">
<p><span class="merged" id="all.xpoev"  title="原文: Helidon is a collection of Java libraries for writing microservices."><a href="https://helidon.io" target="_blank">Helidon</a>は、マイクロサービスを作成するためのJavaライブラリの集まりです。</span></p>

<p><span class="merged" id="all.1t7gq9.spl1" title="原文 : Helidon is open source under the Apache license.">Helidonは、Apacheライセンスに基づくオープン・ソースです。</span> <span class="merged" id="all.1t7gq9.spl2" title="原文 : Sources are available on GitHub.">ソースは<a href="https://github.com/oracle/helidon/tree/4.0.2" target="_blank">GitHub</a>で入手できます。</span> </p>
...
<p><span class="merged" id="all.3Ze0ES" title="原文 : Helidon applications are stand-alone Java applications running in their own JVM and powered by the Helidon WebServer.">Helidonアプリケーションは、独自のJVMで実行され、Helidon WebServerによって動作するスタンドアロンのJavaアプリケーションです。</span></p>
...
<tr>
<td class=""><span class="merged" id="all.434xzN.spl1" title="原文 : Helidon SE is Helidon’s foundational set of APIs.">Helidon SEは、HelidonのAPIの基本セットです。</span> <span class="merged" id="all.434xzN.spl2" title="原文 : As of Helidon 4, virtual threads have enabled these APIs to change from asynchronous to blocking.">Helidon 4の時点で、仮想スレッドにより、これらのAPIが非同期からブロックに変更されるようになりました。</span> <span class="merged" id="all.434xzN.spl3" title="原文 : This results in much simpler code that is easier to write, maintain, debug and understand..">これにより、記述、メンテナンス、デバッグおよび理解が容易なコードが大幅に簡略化されます。</span> </td>
...
<p><span class="merged" id="all.4BS4AA.spl1" title="原文 : Even though Helidon MP supports Jakarta EE APIs it does not require an application server.">Helidon MPはJakarta EE APIをサポートしていますが、アプリケーション・サーバーは必要ありません。</span> <span class="merged" id="all.4BS4AA.spl2" title="原文 : Helidon MP applications are stand-alone Java applications running in their own JVM powered by Helidon WebServer.">Helidon MPアプリケーションは、Helidon WebServerを搭載した独自のJVMで実行されるスタンドアロンのJavaアプリケーションです。</span> </p>
...
<p ><p><span class="merged" id="all.2N8aoQ" title="原文 : If you don’t know which Helidon flavor to use - use Helidon MP.">使用するHelidonフレーバが不明な場合 - <strong>Helidon MP</strong>を使用します。</span></p>
</p>
</div>
...
<div class="block-title"><span class="merged" id="all.eoZJz.1" title="原文 : Prerequisite product versions for Helidon 4.0.2"><span>Helidon 4.0.2の前提条件製品バージョン</span></span></div>
<div class="table__overflow elevation-1  ">
<table class="datatable table">
<colgroup>
<col style="width: 50%;">
...
<tbody>
<tr>
<td class=""><span class="merged" id="all.17vEm3.1" title="原文 : Java&#160;SE&#160;21 (Open&#160;JDK&#160;21)"><a href="https://www.oracle.com/technetwork/java/javase/downloads" target="_blank">Java SE 21</a> (<a href="http://jdk.java.net" target="_blank">JDK 21を開く</a>)</span></td>
<td class=""><span class="merged" id="all.3uVV7D.1" title="原文 : Helidon requires Java 21+.">HelidonにはJava 21+が必要です。</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.UWTyd.1" title="原文 : Maven 3.8+"><a href="https://maven.apache.org/download.cgi" target="_blank">Maven 3.8+</a></span></td>
<td class=""><span class="merged" id="all.47RJEf.1" title="原文 : Helidon requires Maven 3.8+.">HelidonにはMaven 3.8+が必要です。</span></td>
</tr>
<tr>
...
<h2 id="_upgrade"><span class="merged" id="all.2DDlJ8"  title="原文:: Upgrade">アップグレード</span></h2>
<div class="section">
<p><span class="merged" id="all.pxDjb" title="原文 : To upgrade your current version of Helidon, follow the Upgrade Guides:">現在のバージョンのHelidonをアップグレードするには、<code>Upgrade Guides</code>に従います:</span></p>

<p><span class="merged" id="all.2I1XpT" title="原文 : To upgrade from Helidon 3.x to 4.x:">Helidon 3.xから4.xにアップグレードするには:</span></p>

<ul class="ulist">
<li>
<p><span class="merged" id="all.4WSOvj" title="原文 : Helidon SE 4x Upgrade Guide"><router-link to="/se/guides/upgrade_4x">Helidon SE 4xアップグレード・ガイド</router-link></span></p>

</li>
<li>
<p><span class="merged" id="all.CluVO" title="原文 : Helidon MP 4x Upgrade Guide"><router-link to="/mp/guides/upgrade_4x">Helidon MP 4xアップグレード・ガイド</router-link></span></p>

</li>
</ul>

<p><span class="merged" id="all.bozve" title="原文 : To upgrade from Helidon 2.x to 3.x:">Helidon 2.xから3.xにアップグレードするには:</span></p>

<ul class="ulist">
<li>
<p><span class="merged" id="all.2tXX89" title="原文 : Helidon SE 3x Upgrade Guide"><router-link to="/se/guides/upgrade_3x">Helidon SE 3xアップグレード・ガイド</router-link></span></p>

</li>
<li>
<p><span class="merged" id="all.1nOu6O" title="原文 : Helidon MP 3x Upgrade Guide"><router-link to="/mp/guides/upgrade_3x">Helidon MP 3xアップグレード・ガイド</router-link></span></p>

</li>
</ul>

<p><span class="merged" id="all.4tnq" title="原文 : To upgrade from Helidon 1.x to 2.x:">Helidon 1.xから2.xにアップグレードするには:</span></p>

<ul class="ulist">
<li>
<p><span class="merged" id="all.dEHn3" title="原文 : Helidon SE 2x Upgrade Guide"><router-link to="/se/guides/upgrade">Helidon SE 2xアップグレード・ガイド</router-link></span></p>

</li>
<li>
<p><span class="merged" id="all.2xQYuJ" title="原文 : Helidon MP 2x Upgrade Guide"><router-link to="/mp/guides/upgrade">Helidon MP 2xアップグレード・ガイド</router-link></span></p>
