...
<div class="section">
<p><span class="merged" id="all.Spi7a.2.spl1" title="原文 : Helidon requires Java and Maven.">Helidonには、JavaおよびMavenが必要です。</span> <span class="merged" id="all.Spi7a.2.spl2" title="原文 : You might also need Docker and Kubernetes depending on how you plan to deploy your services.">サービスのデプロイ方法によっては、DockerおよびKubernetesも必要になる場合があります。</span> </p>

<div class="block-title"><span class="merged" id="all.eoZJz.2" title="原文 : Prerequisite product versions for Helidon 4.0.2"><span>Helidon 4.0.2の前提条件製品バージョン</span></span></div>
...
<tbody>
<tr>
<td class=""><span class="merged" id="all.17vEm3.2" title="原文 : Java&#160;SE&#160;21 (Open&#160;JDK&#160;21)"><a href="https://www.oracle.com/technetwork/java/javase/downloads" target="_blank">Java SE 21</a> (<a href="http://jdk.java.net" target="_blank">JDK 21を開く</a>)</span></td>
<td class=""><span class="merged" id="all.3uVV7D.2" title="原文 : Helidon requires Java 21+.">HelidonにはJava 21+が必要です。</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.UWTyd.2" title="原文 : Maven 3.8+"><a href="https://maven.apache.org/download.cgi" target="_blank">Maven 3.8+</a></span></td>
<td class=""><span class="merged" id="all.47RJEf.2" title="原文 : Helidon requires Maven 3.8+.">HelidonにはMaven 3.8+が必要です。</span></td>
</tr>
<tr>
