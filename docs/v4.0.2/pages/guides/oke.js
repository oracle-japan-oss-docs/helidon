...
<p class="admonition-inline"><span class="merged" id="all.2KaeU1.spl1" title="原文 : Remember to copy the generated token.">生成されたトークンを必ずコピーしてください。</span> <span class="merged" id="all.2KaeU1.spl2" title="原文 : You won’t be able to access it again.">再度アクセスすることはできません。</span> </p>
</div>
