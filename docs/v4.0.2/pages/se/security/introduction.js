...
<h2 id="_contents"><span class="merged" id="all.1Q34Zl.71"  title="原文:: Contents">目次</span></h2>
<div class="section">
<ul class="ulist">
<li>
<p><span class="merged" id="all.1S1Ao6.70" title="原文 : Overview"><router-link @click.native="this.scrollFix('#_overview')" to="#_overview">概要</router-link></span></p>

</li>
<li>
<p><span class="merged" id="all.1N6U52.52" title="原文 : Maven Coordinates"><router-link @click.native="this.scrollFix('#maven-coordinates')" to="#maven-coordinates">Maven連携</router-link></span></p>

</li>
<li>
<p><span class="merged" id="all.3grmMy.47" title="原文 : Usage"><router-link @click.native="this.scrollFix('#_usage')" to="#_usage">使用</router-link></span></p>
...
<div class="section">
<p><span class="merged" id="all.1rfrXg.spl1" title="原文 : Helidon Security provides authentication, authorization, and auditing for your Helidon application.">Helidonセキュリティは、Helidonアプリケーションの認証、認可および監査を提供します。</span> <span class="merged" id="all.1rfrXg.spl2"  title="原文: It includes the following features:">次の特徴があります。</span> </p>

<ol style="margin-left: 15px;">
<li>
<span class="merged" id="all.ZeYXY.spl1" title="原文 : Authentication - support for authenticating incoming requests, creating a security Subject with Principal and Grants.">認証 - 受信リクエストの認証、プリンシパルおよび付与を使用したセキュリティ・サブジェクトの作成のサポート。</span> <span class="merged" id="all.ZeYXY.spl2" title="原文 : Principal represents current user/service.">プリンシパルは、現在のユーザー/サービスを表します。</span> <span class="merged" id="all.ZeYXY.spl3" title="原文 : Grant may represent a Role, Scope etc. Responsibility to create Principals and Grants lies with with AuthenticationProvider SPI.">付与はロール、スコープなどを表すことができます。プリンシパルと権限付与を作成する職責は、AuthenticationProvider SPIにあります。</span> <span class="merged" id="all.ZeYXY.spl4" title="原文 : The following Principals are expected and supported by default:">次のプリンシパルが想定され、デフォルトでサポートされています:</span> 
<ol style="margin-left: 15px;">
<li>
...
<div class="section">
<p><span class="merged" id="all.1UefFv.1" title="原文 : To enable Security add the following dependency to your project’s pom.xml (see Managing Dependencies).">セキュリティを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<h2 id="_usage"><span class="merged" id="all.JUOSC.66"  title="原文:: Usage">使用</span></h2>
<div class="section">
...
<p><span class="merged" id="all.3Cpq1J" title="原文 : Once a security instance is built, it can be used to initialize an integration with a container, or to use security from a program directly:">セキュリティ・インスタンスが構築されると、それを使用して<router-link to="/se/security/containers-integration">「コンテナとの統合」</router-link>を初期化したり、プログラムから直接セキュリティを使用できます:</span></p>
...
<h3 id="_builder_pattern"><span class="merged" id="all.2JzOyB" title="原文 : Builder Pattern">ビルダー・パターン</span></h3>
<div class="section">
<markup
lang="java"
...
<h3 id="_configuration_pattern"><span class="merged" id="all.14SBU" title="原文 : Configuration Pattern">構成パターン</span></h3>
<div class="section">
<p><span class="merged" id="all.2m6Va5" title="原文 : See Secure config for details about encrypting passwords in configuration files.">構成ファイルでのパスワードの暗号化の詳細は、<router-link to="/se/security/tools">「セキュアな構成」</router-link>を参照してください。</span></p>
...
<h4 id="_overriding_configuration"><span class="merged" id="all.KmX6B" title="原文 : Overriding Configuration">構成のオーバーライド</span></h4>
<div class="section">
...
<h3 id="_hybrid_pattern_builder_with_configuration"><span class="merged" id="all.41RW4q" title="原文 : Hybrid Pattern (Builder with Configuration)">ハイブリッド・パターン(構成を持つビルダー)</span></h3>
<div class="section">
<markup
lang="java"
