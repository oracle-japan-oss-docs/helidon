...
<ul class="ulist">
<li>
<p><span class="merged" id="all.AvkrI" title="原文 : Security Providers"><router-link @click.native="this.scrollFix('#_security_providers')" to="#_security_providers">セキュリティ・プロバイダ</router-link></span></p>

</li>
<li>
<p><span class="merged" id="all.2nJnui" title="原文 : Provider Selection Policy"><router-link @click.native="this.scrollFix('#_provider_selection_policy')" to="#_provider_selection_policy">プロバイダ選択ポリシー</router-link></span></p>

</li>
<li>
<p><span class="merged" id="all.1ysWWZ" title="原文 : Framework Integration"><router-link @click.native="this.scrollFix('#_framework_integration')" to="#_framework_integration">フレームワーク統合</router-link></span></p>
...
<h2 id="_security_providers"><span class="merged" id="all.1VavYU"  title="原文:: Security Providers">セキュリティ・プロバイダ</span></h2>
<div class="section">
<p><span class="merged" id="all.2532vo" title="原文 : You can build a custom provider for each type of security concept supported.">サポートされているセキュリティ概念のタイプごとに、カスタム・プロバイダをビルドできます。</span></p>
...
<h3 id="_authentication_provider"><span class="merged" id="all.2fCKrd"  title="原文:: Authentication Provider">認証プロバイダ</span></h3>
<div class="section">
...
<h3 id="_authorization_provider"><span class="merged" id="all.1LxAmv"  title="原文:: Authorization Provider">認可プロバイダ</span></h3>
<div class="section">
...
<h3 id="_outbound_security_provider"><span class="merged" id="all.43IX4M" title="原文 : Outbound Security Provider">アウトバウンド・セキュリティ・プロバイダ</span></h3>
<div class="section">
...
<h3 id="_audit_provider"><span class="merged" id="all.3zLH83" title="原文 : Audit Provider">監査プロバイダ</span></h3>
<div class="section">
...
<h2 id="_provider_selection_policy"><span class="merged" id="all.1H69Uj" title="原文 : Provider Selection Policy">プロバイダ選択ポリシー</span></h2>
<div class="section">
...
<h2 id="_framework_integration"><span class="merged" id="all.3M43ju" title="原文 : Framework Integration">フレームワーク統合</span></h2>
<div class="section">
