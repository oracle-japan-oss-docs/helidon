...
<div class="section">
<p><span class="merged" id="all.4VCyUH" title="原文 : To enable GraphQL add the following dependency to your project’s pom.xml (see Managing Dependencies).">GraphQLを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
>private static GraphQLSchema buildSchema() {
    ...
    DataFetcher&lt;List&lt;String&gt;&gt; hellosDataFetcher = (DataFetcher&lt;List&lt;String&gt;&gt;) environment -&gt;
            List.of("Bonjour", "Hola", "Zdravstvuyte", "NÇn hÇo", "Salve", "Gudday",
...
<thead>
<tr>
<th><span class="merged" id="all.2XKMH3.141"  title="原文:: key">キー</span></th>
<th><span class="merged" id="all.G3u1e.141"  title="原文:: default value">デフォルト値</span></th>
<th><span class="merged" id="all.20ls8M.147"  title="原文:: description">説明</span></th>
</tr>
</thead>
<tbody>
<tr>
...
<thead>
<tr>
<th><span class="merged" id="all.2XKMH3.142"  title="原文:: key">キー</span></th>
<th><span class="merged" id="all.G3u1e.142"  title="原文:: default value">デフォルト値</span></th>
<th><span class="merged" id="all.20ls8M.148"  title="原文:: description">説明</span></th>
</tr>
</thead>
<tbody>
<tr>
...
{"data":{"helloInDifferentLanguages":["Bonjour","Hola","Zdravstvuyte","NÇn hÇo","Salve","Gudday","Konnichiwa","Guten Tag"]}}</markup>
...
<ul class="ulist">
<li>
<p><span class="merged" id="all.33Eiep" title="原文 : GraphQL Javadocs"><a href="/apidocs/io.helidon.graphql.server/module-summary.html" target="_blank">GraphQL Javadocs</a></span></p>
