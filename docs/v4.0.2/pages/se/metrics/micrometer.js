...
<h2 id="_contents"><span class="merged" id="all.1Q34Zl.61"  title="原文:: Contents">目次</span></h2>
<div class="section">
<ul class="ulist">
<li>
<p><span class="merged" id="all.1S1Ao6.60" title="原文 : Overview"><router-link @click.native="this.scrollFix('#_overview')" to="#_overview">概要</router-link></span></p>

</li>
<li>
<p><span class="merged" id="all.1N6U52.43" title="原文 : Maven Coordinates"><router-link @click.native="this.scrollFix('#maven-coordinates')" to="#maven-coordinates">Maven連携</router-link></span></p>

</li>
<li>
<p><span class="merged" id="all.3grmMy.38" title="原文 : Usage"><router-link @click.native="this.scrollFix('#_usage')" to="#_usage">使用</router-link></span></p>
<ul class="ulist">
<li>
<p><span class="merged" id="all.4RZuZ3" title="原文 : Registering and Updating Meters"><router-link @click.native="this.scrollFix('#_registering_and_updating_meters')" to="#_registering_and_updating_meters">メーターの登録および更新</router-link></span></p>

</li>
<li>
<p><span class="merged" id="all.WOuC7" title="原文 : Accessing the Helidon Micrometer Endpoint"><router-link @click.native="this.scrollFix('#_accessing_the_helidon_micrometer_endpoint')" to="#_accessing_the_helidon_micrometer_endpoint">Helidon Micrometerエンドポイントへのアクセス</router-link></span></p>
...
<li>
<p><span class="merged" id="all.4RBAqg.23" title="原文 : API"><router-link @click.native="this.scrollFix('#_api')" to="#_api">API</router-link></span></p>
<ul class="ulist">
<li>
<p><span class="merged" id="all.3fbDx" title="原文 : The Helidon Micrometer API"><router-link @click.native="this.scrollFix('#_the_helidon_micrometer_api')" to="#_the_helidon_micrometer_api">The Helidon Micrometer API</router-link></span></p>
...
<li>
<p><span class="merged" id="all.26FILD.35" title="原文 : Configuration"><router-link @click.native="this.scrollFix('#_configuration')" to="#_configuration">構成</router-link></span></p>
...
<ul class="ulist">
<li>
<p><span class="merged" id="all.kBkUl" title="原文 : Register an Instance of MicrometerSupport with the Web Server"><router-link @click.native="this.scrollFix('#_register_an_instance_of_micrometersupport_with_the_web_server')" to="#_register_an_instance_of_micrometersupport_with_the_web_server">WebサーバーへのMicrometerSupportインスタンスの登録</router-link></span></p>

</li>
<li>
<p><span class="merged" id="all.24VGfX" title="原文 : Create and Update Meters in Your Application Service"><router-link @click.native="this.scrollFix('#_create_and_update_meters_in_your_application_service')" to="#_create_and_update_meters_in_your_application_service">アプリケーション・サービスでのメーターの作成および更新</router-link></span></p>
...
<h2 id="_overview"><span class="merged" id="all.YrpRV.76"  title="原文:: Overview">概要</span></h2>
<div class="section">
...
<p><span class="merged" id="all.4TumW3" title="原文 : In Helidon 4.0.2, Micrometer support is separate from the Helidon SE metrics API and the built-in Helidon metrics.">Helidon 4.0.2では、マイクロメーターのサポートは、Helidon SEメトリクスAPIおよび組込みのHelidonメトリクスとは異なります。</span></p>
...
<div class="section">
<p><span class="merged" id="all.4eQpnm.1" title="原文 : To enable Micrometer support add the following dependency to your project’s pom.xml (see Managing Dependencies).">Micrometerサポートを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<h2 id="_usage"><span class="merged" id="all.JUOSC.56"  title="原文:: Usage">使用</span></h2>
<div class="section">
...
<h2 id="_configuration"><span class="merged" id="all.Pfqvy.40"  title="原文:: Configuration">構成</span></h2>
<div class="section">
...
<p><span class="merged" id="all.4EPY05.2" title="原文 : Type: io.helidon.integrations.micrometer.MicrometerFeature">タイプ: <a href="/apidocs/io.helidon.integrations.micrometer/io/helidon/integrations/micrometer/MicrometerFeature.html" target="_blank">io.helidon.integrations.micrometer.MicrometerFeature</a></span></p>
...
<h3 id="_configuration_options"><span class="merged" id="all.3SKgM1.133"  title="原文:: Configuration options">構成オプション</span></h3>
<div class="section">
<div class="block-title"><span class="merged" id="all.271SGn.126" title="原文 : Optional configuration options"><span>オプションの構成オプション</span></span></div>
...
<thead>
<tr>
<th><span class="merged" id="all.2XKMH3.145"  title="原文:: key">キー</span></th>
<th><span class="merged" id="all.2ZwVVB.140"  title="原文:: type">タイプ</span></th>
<th><span class="merged" id="all.G3u1e.145"  title="原文:: default value">デフォルト値</span></th>
<th><span class="merged" id="all.20ls8M.151"  title="原文:: description">説明</span></th>
</tr>
</thead>
<tbody>
<tr>
<td class=""><span class="merged" id="all.32ANVF.3"  title="原文: cross-origin-config"><code>cross-origin-config</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.2cqsnT.9" title="原文 : CrossOriginConfig"><router-link to="/config/io_helidon_cors_CrossOriginConfig">CrossOriginConfig</router-link></span></p>

</doc-view>
</td>
<td class="">&#160;</td>
<td class=""><doc-view>
<p><span class="merged" id="all.38IWdR.3" title="原文 : Set the CORS config from the specified CrossOriginConfig object.">指定された<code>CrossOriginConfig</code>オブジェクトからCORS構成を設定します。</span></p>
...
<td class="">&#160;</td>
<td class=""><doc-view>
<p><span class="merged" id="all.3P8Bb4.3" title="原文 : Set the root context for the REST API of the service.">サービスのREST APIのルート・コンテキストを設定します。</span></p>
...
<div class="section">
<p><span class="merged" id="all.2uaHHd" title="原文 : Helidon SE includes an example application which uses Micrometer support.">Helidon SEには、Micrometerサポートを使用する<a href="https://github.com/oracle/helidon/tree/4.0.2/examples/integrations/micrometer/se" target="_blank">「サンプル・アプリケーション」</a>が含まれています。</span></p>
...
<li>
<span class="merged" id="all.3BKGZg" title="原文 : Create meters using the meter registry managed by Helidon’s MicrometerSupport and then update and query those meters.">Helidonの<code>MicrometerSupport</code>で管理されるメーター・レジストリを使用してメーターを作成し、それらのメーターを更新および問合せします。</span>

</li>
</ol>


<h3 id="_register_an_instance_of_micrometersupport_with_the_web_server"><span class="merged" id="all.4QqFpI" title="原文 : Register an Instance of MicrometerSupport with the Web Server">WebサーバーへのMicrometerSupportインスタンスの登録</span></h3>
<div class="section">
<markup
lang="java"
...
<li data-value="3"><span class="merged" id="all.1JU9sI" title="原文 : Pass the MicrometerSupport object’s meter registry to your service for use in creating and updating meters.">メーターの作成および更新に使用するために、<code>MicrometerSupport</code>オブジェクトのメーター・レジストリをサービスに渡します。</span></li>
</ul>

</div>


<h3 id="_create_and_update_meters_in_your_application_service"><span class="merged" id="all.4E0Q8Z" title="原文 : Create and Update Meters in Your Application Service">アプリケーション・サービスでのメーターの作成および更新</span></h3>
<div class="section">
<markup
lang="java"
...
<h4 id="_using_micrometersupport_builder"><span class="merged" id="all.2uF4LY" title="原文 : Using MicrometerSupport.Builder">MicrometerSupport.Builderの使用</span></h4>
<div class="section">
...
<li>
<p><span class="merged" id="all.1Dxf9W" title="原文 : Instantiate a Micrometer meter registry yourself, configured however you want, and add it to the MicrometerSupport object’s collection of meter registries">必要に応じて自分で構成したマイクロメーター・レジストリをインスタンス化し、<code>MicrometerSupport</code>オブジェクトのメーター・レジストリのコレクションに追加</span></p>
...
<p><span class="merged" id="all.1Y1gXE.1.spl1" title="原文 : The configuration keys that are valid for the builtin-registries child entries depend on the type of Micrometer meter registry."><code>builtin-registries</code>の子エントリに対して有効な構成キーは、マイクロメーター・レジストリのタイプによって異なります。</span> <span class="merged" id="all.1Y1gXE.1.spl2" title="原文 : For example, support in Helidon for the Prometheus meter registry respects the prefix configuration setting but other meter registries might not and might support other settings.">たとえば、<a href="https://javadoc.io/doc/io.micrometer/micrometer-registry-prometheus/1.11.1/io/micrometer/prometheus/PrometheusConfig.html" target="_blank">「Prometheusメーター・レジストリ」</a>に対するHelidonのサポートは<code>prefix</code>構成設定を尊重しますが、他のメーター・レジストリは他の設定をサポートしていない場合があります。</span> <span class="merged" id="all.1Y1gXE.1.spl3" title="原文 : Refer to the documentation for the meter registry you want to configure to find out what items apply to that registry type.">構成するメーター・レジストリのドキュメントを参照して、そのレジストリ・タイプに適用される項目を確認してください。</span> </p>
...
<h3 id="_enrolling_other_micrometer_meter_registries"><span class="merged" id="all.4duMYl" title="原文 : Enrolling Other Micrometer Meter Registries">その他のマイクロメーター・レジストリの登録</span></h3>
<div class="section">
...
<li data-value="2"><span class="merged" id="all.37gfGM" title="原文 : Provide the function that checks if the ServerRequest accepts content that your meter registry can produce (e.g., either text/plain or unspecified is normally an indication for Prometheus-style output) and returns the appropriate Optional&lt;Handler&gt;."><a href="/apidocs/io.helidon.webserver/io/helidon/webserver/ServerRequest.html" target="_blank"><code>ServerRequest</code></a>がメーター・レジストリで生成可能なコンテンツを受け入れ(たとえば、<code>text/plain</code>または未指定は通常、プロンプト・スタイルの出力を示します)、適切な<code>Optional&lt;<a href="/apidocs/io.helidon.webserver/io/helidon/webserver/Handler.html" target="_blank"><code>Handler</code></a> > </code>を返すファンクションを指定します。</span></li>
<li data-value="3"><span class="merged" id="all.lI7eO" title="原文 : A very simple in-line Handler that sets the response entity from the Prometheus registry’s scrape() method.">Prometheusレジストリの<code>scrape()</code>メソッドからレスポンス・エンティティを設定する非常に単純なインライン<code>Handler</code>。</span></li>
</ul>
