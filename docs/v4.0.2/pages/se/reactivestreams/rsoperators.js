...
<h2 id="_contents"><span class="merged" id="all.1Q34Zl.69"  title="原文:: Contents">目次</span></h2>
<div class="section">
<ul class="ulist">
<li>
<p><span class="merged" id="all.1S1Ao6.68" title="原文 : Overview"><router-link @click.native="this.scrollFix('#_overview')" to="#_overview">概要</router-link></span></p>
...
<h2 id="_overview"><span class="merged" id="all.YrpRV.84"  title="原文:: Overview">概要</span></h2>
<div class="section">
<p><span class="merged" id="all.25RQsS.1.spl1" title="原文 : Helidon implements MicroProfile Reactive Streams Operators specification which defines reactive operators and provides a standardized tool for manipulation with Reactive Streams.">Helidonは、リアクティブ・オペレータを定義し、<a href="https://www.reactive-streams.org/" target="_blank">「リアクティブ・ストリーム」</a>で操作するための標準化されたツールを提供する<a href="https://download.eclipse.org/microprofile/microprofile-reactive-streams-operators-3.1.1/microprofile-reactive-streams-operators-spec-3.1.1.html" target="_blank">「MicroProfileリアクティブ・ストリーム・オペレータ」</a>仕様を実装します。</span> <span class="merged" id="all.25RQsS.1.spl2" title="原文 : You can use MicroProfile Reactive Streams Operators when you want to maintain source-level portability between different implementations.">異なる実装間でソース・レベルの移植性を維持する場合は、MicroProfileリアクティブ・ストリーム・オペレータを使用できます。</span> </p>
...
<div class="section">
<p><span class="merged" id="all.1AWlFJ" title="原文 : To enable Reactive Streams add the following dependency to your project’s pom.xml (see Managing Dependencies).">リアクティブ・ストリームを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<h2 id="_usage"><span class="merged" id="all.JUOSC.64"  title="原文:: Usage">使用</span></h2>
<div class="section">
<p><span class="merged" id="all.3RzMbG.1" title="原文 : The MicroProfile Reactive Streams Operators specification provides a set of operators within stages, as well as the builders used to prepare graphs of stages from which streams can be built.">MicroProfileリアクティブ・ストリーム・オペレータ仕様は、ステージ内の一連のオペレータと、ストリームの構築元となるステージのグラフを準備するために使用されるビルダーを提供します。</span></p>
...
<tr>
<td class=""><span class="merged" id="all.2rzLy7.3"  title="原文: flatMapCompletionStage">flatMapCompletionStage</span></td>
...
<tr>
<td class=""><span class="merged" id="all.vfpqc.3"  title="原文: ifEmpty">ifEmpty</span></td>
<td class=""><span class="merged" id="all.1Okd6E.3" title="原文 : Executes given java.lang.Runnable when stream is finished without value(empty stream).">value(empty stream)なしでストリームが終了したときに、指定された<code>java.lang.Runnable</code>を実行します。</span></td>
</tr>
<tr>
...
<div class="section">
<p><span class="merged" id="all.3OSFwg.1" title="原文 : Graphs are pre-prepared stream builders with stages, which can be combined to closed graph with methods via and to."><a href="https://download.eclipse.org/microprofile/microprofile-reactive-streams-operators-3.1.1/microprofile-reactive-streams-operators-spec-3.1.1.html#_graphs" target="_blank">「グラフ」</a>は、<a href="https://download.eclipse.org/microprofile/microprofile-reactive-streams-operators-3.1.1/microprofile-reactive-streams-operators-spec-3.1.1.html#_stages" target="_blank">「ステージ」</a>を使用して事前に準備されたストリーム・ビルダーで、<code>via</code>および<code>to</code>メソッドを使用して閉じられたグラフに結合できます。</span></p>
...
<ul class="ulist">
<li>
<p><span class="merged" id="all.27d8i0.1" title="原文 : MicroProfile Reactive Streams Operators Specification"><a href="https://download.eclipse.org/microprofile/microprofile-reactive-streams-operators-3.1.1/microprofile-reactive-streams-operators-spec-3.1.1.html" target="_blank">MicroProfileリアクティブ・ストリーム・オペレータの指定</a></span></p>

</li>
<li>
<p><span class="merged" id="all.1pZzi1.1" title="原文 : MicroProfile Reactive Streams Operators JavaDoc"><a href="https://download.eclipse.org/microprofile/microprofile-reactive-streams-operators-3.1.1/apidocs" target="_blank">MicroProfileリアクティブ・ストリーム・オペレータJavaDoc</a></span></p>

</li>
<li>
<p><span class="merged" id="all.3nQ0Nb.1" title="原文 : MicroProfile Reactive Streams Operators on GitHub"><a href="https://github.com/eclipse/microprofile-reactive-streams-operators" target="_blank">MicroProfile GitHubのリアクティブ・ストリーム・オペレータ</a></span></p>
