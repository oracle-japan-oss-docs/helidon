...
<dl>
<dt slot=title><span class="merged" id="all.30aNM2" title="原文 : Helidon SE 2.x Upgrade Guide">Helidon SE 2.xアップグレード・ガイド</span></dt>
...
<h2 id="_java_11_runtime"><span class="merged" id="all.2Qxnfe.1"  title="原文:: Java 11 Runtime">Java 11 Runtime</span></h2>
<div class="section">
<p><span class="merged" id="all.3qDTVL.1.spl1" title="原文 : Java 8 is no longer supported in Helidon 2.">Java 8は、Helidon 2でサポートされなくなりました。</span> <span class="merged" id="all.3qDTVL.1.spl2"  title="原文:: Java 11 or newer is required.">Java 11以上が必要です。</span> </p>

</div>


<h2 id="_tracing"><span class="merged" id="all.4Mk18P.1"  title="原文:: Tracing">トレース</span></h2>
<div class="section">
...
<ul class="ulist">
<li>
<p><span class="merged" id="all.3eGOkr" title="原文 : io.helidon.http.media.jsonp.JsonpSupport in module io.helidon.http.media:helidon-media-jsonp">モジュール<code>io.helidon.http.media:helidon-media-jsonp</code>の<code>io.helidon.http.media.jsonp.JsonpSupport</code></span></p>

</li>
<li>
<p><span class="merged" id="all.nQUHt" title="原文 : io.helidon.http.media.jsonb.JsonbSupport in module io.helidon.http.media:helidon-media-jsonb">モジュール<code>io.helidon.http.media:helidon-media-jsonb</code>の<code>io.helidon.http.media.jsonb.JsonbSupport</code></span></p>

</li>
<li>
<p><span class="merged" id="all.3ACQ1x" title="原文 : io.helidon.http.media.jackson.JacksonSupport in module io.helidon.http.media:helidon-media-jackson">モジュール<code>io.helidon.http.media:helidon-media-jackson</code>の<code>io.helidon.http.media.jackson.JacksonSupport</code></span></p>
