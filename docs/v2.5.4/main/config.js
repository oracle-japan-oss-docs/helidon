                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                { href: '/about/04_windows', title: 'WindowsのHelidon' },
                                { href: '/about/05_cli', title: 'Helidon CLI' },
                                { href: '/about/05_kubernetes', title: 'デスクトップ上のKubernetes' },
                                { href: '/about/10_upgrade', title: '1.4 からのアップグレード' }
                            ]
                        }
                    ]
                },
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                { href: '/se/config/06_advanced-configuration', title: '拡張構成に関するトピック' },
                                { href: '/se/config/07_extensions', title: '拡張' },
                                { href: '/se/config/08_supported-formats', title: 'サポートされているその他の形式およびソース' },
                                { href: '/se/config/09_config-profiles', title: '構成プロファイル' }
                            ]
                        },
                        {
                            title: 'コア',
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                { href: '/se/metrics/01a_metrics_capable_components', title: 'メトリクス対応モジュール' },
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                { href: '/se/webserver/04_request-handling', title: 'リクエストの処理' },
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                { href: '/mp/guides/38_testing_junit5', title: 'JUnit 5ガイドによるHelidon MPテスト' },
                                { href: '/mp/guides/39_jbatch', title: 'JBatchガイド付きHelidon' }
                            ]
                        },
                        {
                            title: 'Beanバリデーション',
                            ...
                            items: [
                                ...
                                { href: '/mp/beanvalidation/02_general_beanvalidation', title: '一般Beanバリデーション' }
                            ]
                        },
                        {
                            title: '構成',
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                { href: '/mp/extensions/04_cdi_oci-objectstorage', title: 'OCIのCDI拡張' },
                        ...
                        },
                        {
                            ...
                            group: '/mp/health',
                            items: [
                                { href: '/mp/health/01_introduction', title: 'MicroProfileヘルス' }
                            ]
                        },
                        {
                            title: 'JAX-RS/Jersey',
                            ...
                            items: [
                                ...
                                { href: '/mp/jaxrs/05_jaxrs-applications', title: 'JAX-RSアプリケーション' },
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                { href: '/mp/lra/02_coordinator', title: 'コーディネータ' },
                                { href: '/mp/lra/03_participant', title: '参加者' }
                            ]
                        },
                        {
                            title: 'メトリクス',
                            ...
                            items: [
                                ...
                                { href: '/mp/metrics/01a_metrics_capable_components', title: 'メトリクス対応モジュール' },
