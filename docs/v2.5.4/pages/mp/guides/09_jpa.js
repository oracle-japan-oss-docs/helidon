...
<div class="section">
<p><span class="merged" id="all.3XHn7m" title="原文 : For this 30 minute tutrial, you&rsquo;ll need the following:">この30分のトライアルでは、次のものが必要です:</span></p>
...
<tbody>
<tr>
<td class=""><span class="merged" id="all.1hKNxI.7" title="原文 : A Helidon {upper-case-flavor} Application">Helidon {upper-case-flavor} アプリケーション</span></td>
<td class=""><span class="merged" id="all.3jMlMY.7" title="原文 : You can use your own application or use the Helidon {upper-case-flavor} Quickstart to create a sample application.">独自のアプリケーションを使用するか、<a href="https://helidon.io/docs/v2/#/{lower-case-flavor}/guides/02_quickstart" id="" target="_blank" >「Helidon {upper-case-flavor} クイックスタート」</a>を使用してサンプル・アプリケーションを作成できます。</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.3UjXGj.8" title="原文 : Java&#160;SE&#160;11 (Open&#160;JDK&#160;11)"><a href="https://www.oracle.com/technetwork/java/javase/downloads" id="" target="_blank" >Java&#160;SE&#160;11</a> (<a href="http://jdk.java.net" id="" target="_blank" >Open&#160;JDK&#160;11</a>)</span></td>
<td class=""><span class="merged" id="all.3e6V0X.8" title="原文 : Helidon requires Java 11+.">HelidonにはJava 11以上が必要です。</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.1nyTbh.10" title="原文 : Maven 3.6.1+"><a href="https://maven.apache.org/download.cgi" id="" target="_blank" >Maven 3.6.1+</a></span></td>
<td class=""><span class="merged" id="all.3woDk0.8" title="原文 : Helidon requires Maven 3.6.1+.">Helidonには、Maven 3.6.1+が必要です。</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.1HtX9I.9"  title="原文:: Docker 18.09+"><a href="https://docs.docker.com/install/" id="" target="_blank" >Docker 18.09+</a></span></td>
...
<tr>
<td class=""><span class="merged" id="all.48aNQe.9"  title="原文:: Kubectl 1.16.5+"><a href="https://kubernetes.io/docs/tasks/tools/install-kubectl/" id="" target="_blank" >Kubectl 1.16.5+</a></span></td>
<td class=""><span class="merged" id="all.1tjPJQ.8" title="原文 : If you want to deploy to Kubernetes, you need kubectl and a Kubernetes cluster (you can install one on your desktop).">Kubernetesにデプロイする場合は、<code>kubectl</code>およびKubernetesクラスタ(<router-link to="/about/05_kubernetes">「デスクトップにインストール」</router-link>も可)が必要です。</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.4N9w7q.1"  title="原文:: curl"><a href="https://curl.se/download.html" id="" target="_blank" >curl</a></span></td>
<td class=""><span class="merged" id="all.2BBRFb.1" title="原文 : (Optional) for testing">(オプション)テスト用</span></td>
</tr>
</tbody>
</table>
</div>
...
<p class="admonition-inline"><span class="merged" id="all.2dOeYQ" title="原文 : This guide assumes that you have read the following: An understanding of named data source support in Helidon MP and An understanding of transaction support in Helidon MP.">このガイドでは、次の内容を読んだことを前提としています: <router-link to="/mp/guides/07_datasource">Helidon MPでの名前付きデータ・ソースのサポートの理解</router-link>および<router-link to="/mp/guides/08_jta">Helidon MPでのトランザクション・サポートの理解</router-link>。</span></p>
</div>
</div>
...
<h3 id="_add_the_h2_database_driver_to_the_runtime_classpath"><span class="merged" id="all.4FIoJ.1" title="原文 : Add the H2 Database Driver to the Runtime Classpath">H2データベース・ドライバのランタイム・クラスパスへの追加</span></h3>
<div class="section">
...
<h3 id="_add_the_hikari_connection_pool_extension_to_the_runtime_classpath"><span class="merged" id="all.3Jsz1M.1" title="原文 : Add the Hikari Connection Pool Extension to the Runtime Classpath">ランタイム・クラスパスへのHikari接続プール拡張機能の追加</span></h3>
<div class="section">
...
<h3 id="_add_the_jta_extension_to_the_runtime_classpath"><span class="merged" id="all.26FzI2" title="原文 : Add the JTA Extension to the Runtime Classpath">JTA拡張機能のランタイム・クラスパスへの追加</span></h3>
<div class="section">
...
<h3 id="_add_the_provider_independent_helidon_jpa_extension_to_the_runtime_classpath"><span class="merged" id="all.4XHXnA" title="原文 : Add the Provider-Independent Helidon JPA Extension to the Runtime Classpath">プロバイダに依存しないHelidon JPA拡張機能のランタイム・クラスパスへの追加</span></h3>
<div class="section">
...
<h3 id="_add_the_eclipselink_jpa_extension_to_the_runtime_classpath"><span class="merged" id="all.4XCkd4" title="原文 : Add the EclipseLink JPA Extension to the Runtime Classpath">EclipseLink JPA拡張機能のランタイム・クラスパスへの追加</span></h3>
<div class="section">
...
<h3 id="_add_the_jta_and_jpa_dependencies_to_the_provided_classpath"><span class="merged" id="all.4LY8VK" title="原文 : Add the JTA and JPA Dependencies to the Provided Classpath">指定したクラスパスへのJTAおよびJPA依存関係の追加</span></h3>
<div class="section">
...
<h3 id="_add_ddl_to_create_the_relevant_database_tables"><span class="merged" id="all.Tng4m" title="原文 : Add DDL to Create the Relevant Database Tables">関連データベース表を作成するためのDDLの追加</span></h3>
<div class="section">
...
<h3 id="_add_an_application_yaml_file_with_database_connectivity_information"><span class="merged" id="all.xk1tX.1" title="原文 : Add an application.yaml File With Database Connectivity Information">データベース接続情報を含む<code>application.yaml</code>ファイルの追加</span></h3>
<div class="section">
...
<h3 id="_add_a_java_class_to_represent_a_greeting_jpa_entity"><span class="merged" id="all.2apIFG" title="原文 : Add a Java Class to Represent a Greeting JPA Entity">応答JPAエンティティを表すJavaクラスの追加</span></h3>
<div class="section">
...
<h3 id="_add_a_meta_infpersistence_xml_descriptor"><span class="merged" id="all.31FiKI" title="原文 : Add a META-INF/persistence.xml Descriptor"><code>META-INF/persistence.xml</code>ディスクリプタの追加</span></h3>
<div class="section">
...
<h3 id="_modify_the_pom_xml_file_to_support_static_weaving"><span class="merged" id="all.4a8bwB" title="原文 : Modify the pom.xml File To Support Static Weaving">静的ウィービングをサポートするための<code>pom.xml</code>ファイルの変更</span></h3>
<div class="section">
