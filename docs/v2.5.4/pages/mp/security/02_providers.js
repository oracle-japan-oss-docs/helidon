...
<p><span class="merged" id="all.40iH1l" title="原文 : Note: If the example code uses clear-text passwords in configuration, ensure that you add the following to the code snippet:"><strong>ノート</strong> : このサンプル・コードで構成でクリアテキスト・パスワードを使用する場合は、コード・スニペットに次のものを追加してください:</span></p>

<div class="listing">
<markup>security:
  config.require-encryption: false</markup>
</div>

<p><span class="merged" id="all.1pYfB1.spl1" title="原文 : If set to true, an exception is thrown."><code>true</code>に設定すると、例外がスローされます。</span> <span class="merged" id="all.1pYfB1.spl2" title="原文 : However, in a production environment you would set this value to true so that any attempt to pass a clear-text password throws an exception.">ただし、実稼働環境では、クリアテキスト・パスワードを渡そうとすると例外がスローされるように、この値を<code>true</code>に設定します。</span> </p>
...
<td class="">&#160;</td>
<td class=""><span class="merged" id="all.25TDeJ" title="原文 : Cross-origin resource sharing settings (see below)">クロス・オリジンのリソース共有設定(下の<router-link @click.native="this.scrollFix('#cors')" to="#cors"></router-link>を参照)</span></td>
</tr>
<tr>
...
<h5 id="cors"><span class="merged" id="all.3bUB5l" title="原文 : CORS Settings">CORS設定</span></h5>
<div class="section">
...
<td class=""><span class="merged" id="all.m7sMH"  title="原文: [SIGNATURE,AUTHORIZATION,CUSTOM]"><code>[SIGNATURE,AUTHORIZATION,CUSTOM]</code></span></td>
<td class=""><span class="merged" id="all.2Qa1iS.spl1" title="原文 : Headers to look for inbound signatures and to store outbound signatures.">インバウンド・シグネチャを検索し、アウトバウンド・シグネチャを格納するヘッダー。</span> <span class="merged" id="all.2Qa1iS.spl2" title="原文 : CUSTOM is provided using io.helidon.security.util.TokenHandler"><code>CUSTOM</code> は、<code>io.helidon.security.util.TokenHandler</code>を使用して提供されます</span> </td>
</tr>
<tr>
...
<tr>
<td class=""><span class="merged" id="all.cn4Qk"  title="原文: outbound.*.signature.header"><code>outbound.*.signature.header</code></span></td>
<td class=""><span class="merged" id="all.m7sMH.1"  title="原文: [SIGNATURE,AUTHORIZATION,CUSTOM]"><code>[SIGNATURE,AUTHORIZATION,CUSTOM]</code></span></td>
<td class=""><span class="merged" id="all.K3eYa.spl1" title="原文 : Headers supported by HTTP Signature.">HTTPシグネチャでサポートされているヘッダー。</span> <span class="merged" id="all.K3eYa.spl2" title="原文 : CUSTOM is provided using io.helidon.security.util.TokenHandler"><code>CUSTOM</code> は、<code>io.helidon.security.util.TokenHandler</code>を使用して提供されます</span> </td>
</tr>
<tr>
