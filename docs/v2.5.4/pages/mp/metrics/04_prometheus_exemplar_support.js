...
<li>
<span class="merged" id="all.265yae" title="原文 : If a metric necessarily corresponds to a specific sample-​for example a minimum or maximum-​Helidon associates a sample that has that exact value as the exemplar for the metric.">メトリックが特定のサンプル(最小値または最大値など)に必ずしも対応する場合、Helidonは、その正確な値がメトリックの指針であるサンプルを関連付けます。</span>
