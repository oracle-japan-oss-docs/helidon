...
<div class="section">
<p><span class="merged" id="all.f2r7p.spl1" title="原文 : In configuration, Helidon represents basic CORS information as a section that contains one or more key/value pairs.">構成では、Helidonは、1つ以上のキー/バリューのペアを含むセクションとして基本的なCORS情報を表します。</span> <span class="merged" id="all.f2r7p.spl2" title="原文 : Each key-value pair assigns one characteristic of CORS behavior.">各キーと値のペアにCORS動作の特性が1つ割り当てられます。</span> </p>
...
<li>
<p><span class="merged" id="all.2xCtrN.1" title="原文 : See the Helidon CORS support in action by building and running the CORS example."><a href="https://github.com/oracle/helidon/tree/2.5.4/examples/microprofile/cors" id="" target="_blank" >「CORSの例」</a>をビルドして実行し、動作中のHelidon CORSサポートを参照してください。</span></p>
