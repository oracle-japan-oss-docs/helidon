...
<ul class="colist">
<li data-value="1"><span class="merged" id="all.2fcubm.spl1" title="原文 : the NamingFunction is just a lambda that returns the concatenated service name and method name with the prefix grpc."><code>NamingFunction</code>は、プレフィクス<code>grpc.</code>が付いた連結サービス名およびメソッド名を返すラムダにすぎません</span> <span class="merged" id="all.2fcubm.spl2" title="原文 : So for a service &quot;Foo&quot;, method &quot;bar&quot; the above example would produce a name &quot;grpc.Foo.bar&quot;.">そのため、サービス"Foo"の場合、メソッド"bar"の場合、前述の例では"grpc.Foo.bar"という名前が生成されます。</span> </li>
</ul>
</div>
</doc-view>
