...
<p><span class="merged" id="all.1P1Snm" title="原文 : In Helidon 2.5.4, Micrometer support is separate from the Helidon SE metrics API and the built-in Helidon metrics.">Helidon 2.5.4では、マイクロメーターのサポートは、Helidon SEメトリクスAPIおよび組込みHelidonメトリクスとは異なります。</span></p>
</dd>
</dl>
</v-card-text>
</v-card>
