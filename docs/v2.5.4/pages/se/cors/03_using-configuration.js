...
<th><span class="merged" id="all.3zyV5O.3" title="原文 : CORS Header Name">CORSヘッダー名</span></th>
</tr>
</thead>
<tbody>
<tr>
...
<td class=""><span class="merged" id="all.4dF9U6.3"  title="原文: Access-Control-Allow-Credentials"><code>Access-Control-Allow-Credentials</code></span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.3CeDxm.2"  title="原文: allow-headers"><code>allow-headers</code></span></td>
<td class=""><span class="merged" id="all.3P5UfM.9"  title="原文: [&quot;*&quot;]"><code>["*"]</code></span></td>
<td class=""><span class="merged" id="all.RsjK1.3"  title="原文: Access-Control-Allow-Headers"><code>Access-Control-Allow-Headers</code></span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.2GrPoY.2"  title="原文: allow-methods"><code>allow-methods</code></span></td>
<td class=""><span class="merged" id="all.3P5UfM.10"  title="原文: [&quot;*&quot;]"><code>["*"]</code></span></td>
<td class=""><span class="merged" id="all.3hrvIH.3"  title="原文: Access-Control-Allow-Methods"><code>Access-Control-Allow-Methods</code></span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.3lELH6.2"  title="原文: allow-origins"><code>allow-origins</code></span></td>
<td class=""><span class="merged" id="all.3P5UfM.11"  title="原文: [&quot;*&quot;]"><code>["*"]</code></span></td>
<td class=""><span class="merged" id="all.2FjaSx.3"  title="原文: Access-Control-Allow-Origins"><code>Access-Control-Allow-Origins</code></span></td>
</tr>
<tr>
...
<td class=""><span class="merged" id="all.yr2OR.3"  title="原文: Access-Control-Expose-Headers"><code>Access-Control-Expose-Headers</code></span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.znMla.2"  title="原文: max-age"><code>max-age</code></span></td>
<td class=""><span class="merged" id="all.3ukg0O.3"  title="原文: 3600"><code>3600</code></span></td>
<td class=""><span class="merged" id="all.4bPOg7.3"  title="原文: Access-Control-Max-Age"><code>Access-Control-Max-Age</code></span></td>
</tr>
<tr>
...
<p><span class="merged" id="all.226CVy.3" title="原文 : If the cross-origin configuration is disabled (enabled = false), then the Helidon CORS implementation ignores the cross-origin configuration entry.">クロス・オリジン構成が無効になっている場合(<code>enabled</code> = false)、Helidon CORS実装はクロス・オリジン構成エントリを無視します。</span></p>
...
<ul class="ulist">
<li>
<p><span class="merged" id="all.1zgzb1.1" title="原文 : An optional enabled setting which defaults to true and applies to the whole mapped CORS config section, and"><code>true</code>にデフォルト設定され、マップされたCORS構成セクション全体に適用されるオプションの<code>enabled</code>設定、および</span></p>
...
<ul class="ulist">
<li>
<p><span class="merged" id="all.1XKhTK.1" title="原文 : a basic CORS config section, and">基本的なCORS構成セクション、および</span></p>
...
<li>
<p><span class="merged" id="all.DtD4l.1" title="原文 : See the Helidon CORS support in action by building and running the CORS example."><a href="https://github.com/oracle/helidon/tree/2.5.4/examples/cors" id="" target="_blank" >「CORSの例」</a>をビルドして実行し、動作中のHelidon CORSサポートを参照してください。</span></p>
