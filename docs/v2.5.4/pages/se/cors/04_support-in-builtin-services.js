...
<th><span class="merged" id="all.1Ov129.7"  title="原文:: Configuration Key">構成キー</span></th>
</tr>
</thead>
<tbody>
<tr>
...
<p><span class="merged" id="all.2fUbk4" title="原文 : The Helidon SE QuickStart example uses these services, so you can use that as a template for your own application, or use the example project itself to experiment with customizing the CORS behavior in the built-in services."><a href="https://github.com/oracle/helidon/tree/2.5.4/examples/quickstarts/helidon-quickstart-se" id="" target="_blank" >「Helidon SE QuickStartの例」</a>ではこれらのサービスが使用されるため、独自のアプリケーションのテンプレートとして使用することも、サンプル・プロジェクト自体を使用して組込みサービスのCORS動作のカスタマイズを試すこともできます。</span></p>
