...
<tbody>
<tr>
<td class=""><span class="merged" id="all.41roYO.1" title="原文 : About 20 minutes">約20分</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.27GIMH.7" title="原文 : Helidon Prerequisites"><router-link to="/about/03_prerequisites">Helidonの前提条件</router-link></span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.3h2Pge" title="原文 : curl (for testing)"><code>curl</code> (テスト用)</span></td>
</tr>
</tbody>
</table>
</div>
...
<h2 id="_add_an_application_yaml_file_with_database_connectivity_information"><span class="merged" id="all.xk1tX" title="原文 : Add an application.yaml File With Database Connectivity Information">データベース接続情報を含む<code>application.yaml</code>ファイルの追加</span></h2>
<div class="section">
...
<h2 id="_inject_a_datasource_in_your_application_code"><span class="merged" id="all.3ywnxV" title="原文 : Inject a DataSource in Your Application Code">アプリケーション・コードへの<a href="https://docs.oracle.com/javase/8/docs/api/javax/sql/DataSource.html" id="" target="_blank" ><code>DataSource</code></a>のインジェクト</span></h2>
<div class="section">
...
<h2 id="_use_the_injected_datasource"><span class="merged" id="all.XGTx2" title="原文 : Use The Injected DataSource">インジェクトされた<code>DataSource</code>の使用</span></h2>
<div class="section">
...
<div class="section">
<p><span class="merged" id="all.bTAk" title="原文 : Helidon features a few examples of projects that use data sources.">Helidonには、データ・ソースを使用するプロジェクトの例がいくつかあります。</span></p>
