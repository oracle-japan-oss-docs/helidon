...
<h2 id="_what_you_need"><span class="merged" id="all.mQ2U1.6"  title="原文:: What you need">必要事項</span></h2>
<div class="section">
...
<tbody>
<tr>
<td class=""><span class="merged" id="all.wqDOs.4" title="原文 : About 30 minutes">約30分</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.27GIMH.10" title="原文 : Helidon Prerequisites"><router-link to="/about/03_prerequisites">Helidonの前提条件</router-link></span></td>
</tr>
</tbody>
</table>
</div>
...
<h2 id="_create_the_maven_project"><span class="merged" id="all.4dQgm8" title="原文 : Create The Maven Project">Mavenプロジェクトの作成</span></h2>
<div class="section">
...
<h2 id="_start_implementing_the_microprofile_application"><span class="merged" id="all.3CnvkY" title="原文 : Start implementing the MicroProfile application">MicroProfileアプリケーションの実装の開始</span></h2>
<div class="section">
...
<p><span class="merged" id="all.pN3vX.1.spl1" title="原文 : A main class is also required to start up the server and run the application.">サーバーを起動してアプリケーションを実行するには、メイン・クラスも必要です。</span> <span class="merged" id="all.pN3vX.1.spl2" title="原文 : If you don&rsquo;t use Helidon&rsquo;s built-in main class you can define your own:">Helidonの組込みメイン・クラスを使用しない場合は、独自のクラスを定義できます:</span> </p>
...
<h2 id="_build_the_application"><span class="merged" id="all.Vamel"  title="原文:: Build the application">アプリケーションのビルド</span></h2>
<div class="section">
...
<p><span class="merged" id="all.2O8bJP.spl1" title="原文 : This will build the application jar and save all runtime dependencies in the target/libs directory.">これにより、アプリケーションjarがビルドされ、すべてのランタイム依存性が<code>target/libs</code>ディレクトリに保存されます。</span> <span class="merged" id="all.2O8bJP.spl2" title="原文 : This means you can easily start the application by running the application jar file:">つまり、アプリケーションjarファイルを実行することで、アプリケーションを簡単に起動できます:</span> </p>
...
<markup
lang="bash"
title="初期microprofile-config.properties"
...
<markup
lang="bash"
title="更新されたMETA-INF/microprofile-config.properties"
># Microprofile server properties
server.port=8080
server.host=0.0.0.0
...
<h2 id="_extending_the_application"><span class="merged" id="all.1jyr9N" title="原文 : Extending the application">アプリケーションの拡張</span></h2>
<div class="section">
...
<markup
lang="java"
title="GreetResource.javaの新しいメソッド"
...
<markup
lang="properties"
title="logging.propertiesファイルの例"
...
<markup
lang="bash"
title="デフォルトのレディネスおよびリブネス・エンドポイント"
># readiness
...
<li data-value="3"><span class="merged" id="all.2J6OuF.spl1" title="原文 : The GreetingProvider is injected using Context and Dependency Injection."><code>GreetingProvider</code>は、コンテキストと依存性のインジェクションを使用してインジェクトされます。</span> <span class="merged" id="all.2J6OuF.spl2" title="原文 : This example will use the greeting to determine whether the application is healthy, this is a contrived example for demonstration purposes.">この例では、グリーティングを使用して、アプリケーションが健全かどうかを判断します。これはデモ用の現実的な例です。</span> </li>
...
<markup
lang="bash"
title="非健全な状態を報告するカスタム・ヘルス・チェック"
