...
<h2 id="_what_you_need"><span class="merged" id="all.mQ2U1.4"  title="原文:: What you need">必要事項</span></h2>
<div class="section">
...
<tbody>
<tr>
<td class=""><span class="merged" id="all.41roYO" title="原文 : About 20 minutes">約20分</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.27GIMH.5" title="原文 : Helidon Prerequisites"><router-link to="/about/03_prerequisites">Helidonの前提条件</router-link></span></td>
</tr>
</tbody>
</table>
</div>
...
<li>
<p><span class="merged" id="all.13FZ2S" title="原文 : Restrict access to a specific role"><router-link @click.native="this.scrollFix('#_restrict_access_to_a_specific_role')" to="#_restrict_access_to_a_specific_role">特定のロールへのアクセスの制限</router-link></span></p>
...
<h5 id="_start_keycloak"><span class="merged" id="all.1Wa2Zu" title="原文 : Start Keycloak">Keycloakの起動</span></h5>
<div class="section">
...
<h5 id="_create_an_admin_user"><span class="merged" id="all.2CNwrJ" title="原文 : Create an admin user">管理ユーザーの作成</span></h5>
<div class="section">
...
<h3 id="_set_up_keycloak"><span class="merged" id="all.LItef" title="原文 : Set up Keycloak">Keycloakの設定</span></h3>
<div class="section">
...
<h4 id="_create_a_realm"><span class="merged" id="all.Jz23p"  title="原文:: Create a realm">レルムの作成</span></h4>
<div class="section">
...
<h4 id="_create_a_user"><span class="merged" id="all.2ZgCmS"  title="原文:: Create a user">ユーザーを作成します</span></h4>
<div class="section">
...
<h4 id="_create_a_client"><span class="merged" id="all.4esYak" title="原文 : Create a Client">クライアントの作成</span></h4>
<div class="section">
...
<markup
lang="bash"
title="プロジェクトはhelidon-quickstart-mpディレクトリからビルドおよび実行されます:"
>cd helidon-quickstart-mp</markup>


<h4 id="_update_project_dependencies"><span class="merged" id="all.1yMOPq" title="原文 : Update project dependencies">プロジェクト依存関係の更新</span></h4>
<div class="section">
...
<h4 id="_add_oidc_security_properties"><span class="merged" id="all.4IgswY" title="原文 : Add OIDC security properties">OIDCセキュリティ・プロパティの追加</span></h4>
<div class="section">
...
<markup
lang="yaml"
title="application.yamlファイルを作成して次の行を追加"
>security:
  providers:
    - abac:
...
<markup
lang="properties"
title="古いポートをmicroprofile-config.propertiesに交換"
...
<h4 id="_secure_your_application"><span class="merged" id="all.2z8rfR" title="原文 : Secure your application">アプリケーションの保護</span></h4>
<div class="section">
...
<markup
lang="java"
title="<code>Authenticated</code>注釈のインポート:"
>import io.helidon.security.annotations.Authenticated;</markup>

<markup
lang="java"
title="<code>getDefaultMessage</code>を保護するための<code>@Authenticated</code>の追加"
>    @Authenticated
    @GET
...
<h4 id="_try_it"><span class="merged" id="all.4Mibtz" title="原文 : Try it !">試してみましょう。</span></h4>
<div class="section">
<p><span class="merged" id="all.PeD2y" title="原文 : Now, Helidon and Keycloak are correctly configured, and your application is safe.">これで、HelidonとKeycloakが正しく構成され、アプリケーションが安全になりました。</span></p>
...
<h4 id="_update_tests_to_the_secure_environment"><span class="merged" id="all.36LGtq" title="原文 : Update tests to the secure environment">テストをセキュアな環境に更新</span></h4>
<div class="section">
...
<markup
lang="yaml"
title="これらのプロパティを新しいapplication.yamlにコピー"
>app:
  greeting: "Hello"
...
<markup
lang="java"
title="Configクラスのインポート"
>import io.helidon.config.Config;</markup>

<markup
lang="java"
title="startTheServerメソッドを次のメソッドに置き換えます:"
>@BeforeAll
...
<markup
lang="java"
title="次のコードで、JsonObject宣言をtestHelloWorldメソッドに置き換えます:"
...
<h4 id="_restrict_access_to_a_specific_role"><span class="merged" id="all.qQxMW" title="原文 : Restrict access to a specific role">特定のロールへのアクセスの制限</span></h4>
<div class="section">
...
<markup
lang="java"
title="RolesAllowed注釈のインポート"
>import javax.annotation.security.RolesAllowed;</markup>

<markup
lang="java"
title="@Authenticate注釈の下に@RolesAllowed注釈を追加します:"
