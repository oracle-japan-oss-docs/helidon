...
<h2 id="_reactive_streams_operators"><span class="merged" id="all.2mqniA" title="原文 : Reactive Streams Operators">リアクティブ・ストリーム演算子</span></h2>
<div class="section">
<p><span class="merged" id="all.1EI1nv.spl1" title="原文 : Implementation of MicroProfile Reactive Streams Operators specification."><a href="https://download.eclipse.org/microprofile/microprofile-reactive-streams-operators-1.0.1/microprofile-reactive-streams-operators-spec.html" id="" target="_blank" >「MicroProfileリアクティブ・ストリーム演算子」</a>仕様の実装。</span> <span class="merged" id="all.1EI1nv.spl2" title="原文 : A standardised tool for manipulation with Reactive Streams, provides set of operators as so called stages, and the builders to prepare graphs of stages for streams to be build from."><a href="https://www.reactive-streams.org/" id="" target="_blank" >「リアクティブ・ストリーム」</a>で操作するための標準化されたツールで、ステージと呼ばれる演算子のセットと、ストリームのビルド元となるステージのグラフを準備するためのビルダーが用意されています。</span> </p>
...
<td class=""><span class="merged" id="all.2r9qtx" title="原文 : Create infinite stream with every next item created by supplied operator from previous item">指定された演算子によって前のアイテムから作成された次のすべてのアイテムで無限ストリームを作成</span></td>
</tr>
<tr>
...
<td class=""><span class="merged" id="all.CIzxG" title="原文 : Invoke consumer for every item passing this operator">この演算子を渡すすべてのアイテムに対してコンシューマを起動</span></td>
</tr>
<tr>
