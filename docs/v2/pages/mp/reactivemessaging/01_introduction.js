...
<markup
lang="java"
title="チャネル<code>example-channel-2</code>からのすべてのメッセージの消費例:"
...
<markup
lang="java"
title="チャネル<code>example-channel-1</code>のリアクティブ・ストリーム・サブスクライバを準備する例:"
>@Incoming("example-channel-2")
...
<markup
lang="java"
title="チャネル<code>example-channel-1</code>にメッセージを生産する例:"
...
<markup
lang="java"
title="チャネル<code>example-channel-1</code>に3つのメッセージを公開するリアクティブ・ストリーム・パブリッシャの準備の例:"
>@Outgoing("example-channel-1")
...
<markup
lang="java"
title="チャネル<code>example-channel-1</code>からチャネル<code>example-channel-2</code>へのすべてのメッセージを処理する例:"
...
<markup
lang="java"
title="チャネル<code>example-channel-1</code>と<code>example-channel-2</code>の間で接続するプロセッサ・ストリームを準備する例:"
>@Incoming("example-channel-1")
@Outgoing("example-channel-2")
...
<markup
lang="java"
title="チャネル<code>example-channel-1`as stream to be flattened to channel `example-channel-2</code>からのすべてのメッセージを処理する例:"
>@Incoming("example-channel-1")
@Outgoing("example-channel-2")
public String processMessage(String msg) {
