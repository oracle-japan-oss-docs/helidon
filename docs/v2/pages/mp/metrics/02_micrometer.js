...
<p><span class="merged" id="all.37aVFI" title="原文 : In Helidon 2.3.1, Micrometer support is separate from the Helidon MP metrics API and the built-in Helidon metrics.">Helidon 2.3.1では、マイクロメーターのサポートは、Helidon MPメトリクスAPIおよび組込みHelidonメトリクスとは異なります。</span></p>
</dd>
</dl>
</v-card-text>
</v-card>
...
<markup
lang="java"
title="JAX-RSリソースの<code>GET</code>メソッドへのマイクロメーター注釈の追加"
...
<markup
lang="java"
title="<code>MeterRegistry</code>のインジェクト"
>@Inject
