...
<div class="section">
<p><span class="merged" id="all.1DCGzT.spl1" title="原文 : Helidon MP 2.2.1-SNAPSHOT is an implementation of the MicroProfile specification and supports MicroProfile 3.3.">Helidon MP 2.2.1-SNAPSHOTは、<a href="https://microprofile.io" id="" target="_blank" >MicroProfile</a> <a href="https://github.com/eclipse/microprofile/releases" id="" target="_blank" >specification</a>の実装であり、MicroProfile 3.3をサポートします。</span> <span class="merged" id="all.1DCGzT.spl2" title="原文 : Since MicroProfile has its roots in Java EE, the MicroProfile APIs follow a familiar, declarative approach with heavy use of annotations.">MicroProfileのルートはJava EEにあるため、MicroProfile APIは使い慣れた宣言的アプローチに従い、注釈を頻繁に使用します。</span> <span class="merged" id="all.1DCGzT.spl3" title="原文 : This makes it a good choice for Java EE developers.">これにより、Java EE開発者に適した選択肢になります。</span> </p>
