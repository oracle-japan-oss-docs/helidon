...
<dl>
<dt slot=title><span class="merged" id="all.19StqX"  title="原文:: Vault">Vault</span></dt>
<dd slot="desc"><p><span class="merged" id="all.4eTCPn.spl1" title="原文 : HashiCorp Vault is a commonly used Vault in many microservices.">HashiCorp Vaultは、多くのマイクロサービスでよく使用されているVaultです。</span> <span class="merged" id="all.4eTCPn.spl2" title="原文 : The APIs are REST-based and Helidon implements them using reactive client.">APIはRESTベースであり、Helidonはリアクティブ・クライアントを使用して実装します。</span> </p>
...
<h3 id="_experimental"><span class="merged" id="all.3qlK5J.4"  title="原文:: Experimental">試作</span></h3>
<div class="section">
...
<h3 id="_sys_operations"><span class="merged" id="all.4DPBwG" title="原文 : Sys Operations">システム操作</span></h3>
<div class="section">
...
<h3 id="_modules"><span class="merged" id="all.47VrhL"  title="原文:: Modules">モジュール</span></h3>
<div class="section">
<p><span class="merged" id="all.4WLHW2" title="原文 : The following is a list of maven coordinates of all Vault modules available:">次に、使用可能なすべてのVaultモジュールのmaven座標のリストを示します:</span></p>
...
<p><span class="merged" id="all.iPv45" title="原文 : To use Vault integration in MP, the following module must be added, as it enables injection of all features:">MPでVault統合を使用するには、次のモジュールを追加する必要があります。これにより、すべての機能のインジェクションが可能になります:</span></p>
...
<p><span class="merged" id="all.4G30eL" title="原文 : Configuration to connect to Vault.">Vaultに接続するための構成。</span></p>

<ol style="margin-left: 15px;">
<li>
<span class="merged" id="all.3Nwkr" title="原文 : Authenticating using Token:">トークンを使用した認証:</span>
...
<ol style="margin-left: 15px;">
<li>
<span class="merged" id="all.LF0dL" title="原文 : Authenticating using AppRole:">AppRoleを使用した認証:</span>
...
<ol style="margin-left: 15px;">
<li>
<span class="merged" id="all.28Gyws" title="原文 : Authenticating using Kubernetes:">Kubernetesを使用した認証:</span>
...
<li>
<p><span class="merged" id="all.3Tnr8Z" title="原文 : Kv1Secrets - Key/Value Version 1 Secrets (unversioned secrets, legacy)">Kv1Secrets - キー/バリュー・バージョン1のシークレット(バージョニングされていないシークレット、レガシー)</span></p>
...
<h2 id="_local_testing"><span class="merged" id="all.3HPxA2" title="原文 : Local testing">ローカル・テスト</span></h2>
<div class="section">
