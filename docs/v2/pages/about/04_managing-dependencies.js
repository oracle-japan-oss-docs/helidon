...
<dd slot="desc"><p><span class="merged" id="all.1tYd3T.spl1" title="原文 : Helidon provides a &ldquo;Bill Of Materials&rdquo; (BOM) to manage dependencies.">Helidonには、依存関係を管理するための部品構成表(BOM)が用意されています。</span> <span class="merged" id="all.1tYd3T.spl2" title="原文 : This is a special Maven pom file that provides dependency management.">これは、依存性管理を提供する特別なMaven pomファイルです。</span> </p>

<p><span class="merged" id="all.2V4xlu" title="原文 : Using the Helidon BOM allows you to use Helidon component dependencies with a single version: the Helidon version.">Helidon BOMを使用すると、単一バージョンでHelidonコンポーネントの依存性を使用できます: Helidonのバージョン。</span></p>
</dd>
</dl>
</v-card-text>
</v-card>
...
<div class="section">
<p><span class="merged" id="all.3fb4tp" title="原文 : Add the following snippet to your pom.xml file in order to import the Helidon BOM.">Helidon BOMをインポートするには、次のスニペットをpom.xmlファイルに追加します。</span></p>
...
<h2 id="_using_helidon_component_dependencies"><span class="merged" id="all.1nraYX" title="原文 : Using Helidon Component Dependencies">Helidonコンポーネントの依存性の使用</span></h2>
<div class="section">
<p><span class="merged" id="all.1KS2gs" title="原文 : Once you have imported the BOM, you can declare dependencies on Helidon components without specifying a version.">BOMをインポートすると、バージョンを指定せずにHelidonコンポーネントへの依存性を宣言できます。</span></p>
