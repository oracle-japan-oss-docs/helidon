...
<tr>
<td class=""><span class="merged" id="all.27GIMH" title="原文 : Helidon Prerequisites"><router-link to="/about/03_prerequisites">Helidonの前提条件</router-link></span></td>
</tr>
</tbody>
</table>
</div>
...
<div class="admonition note">
<p class="admonition-inline"><span class="merged" id="all.zRoZz.spl1" title="原文 : By default, Jib uses distroless/java as the base image.">デフォルトでは、Jibは<a href="https://github.com/GoogleContainerTools/distroless/tree/master/java/" id="" target="_blank" >distroless/java</a>をベース・イメージとして使用します。</span> <span class="merged" id="all.zRoZz.spl2" title="原文 : You can override the default with configuration see the documentation">構成でデフォルトをオーバーライドできます。<a href="https://github.com/GoogleContainerTools/jib/tree/master/jib-maven-plugin#extended-usage" id="" target="_blank" >documentation</a>を参照してください</span> </p>
</div>
<markup
lang="bash"
title="更新されたアプリケーションのパッケージ化"
>mvn package</markup>
...
<ul class="colist">
<li data-value="1"><span class="merged" id="all.45VKiI.spl1" title="原文 : Ignore the fact that it says the image was created 48 years ago.">イメージが48年前に作成された表示される事実は無視してください。</span> <span class="merged" id="all.45VKiI.spl2" title="原文 : Refer to the Jib FAQ for explanations.">詳細は、<a href="https://github.com/GoogleContainerTools/jib/blob/master/docs/faq.md#why-is-my-image-created-48-years-ago" id="" target="_blank" >Jib FAQ</a>を参照してください。</span> </li>
</ul>
<div class="admonition note">
