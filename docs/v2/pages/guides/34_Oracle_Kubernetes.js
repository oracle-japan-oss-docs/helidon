...
<tr>
<td class=""><span class="merged" id="all.3nXSad" title="原文 : Helidon prerequisites"><router-link to="/about/03_prerequisites">Helidonの前提条件</router-link></span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.cryHO.spl1" title="原文 : An OKE cluster.">OKEクラスタ。</span> <span class="merged" id="all.cryHO.spl2" title="原文 : See the OKE documentation."><a href="http://www.oracle.com/webfolder/technetwork/tutorials/obe/oci/oke-full/index.html" id="" target="_blank" >「OKEドキュメント」</a>を参照してください。</span> </td>
</tr>
<tr>
<td class=""><span class="merged" id="all.14ecFT.spl1" title="原文 : A Helidon project created from the quickstart Maven archetype.">クイックスタートMaven原型から作成されたHelidonプロジェクト。</span> <span class="merged" id="all.14ecFT.spl2" title="原文 : See quickstart Maven archetype."><router-link @click.native="this.scrollFix('#guides/02_quickstart-se.adoc')" to="#guides/02_quickstart-se.adoc">「クイックスタートMaven原型」</router-link>を参照してください。</span> </td>
</tr>
</tbody>
</table>
</div>
...
<p><span class="merged" id="all.3L6Pn.spl1" title="原文 : Sign in to the Oracle Cloud Infrastructure (OCI) web console and generate an authentication token.">Oracle Cloud Infrastructure (OCI) webコンソールにサインインし、認証トークンを生成します。</span> <span class="merged" id="all.3L6Pn.spl2" title="原文 : See Getting an Auth Token."><a href="https://docs.cloud.oracle.com/iaas/Content/Registry/Tasks/registrygettingauthtoken.htm" id="" target="_blank" >「認証トークンの取得」</a>を参照してください。</span> </p>
...
<markup
lang="bash"
title="OCIR Dockerレジストリにログインします:"
>docker login \
...
<li data-value="3"><span class="merged" id="all.2cjPsK.spl1" title="原文 : &lt;region-code&gt; is the code for the OCI region that you&rsquo;re using."><code>&lt;region-code></code>は、使用しているOCIリージョンのコードです。</span> <span class="merged" id="all.2cjPsK.spl2" title="原文 : For example, the region code for Phoenix is phx.">たとえば、Phoenixのリージョン・コードは<code>phx</code>です。</span> <span class="merged" id="all.2cjPsK.spl3" title="原文 : See Regions and Availability Domains."><a href="https://docs.cloud.oracle.com/iaas/Content/General/Concepts/regions.htm" id="" target="_blank" >「リージョンおよび可用性ドメイン」</a>を参照してください。</span> </li>
</ul>
<markup
lang="bash"
title="レジストリにプッシュするイメージにタグを付けます:"
>docker tag \
...
<markup
lang="bash"
title="アプリケーションをデプロイします:"
>kubectl create -f app.yaml -n helidon</markup>

<markup
lang="bash"
title="新しいポッドの<code>NodePort</code>番号を取得します:"
>kubectl get svc -n helidon</markup>

<markup
lang="bash"
title="クラスタ・ノードのIPアドレスを取得します:"
