...
<markup
lang="java"
title="固定レートを使用したスケジューリングの例では、<code>Scheduling.fixedRateBuilder()</code>ビルダーを使用します。"
...
<th><span class="merged" id="all.2xA7W7.5"  title="原文:: Example">例</span></th>
...
<td class=""><span class="merged" id="all.1bEecX.1"  title="原文:: Every second">1秒 ごと</span></td>
</tr>
<tr>
