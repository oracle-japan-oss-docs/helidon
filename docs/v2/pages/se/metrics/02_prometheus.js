...
<dl>
<dt slot=title><span class="merged" id="all.1thneg" title="原文 : Prometheus Metrics">Prometheusメトリック</span></dt>
<dd slot="desc"><p><span class="merged" id="all.TRt8r" title="原文 : Helidon WebServer can serve Prometheus metrics.">Helidon WebServerはPrometheusメトリックを提供できます。</span></p>
...
<p><span class="merged" id="all.1DRKmk.spl1" title="原文 : Note that Helidon has an in-built metrics implementation.">Helidonには組込みメトリック実装があることに注意してください。</span> <span class="merged" id="all.1DRKmk.spl2" title="原文 : See Helidon Metrics."><router-link @click.native="this.scrollFix('#metrics/01_metrics.adoc')" to="#metrics/01_metrics.adoc">「Helidonメトリック」</router-link>を参照してください。</span> </p>
</dd>
</dl>
</v-card-text>
</v-card>
...
<h2 id="_prerequisites"><span class="merged" id="all.2LZvWc.10"  title="原文:: Prerequisites">前提条件</span></h2>
<div class="section">
<p><span class="merged" id="all.4JnU1V.11" title="原文 : Declare the following dependency in your project:">プロジェクトで次の依存性を宣言します:</span></p>
...
<h2 id="_using_prometheus_metrics_in_your_application"><span class="merged" id="all.GtiEo" title="原文 : Using Prometheus metrics in your application">アプリケーションでのPrometheusメトリックの使用</span></h2>
<div class="section">
<p><span class="merged" id="all.2BhWcL" title="原文 : To enable Prometheus metrics, register it with the web server.">Prometheusメトリックを有効にするには、webサーバーに登録します。</span></p>
