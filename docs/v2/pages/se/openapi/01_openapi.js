...
<p><span class="merged" id="all.1zYyU8" title="原文 : Helidon SE also supports additional properties.">Helidon SEでは、追加プロパティもサポートされています。</span></p>

<div class="block-title"><span class="merged" id="all.1i8NrV" title="原文 : Helidon SE-specific OpenAPI Config Properties"><span>Helidon SE固有のOpenAPI構成プロパティ</span></span></div>
<div class="table__overflow elevation-1  ">
<table class="datatable table">
<colgroup>
<col style="width: 50%;">
