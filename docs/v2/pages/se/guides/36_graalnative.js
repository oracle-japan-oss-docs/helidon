...
<h2 id="_generate_the_project"><span class="merged" id="all.xQmwm.4" title="原文 : Generate The Project">プロジェクトの生成</span></h2>
<div class="section">
...
<h3 id="_local_build"><span class="merged" id="all.44pkHU.2" title="原文 : Local build">ローカル・ビルド</span></h3>
<div class="section">
...
<h3 id="_multi_stage_docker_build"><span class="merged" id="all.wMzjC.2" title="原文 : Multi-stage Docker build">複数ステージのDockerビルド</span></h3>
<div class="section">
<p><span class="merged" id="all.17Gxv8.1" title="原文 : Build the &quot;native&quot; Docker Image">ネイティブDockerイメージのビルド</span></p>
