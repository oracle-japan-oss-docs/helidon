...
<h2 id="_resource_class_when_loaded_from_config"><span class="merged" id="all.IB5Pd" title="原文 : Resource class when loaded from Config">構成からのロード時のリソース・クラス</span></h2>
<div class="section">
...
<h3 id="_other_significant_webserver_deprecations"><span class="merged" id="all.n33SI" title="原文 : Other significant WebServer deprecations">その他の重要なWebServerの非推奨</span></h3>
<div class="section">
<ul class="ulist">
<li>
