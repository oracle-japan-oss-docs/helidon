...
<p><span class="merged" id="all.1QVPqh.spl1" title="原文 : If you want to use your own parent POM, then take a look at the standalone quickstart example.">独自の親POMを使用する場合は、<a href="https://github.com/oracle/helidon/tree/2.3.1/examples/quickstarts/helidon-standalone-quickstart-se" id="" target="_blank" >「スタンドアロン・クイックスタートの例」</a>を参照してください。</span> <span class="merged" id="all.1QVPqh.spl2" title="原文 : This example has a stand-alone POM that you can pattern your own application POM after.">この例には、独自のアプリケーションPOMを後からパターン化できるスタンドアロンPOMがあります。</span> </p>

<p><span class="merged" id="all.2W06xt.1" title="原文 : For more details on Helidon application POMs see the Helidon&rsquo;s Application POMS">HelidonアプリケーションPOMの詳細は、<a href="https://github.com/oracle/helidon/blob/2.3.1/docs-internal/application-pom.md" id="" target="_blank" >「HelidonアプリケーションPOMS」</a>を参照してください</span></p>
...
<p><span class="merged" id="all.3pnN8a.1.spl1" title="原文 : When you use a Helidon Application POM as your project&rsquo;s parent pom, you inheritent Helidon&rsquo;s dependency management.">HelidonアプリケーションPOMをプロジェクトの親POMとして使用する場合、Helidonの依存関係管理を継承します。</span> <span class="merged" id="all.3pnN8a.1.spl2" title="原文 : If you have your own parent, then you can import Helidon dependency management like this:">独自の親がある場合は、次のようにHelidonの依存関係管理をインポートできます:</span> </p>
