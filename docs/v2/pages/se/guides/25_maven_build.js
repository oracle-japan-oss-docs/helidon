...
<li>
<span class="merged" id="all.1P4Qjv.1" title="原文 : Dependency managment via the Helidon BOM and Dependencies POMs">Helidon BOMおよび依存関係POMを介した依存関係管理</span>
...
<ol style="margin-left: 15px;">
<li>
<span class="merged" id="all.1K9u7y.1" title="原文 : Helidon dependency management.">Helidonの依存性管理。</span>
...
<p><span class="merged" id="all.3Afbqu.spl1" title="原文 : If you want to use your own parent POM, then take a look at the standalone quickstart example.">独自の親POMを使用する場合は、<a href="https://github.com/oracle/helidon/tree/2.2.1-SNAPSHOT/examples/quickstarts/helidon-standalone-quickstart-se" id="" target="_blank" >「スタンドアロン・クイックスタートの例」</a>を参照してください。</span> <span class="merged" id="all.3Afbqu.spl2" title="原文 : This example has a stand-alone POM that you can pattern your own application POM after.">この例には、独自のアプリケーションPOMを後からパターン化できるスタンドアロンPOMがあります。</span> </p>

<p><span class="merged" id="all.2WpVep.1" title="原文 : For more details on Helidon application POMs see the Helidon&rsquo;s Application POMS">HelidonアプリケーションPOMの詳細は、<a href="https://github.com/oracle/helidon/blob/2.2.1-SNAPSHOT/docs-internal/application-pom.md" id="" target="_blank" >「HelidonアプリケーションPOMS」</a>を参照してください</span></p>
...
<p><span class="merged" id="all.1Ue6Is.1" title="原文 : Helidon provides two POMs that are used together for dependency management:">Helidonには、依存性管理のために一緒に使用される2つのPOMが用意されています:</span></p>
...
<p><span class="merged" id="all.3pnN8a.1.spl1" title="原文 : When you use a Helidon Application POM as your project&rsquo;s parent pom, you inheritent Helidon&rsquo;s dependency management.">HelidonアプリケーションPOMをプロジェクトの親POMとして使用する場合、Helidonの依存性管理を継承します。</span> <span class="merged" id="all.3pnN8a.1.spl2" title="原文 : If you have your own parent, then you can import Helidon dependency management like this:">独自の親がある場合は、次のようにHelidonの依存性管理をインポートできます:</span> </p>
...
<p><span class="merged" id="all.3eHftr.1" title="原文 : You then declare dependencies on Helidon (and other) components without specifying a version.">次に、バージョンを指定せずに、Helidon (およびその他の)コンポーネントへの依存性を宣言します。</span></p>
...
<p><span class="merged" id="all.I6TIp.1" title="原文 : For full documentation of the plugin please see the Helidon Maven Plugin README.">プラグインの完全なドキュメントは、<a href="https://github.com/oracle/helidon-build-tools/tree/master/helidon-maven-plugin" id="" target="_blank" >「Helidon MavenプラグインREADME」</a>を参照してください。</span></p>
