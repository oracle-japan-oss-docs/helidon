...
<h3 id="_operator_chains_composition"><span class="merged" id="all.1CeSRX.1" title="原文 : Operator chains composition">演算子チェーンの構成</span></h3>
<div class="section">
<p><span class="merged" id="all.24f8lE.1" title="原文 : In the situations when part of the operator chain needs to be prepared in advance, compose and to operators are at hand.">演算子チェーンの一部を事前に準備する必要がある場合は、<code>compose</code>および<code>to</code>の演算子を使用できます。</span></p>
