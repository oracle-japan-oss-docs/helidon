...
<div class="section">
<p><span class="merged" id="all.1wtZxm" title="原文 : The Helidon SE DB Client provides a unified, reactive API for working with databases in non-blocking way.">Helidon SE DBクライアントは、非ブロッキング方式でデータベースを操作するための統合されたリアクティブAPIを提供します。</span></p>
...
<div class="section">
<p><span class="merged" id="all.3HlkJo" title="原文 : To enable DB Client add the following dependency to your project&rsquo;s pom.xml (see Managing Dependencies).">DBクライアントを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<h2 id="_usage"><span class="merged" id="all.JUOSC.44"  title="原文:: Usage">使用方法</span></h2>
<div class="section">
...
<div class="section">
<p><span class="merged" id="all.2BhuCv.spl1" title="原文 : Now that you understand how to build and execute statements, try it for yourself.">文をビルドして実行する方法を理解したら、自分で試してみます。</span> <span class="merged" id="all.2BhuCv.spl2" title="原文 : DB Client Examples."><a href="https://github.com/oracle/helidon/tree/master/examples/dbclient" target="_blank">「DBクライアントの例」</a>。</span> </p>
