...
<dd slot="desc"><p><span class="merged" id="all.3brerX" title="原文 : Helidon Security provides authentication, authorization and auditing for your Helidon application.">Helidonセキュリティは、Helidonアプリケーションの認証、認可および監査を提供します。</span></p>
</dd>
</dl>
</v-card-text>
</v-card>
...
<div class="section">
<p><span class="merged" id="all.1UefFv.1" title="原文 : To enable Security add the following dependency to your project&rsquo;s pom.xml (see Managing Dependencies).">セキュリティを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<h2 id="_usage"><span class="merged" id="all.JUOSC.61"  title="原文:: Usage">使用方法</span></h2>
<div class="section">
