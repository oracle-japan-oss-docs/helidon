...
<h3 id="_maven_coordinates"><span class="merged" id="all.317oeS.58"  title="原文:: Maven Coordinates">Maven連携</span></h3>
<div class="section">
<markup
lang="xml"
...
<h4 id="_overview"><span class="merged" id="all.YrpRV.78"  title="原文:: Overview">概要</span></h4>
<div class="section">
...
<p><span class="merged" id="all.V4NKy.2" title="原文 : Type: io.helidon.security.providers.oidc.OidcProvider">タイプ: <a href="./apidocs/io.helidon.security.providers.oidc/io/helidon/security/providers/oidc/OidcProvider.html" target="_blank">io.helidon.security.providers.oidc.OidcProvider</a></span></p>
...
<p><span class="merged" id="all.31kiUh.22" title="原文 : This type provides the following service implementations:">このタイプでは、次のサービス実装が提供されます:</span></p>
...
<h4 id="_configuration_options"><span class="merged" id="all.3SKgM1.92"  title="原文:: Configuration options">構成オプション</span></h4>
<div class="section">
...
<th><span class="merged" id="all.2ZwVVB.111"  title="原文:: type">type</span></th>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2jtxrk.3.spl1" title="原文 : Configure base scopes.">ベース・スコープを構成します。</span> <span class="merged" id="all.2jtxrk.3.spl2" title="原文 : By default this is DEFAULT_BASE_SCOPES.">デフォルトでは、これは<code>DEFAULT_BASE_SCOPES</code>です。</span> <span class="merged" id="all.2jtxrk.3.spl3" title="原文 : If scope has a qualifier, it must be used here.">スコープに修飾子がある場合は、ここで使用する必要があります。</span> </p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.15f2Ma.41"  title="原文:: long">long</span></p>
...
<tr>
<td class=""><span class="merged" id="all.3UsoFV.18"  title="原文: cors"><code>cors</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.1Gn61H.18" title="原文 : CrossOriginConfig"><router-link to="/config/io_helidon_webserver_cors_CrossOriginConfig">CrossOriginConfig</router-link></span></p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2XHIO8.176"  title="原文:: boolean">boolean</span></p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2XHIO8.177"  title="原文:: boolean">boolean</span></p>

</doc-view>
</td>
<td class=""><span class="merged" id="all.xEiHU.82"  title="原文: true"><code>true</code></span></td>
<td class=""><doc-view>
...
<td class=""><doc-view>
<p><span class="merged" id="all.N4Pvl.74"  title="原文:: int">int</span></p>

</doc-view>
</td>
<td class=""><span class="merged" id="all.4XADpA.6"  title="原文: 5"><code>5</code></span></td>
<td class=""><doc-view>
...
<td class=""><doc-view>
<p><span class="merged" id="all.21ZylF.31" title="原文 : Resource"><router-link to="/config/io_helidon_common_configurable_Resource">リソース</router-link></span></p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.3LwUVC.3.spl1" title="原文 : By default the client should redirect to the identity server for the user to log in.">デフォルトでは、クライアントはユーザーがログインできるようにアイデンティティ・サーバーにリダイレクトする必要があります。</span> <span class="merged" id="all.3LwUVC.3.spl2" title="原文 : This behavior can be overridden by setting redirect to false.">この動作は、リダイレクトをfalseに設定することでオーバーライドできます。</span> <span class="merged" id="all.3LwUVC.3.spl3" title="原文 : When token is not present in the request, the client will not redirect and just return appropriate error response code.">トークンがリクエストに存在しない場合、クライアントはリダイレクトされず、適切なエラー・レスポンス・コードを返します。</span> </p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.21ZylF.32" title="原文 : Resource"><router-link to="/config/io_helidon_common_configurable_Resource">リソース</router-link></span></p>
...
<td class=""><span class="merged" id="all.xEiHU.84"  title="原文: true"><code>true</code></span></td>
<td class=""><doc-view>
...
<h3 id="_example_code"><span class="merged" id="all.mu2yS.8"  title="原文:: Example code">コード例</span></h3>
<div class="section">
<p><span class="merged" id="all.4DieL9.1" title="原文 : See the example on GitHub.">GitHubの<a href="https://github.com/oracle/helidon/tree/master/examples/security/idcs-login" target="_blank">example</a>を参照してください。</span></p>
...
<h3 id="_how_does_it_work"><span class="merged" id="all.aWBLA.8"  title="原文: How does it work?"> 動作の仕組み</span></h3>
<div class="section">
...
<h4 id="_setup"><span class="merged" id="all.4BqnSO.8"  title="原文:: Setup">設定</span></h4>
<div class="section">
<markup
lang="xml"
title="Maven dependency"
...
<h4 id="_configuration_options_2"><span class="merged" id="all.3SKgM1.93"  title="原文:: Configuration options">構成オプション</span></h4>
<div class="section">
...
<th><span class="merged" id="all.2ZwVVB.112"  title="原文:: type">type</span></th>
<th><span class="merged" id="all.G3u1e.118"  title="原文:: default value">デフォルト値</span></th>
<th><span class="merged" id="all.20ls8M.123"  title="原文:: description">説明</span></th>
</tr>
</thead>
<tbody>
<tr>
...
<h4 id="_example_code_2"><span class="merged" id="all.mu2yS.9"  title="原文:: Example code">コード例</span></h4>
<div class="section">
<p><span class="merged" id="all.3OB7P6.1" title="原文 : See the example on GitHub.">GitHubの<a href="https://github.com/oracle/helidon/tree/master/master/examples/security/outbound-override" target="_blank">example</a>を参照してください。</span></p>
...
<h4 id="_how_does_it_work_2"><span class="merged" id="all.aWBLA.9"  title="原文: How does it work?"> 動作の仕組み</span></h4>
<div class="section">
...
<h4 id="_setup_2"><span class="merged" id="all.4BqnSO.9"  title="原文:: Setup">設定</span></h4>
<div class="section">
<markup
lang="xml"
title="Maven dependency"
...
<h4 id="_overview_3"><span class="merged" id="all.YrpRV.80"  title="原文:: Overview">概要</span></h4>
<div class="section">
...
<h4 id="_configuration_options_3"><span class="merged" id="all.3SKgM1.94"  title="原文:: Configuration options">構成オプション</span></h4>
<div class="section">
...
<th><span class="merged" id="all.2ZwVVB.113"  title="原文:: type">type</span></th>
...
<td class=""><doc-view>
<p><span class="merged" id="all.15f2Ma.42"  title="原文:: long">long</span></p>
...
<h4 id="_example_code_3"><span class="merged" id="all.mu2yS.10"  title="原文:: Example code">コード例</span></h4>
<div class="section">
<markup
lang="yaml"
title="Configuration example"
...
<h4 id="_how_does_it_work_3"><span class="merged" id="all.aWBLA.10"  title="原文: How does it work?"> 動作の仕組み</span></h4>
<div class="section">
...
<h4 id="_setup_3"><span class="merged" id="all.4BqnSO.10"  title="原文:: Setup">設定</span></h4>
<div class="section">
<markup
lang="xml"
title="Maven dependency"
...
<h4 id="_overview_4"><span class="merged" id="all.YrpRV.81"  title="原文:: Overview">概要</span></h4>
<div class="section">
...
<p><span class="merged" id="all.48Ozlr.2" title="原文 : Type: io.helidon.security.providers.header.HeaderAtnProvider">タイプ: <a href="./apidocs/io.helidon.security.providers.header/io/helidon/security/providers/header/HeaderAtnProvider.html" target="_blank">io.helidon.security.providers.header.HeaderAtnProvider</a></span></p>
...
<h4 id="_configuration_options_4"><span class="merged" id="all.3SKgM1.95"  title="原文:: Configuration options">構成オプション</span></h4>
<div class="section">
<div class="block-title"><span class="merged" id="all.271SGn.96" title="原文 : Optional configuration options"><span>オプションの構成オプション</span></span></div>
<div class="table__overflow elevation-1  ">
<table class="datatable table">
<colgroup>
<col style="width: 23.077%;">
...
<th><span class="merged" id="all.2ZwVVB.114"  title="原文:: type">type</span></th>
...
<h4 id="_example_code_4"><span class="merged" id="all.mu2yS.11"  title="原文:: Example code">コード例</span></h4>
<div class="section">
<markup
lang="yaml"
title="Configuration example"
...
<h4 id="_how_does_it_work_4"><span class="merged" id="all.aWBLA.11"  title="原文: How does it work?"> 動作の仕組み</span></h4>
<div class="section">
...
<h4 id="_setup_4"><span class="merged" id="all.4BqnSO.11"  title="原文:: Setup">設定</span></h4>
<div class="section">
<markup
lang="xml"
title="Maven dependency"
...
<h4 id="_overview_5"><span class="merged" id="all.YrpRV.82"  title="原文:: Overview">概要</span></h4>
<div class="section">
<p><span class="merged" id="all.3P1sPy.2" title="原文 : HTTP header signature provider.">HTTPヘッダー・シグネチャ・プロバイダ。</span></p>

<p><span class="merged" id="all.H1CEa.2" title="原文 : Type: io.helidon.security.providers.httpsign.HttpSignProvider">タイプ: <a href="./apidocs/io.helidon.security.providers.httpsign/io/helidon/security/providers/httpsign/HttpSignProvider.html" target="_blank">io.helidon.security.providers.httpsign.HttpSignProvider</a></span></p>
...
<p><span class="merged" id="all.31kiUh.26" title="原文 : This type provides the following service implementations:">このタイプでは、次のサービス実装が提供されます:</span></p>
...
<h4 id="_configuration_options_5"><span class="merged" id="all.3SKgM1.96"  title="原文:: Configuration options">構成オプション</span></h4>
<div class="section">
<div class="block-title"><span class="merged" id="all.271SGn.97" title="原文 : Optional configuration options"><span>オプションの構成オプション</span></span></div>
<div class="table__overflow elevation-1  ">
<table class="datatable table">
<colgroup>
<col style="width: 23.077%;">
...
<th><span class="merged" id="all.2ZwVVB.115"  title="原文:: type">type</span></th>
...
<tr>
<td class=""><span class="merged" id="all.VPmDa.3"  title="原文: headers"><code>headers</code></span></td>
<td class=""><doc-view>
...
<h4 id="_example_code_5"><span class="merged" id="all.mu2yS.12"  title="原文:: Example code">コード例</span></h4>
<div class="section">
<p><span class="merged" id="all.Po8RG.1" title="原文 : See the example on GitHub.">GitHubの<a href="https://github.com/oracle/helidon/tree/master/master/examples/security/webserver-signatures" target="_blank">example</a>を参照してください。</span></p>
...
<h4 id="_how_does_it_work_5"><span class="merged" id="all.aWBLA.12"  title="原文: How does it work?"> 動作の仕組み</span></h4>
<div class="section">
...
<h4 id="_setup_5"><span class="merged" id="all.4BqnSO.12"  title="原文:: Setup">設定</span></h4>
<div class="section">
<markup
lang="xml"
title="Maven dependency"
...
<p><span class="merged" id="all.31kiUh.27" title="原文 : This type provides the following service implementations:">このタイプでは、次のサービス実装が提供されます:</span></p>
...
<h4 id="_configuration_options_6"><span class="merged" id="all.3SKgM1.97"  title="原文:: Configuration options">構成オプション</span></h4>
<div class="section">
<div class="block-title"><span class="merged" id="all.271SGn.98" title="原文 : Optional configuration options"><span>オプションの構成オプション</span></span></div>
<div class="table__overflow elevation-1  ">
<table class="datatable table">
<colgroup>
<col style="width: 23.077%;">
...
<th><span class="merged" id="all.2ZwVVB.116"  title="原文:: type">type</span></th>
<th><span class="merged" id="all.G3u1e.122"  title="原文:: default value">デフォルト値</span></th>
...
<h4 id="_configuration_options_7"><span class="merged" id="all.3SKgM1.98"  title="原文:: Configuration options">構成オプション</span></h4>
<div class="section">
<div class="block-title"><span class="merged" id="all.271SGn.99" title="原文 : Optional configuration options"><span>オプションの構成オプション</span></span></div>
<div class="table__overflow elevation-1  ">
<table class="datatable table">
<colgroup>
<col style="width: 23.077%;">
...
<th><span class="merged" id="all.2ZwVVB.117"  title="原文:: type">type</span></th>
...
<td class="">&#160;</td>
<td class=""><doc-view>
<p><span class="merged" id="all.1ItWlZ.2.spl1" title="原文 : Configure token handler for IDCS Application name.">IDCSアプリケーション名のトークン・ハンドラを構成します。</span> <span class="merged" id="all.1ItWlZ.2.spl2" title="原文 : By default the header IdcsMtRoleMapperRxProvider#IDCS_APP_HEADER is used.">デフォルトでは、ヘッダー<code>IdcsMtRoleMapperRxProvider#IDCS_APP_HEADER</code>が使用されます。</span> </p>
...
<td class="">&#160;</td>
<td class=""><doc-view>
<p><span class="merged" id="all.4HQAaT.2.spl1" title="原文 : Configure token handler for IDCS Tenant ID.">IDCSテナントIDのトークン・ハンドラを構成します。</span> <span class="merged" id="all.4HQAaT.2.spl2" title="原文 : By default the header IdcsMtRoleMapperRxProvider#IDCS_TENANT_HEADER is used.">デフォルトでは、ヘッダー<code>IdcsMtRoleMapperRxProvider#IDCS_TENANT_HEADER</code>が使用されます。</span> </p>
...
<h4 id="_example_code_6"><span class="merged" id="all.mu2yS.13"  title="原文:: Example code">コード例</span></h4>
<div class="section">
<p><span class="merged" id="all.1fpGIg.1" title="原文 : See the example on GitHub.">GitHubの<a href="https://github.com/oracle/helidon/tree/master/examples/security/idcs-login/" target="_blank">example</a>を参照してください。</span></p>
...
<h4 id="_how_does_it_work_6"><span class="merged" id="all.aWBLA.13"  title="原文: How does it work?"> 動作の仕組み</span></h4>
<div class="section">
...
<div class="section">
<p><span class="merged" id="all.1Kii3r.1" title="原文 : Attribute-based Access Control (ABAC) authorization provider provides security and authorization service implementations.">属性ベースのアクセス制御(ABAC)認可プロバイダは、セキュリティおよび認可サービスの実装を提供します。</span></p>


<h4 id="_overview_6"><span class="merged" id="all.YrpRV.83"  title="原文:: Overview">概要</span></h4>
<div class="section">
<p><span class="merged" id="all.4bF52K.2" title="原文 : Attribute Based Access Control provider">属性ベースのアクセス制御プロバイダ</span></p>

<p><span class="merged" id="all.kHrqK.2" title="原文 : Type: io.helidon.security.providers.abac.AbacProvider">タイプ: <a href="./apidocs/io.helidon.security.providers.abac/io/helidon/security/providers/abac/AbacProvider.html" target="_blank">io.helidon.security.providers.abac.AbacProvider</a></span></p>
...
<h4 id="_configuration_options_8"><span class="merged" id="all.3SKgM1.99"  title="原文:: Configuration options">構成オプション</span></h4>
<div class="section">
<div class="block-title"><span class="merged" id="all.271SGn.100" title="原文 : Optional configuration options"><span>オプションの構成オプション</span></span></div>
<div class="table__overflow elevation-1  ">
<table class="datatable table">
<colgroup>
<col style="width: 23.077%;">
...
<th><span class="merged" id="all.2ZwVVB.118"  title="原文:: type">type</span></th>
...
<h4 id="_maven_dependency"><span class="merged" id="all.4UVn3x.1" title="原文 : Maven Dependency">Mavenの依存関係</span></h4>
<div class="section">
<markup
lang="xml"
title="Maven dependency"
...
<h4 id="_examples"><span class="merged" id="all.2OLHXv.44"  title="原文:: Examples">例</span></h4>
<div class="section">
<p><span class="merged" id="all.2W4II.1" title="原文 : See the example on GitHub.">GitHubの<a href="https://github.com/oracle/helidon/tree/master/examples/security/attribute-based-access-control" target="_blank">example</a>を参照してください。</span></p>
...
<h4 id="_configuration_options_9"><span class="merged" id="all.276fEP.6"  title="原文:: Configuration Options">構成オプション</span></h4>
<div class="section">
...
<h4 id="_usage"><span class="merged" id="all.JUOSC.62"  title="原文:: Usage">使用方法</span></h4>
<div class="section">
...
<h5 id="_interaction_with_jax_rs_sub_resource_locators"><span class="merged" id="all.2DmYNg.1" title="原文 : Interaction with JAX-RS Sub-Resource Locators">JAX-RSサブリソース・ロケータとの相互作用</span></h5>
<div class="section">
...
<h4 id="_setup_6"><span class="merged" id="all.4BqnSO.13"  title="原文:: Setup">設定</span></h4>
<div class="section">
<markup
lang="xml"
title="Maven dependency"
...
<h4 id="_overview_7"><span class="merged" id="all.YrpRV.84"  title="原文:: Overview">概要</span></h4>
<div class="section">
<p><span class="merged" id="all.1M4tHs.2" title="原文 : Google Authentication provider">Google認証プロバイダ</span></p>

<p><span class="merged" id="all.4Z2jOM.2" title="原文 : Type: io.helidon.security.providers.google.login.GoogleTokenProvider">タイプ: <a href="./apidocs/io.helidon.security.providers.google.login/io/helidon/security/providers/google/login/GoogleTokenProvider.html" target="_blank">io.helidon.security.providers.google.login.GoogleTokenProvider</a></span></p>
...
<h4 id="_configuration_options_10"><span class="merged" id="all.3SKgM1.100"  title="原文:: Configuration options">構成オプション</span></h4>
<div class="section">
<div class="block-title"><span class="merged" id="all.271SGn.101" title="原文 : Optional configuration options"><span>オプションの構成オプション</span></span></div>
<div class="table__overflow elevation-1  ">
<table class="datatable table">
<colgroup>
<col style="width: 23.077%;">
...
<th><span class="merged" id="all.2ZwVVB.119"  title="原文:: type">type</span></th>
...
<h4 id="_example_code_7"><span class="merged" id="all.mu2yS.14"  title="原文:: Example code">コード例</span></h4>
<div class="section">
<p><span class="merged" id="all.3iqn8w.1" title="原文 : See the example on GitHub.">GitHubの<a href="https://github.com/oracle/helidon/tree/master/examples/security/google-login" target="_blank">example</a>を参照してください。</span></p>
...
<h4 id="_how_does_it_work_7"><span class="merged" id="all.aWBLA.14"  title="原文: How does it work?"> 動作の仕組み</span></h4>
<div class="section">
...
<li>
<p><span class="merged" id="all.1isw0k.5"  title="原文:: name">name</span></p>
...
<h4 id="_setup_7"><span class="merged" id="all.4BqnSO.14"  title="原文:: Setup">設定</span></h4>
<div class="section">
<markup
lang="xml"
title="Maven dependency"
...
<h4 id="_overview_8"><span class="merged" id="all.YrpRV.85"  title="原文:: Overview">概要</span></h4>
<div class="section">
<p><span class="merged" id="all.4NSKji.2" title="原文 : JWT authentication provider">JWT認証プロバイダ</span></p>

<p><span class="merged" id="all.3mAzAF.2" title="原文 : Type: io.helidon.security.providers.jwt.JwtProvider">タイプ: <a href="./apidocs/io.helidon.security.providers.jwt/io/helidon/security/providers/jwt/JwtProvider.html" target="_blank">io.helidon.security.providers.jwt.JwtProvider</a></span></p>
...
<h4 id="_configuration_options_11"><span class="merged" id="all.3SKgM1.101"  title="原文:: Configuration options">構成オプション</span></h4>
<div class="section">
<div class="block-title"><span class="merged" id="all.271SGn.102" title="原文 : Optional configuration options"><span>オプションの構成オプション</span></span></div>
<div class="table__overflow elevation-1  ">
<table class="datatable table">
<colgroup>
<col style="width: 23.077%;">
...
<th><span class="merged" id="all.2ZwVVB.120"  title="原文:: type">type</span></th>
...
<td class=""><doc-view>
<p><span class="merged" id="all.21ZylF.33" title="原文 : Resource"><router-link to="/config/io_helidon_common_configurable_Resource">リソース</router-link></span></p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.21ZylF.34" title="原文 : Resource"><router-link to="/config/io_helidon_common_configurable_Resource">リソース</router-link></span></p>
...
<h4 id="_example_code_8"><span class="merged" id="all.mu2yS.15"  title="原文:: Example code">コード例</span></h4>
<div class="section">
<p><span class="merged" id="all.3ot1of.1" title="原文 : See the example on GitHub.">GitHubの<a href="https://github.com/oracle/helidon/tree/master/examples/security/outbound-override" target="_blank">example</a>を参照してください。</span></p>
...
<h4 id="_how_does_it_work_8"><span class="merged" id="all.aWBLA.15"  title="原文: How does it work?"> 動作の仕組み</span></h4>
<div class="section">
...
<h2 id="_reference"><span class="merged" id="all.oKAT2.23"  title="原文:: Reference">リファレンス</span></h2>
<div class="section">
<ul class="ulist">
<li>
...
<li>
<p><span class="merged" id="all.2Wm4Xz" title="原文 : Helidon OIDC JavaDoc"><a href="./apidocs/io.helidon.security.providers.oidc/module-summary.html" target="_blank">Helidon OIDC JavaDoc</a></span></p>

</li>
<li>
<p><span class="merged" id="all.3dN5aa" title="原文 : Helidon HTTP Authentication JavaDoc"><a href="./apidocs/io.helidon.security.providers.httpauth/module-summary.html" target="_blank">Helidon HTTP認証JavaDoc</a></span></p>

</li>
<li>
<p><span class="merged" id="all.3su7NE" title="原文 : Helidon Header Authentication JavaDoc"><a href="./apidocs/io.helidon.security.providers.header/module-summary.html" target="_blank">Helidonヘッダー認証JavaDoc</a></span></p>

</li>
<li>
<p><span class="merged" id="all.5kLyD" title="原文 : Helidon HTTP Signature JavaDoc"><a href="./apidocs/io.helidon.security.providers.httpsign/module-summary.html" target="_blank">Helidon HTTPシグネチャJavaDoc</a></span></p>

</li>
<li>
<p><span class="merged" id="all.IutYW" title="原文 : Helidon IDCS Role Mapper JavaDoc"><a href="./apidocs/io.helidon.security.providers.idcs.mapper/module-summary.html" target="_blank">Helidon IDCSロール・マッパーJavaDoc</a></span></p>

</li>
<li>
<p><span class="merged" id="all.4CO7e8" title="原文 : Helidon ABAC JavaDoc"><a href="./apidocs/io.helidon.security.providers.abac/module-summary.html" target="_blank">Helidon ABAC JavaDoc</a></span></p>

</li>
<li>
<p><span class="merged" id="all.3PtjBn" title="原文 : Helidon Google Login JavaDoc"><a href="./apidocs/io.helidon.security.providers.google.login/module-summary.html" target="_blank">Helidon GoogleログインJavaDoc</a></span></p>

</li>
<li>
<p><span class="merged" id="all.3mge9o" title="原文 : Helidon JWT JavaDoc"><a href="./apidocs/io.helidon.security.providers.jwt/module-summary.html" target="_blank">Helidon JWT JavaDoc</a></span></p>
