...
<li>
<p><span class="merged" id="all.3v8Seg.1" title="原文 : Deserialization Setup"><router-link @click.native="this.scrollFix('#_deserialization_setup')" to="#_deserialization_setup">デシリアライズ設定</router-link></span></p>

</li>
<li>
<p><span class="merged" id="all.47hrIn.1" title="原文 : System Property Configuration"><router-link @click.native="this.scrollFix('#_system_property_configuration')" to="#_system_property_configuration">システム・プロパティ構成</router-link></span></p>

</li>
<li>
<p><span class="merged" id="all.2wJFRp.1" title="原文 : Programmatic Configuration"><router-link @click.native="this.scrollFix('#_programmatic_configuration')" to="#_programmatic_configuration">プログラム構成</router-link></span></p>
...
<h2 id="_deserialization_setup"><span class="merged" id="all.1gqSwZ.1" title="原文 : Deserialization Setup">デシリアライズ設定</span></h2>
<div class="section">
...
<h2 id="_system_property_configuration"><span class="merged" id="all.8ePlD.1" title="原文 : System Property Configuration">システム・プロパティ構成</span></h2>
<div class="section">
...
<h2 id="_programmatic_configuration"><span class="merged" id="all.3fKWWu.1" title="原文 : Programmatic Configuration">プログラム構成</span></h2>
<div class="section">
