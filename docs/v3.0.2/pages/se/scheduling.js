...
<h2 id="maven-coordinates"><span class="merged" id="all.317oeS.56"  title="原文:: Maven Coordinates">Maven連携</span></h2>
<div class="section">
<p><span class="merged" id="all.1OtigJ.1" title="原文 : To enable Scheduling add the following dependency to your project&rsquo;s pom.xml (see Managing Dependencies).">スケジューリングを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<h2 id="_usage"><span class="merged" id="all.JUOSC.60"  title="原文:: Usage">使用方法</span></h2>
<div class="section">
...
<markup
lang="java"
title="Scheduling with fixed rate use <code>Scheduling.fixedRateBuilder()</code> builder."
...
<div class="section">
<p><span class="merged" id="all.2RiN0c" title="原文 : For more complicated interval definition, Cron expression can be leveraged with Scheduling.cronBuilder() builder.">より複雑な間隔定義では、<code>Scheduling.cronBuilder()</code>ビルダーでCron式を利用できます。</span></p>
...
<div class="section">
<p><span class="merged" id="all.4YessA" title="原文 : Configuration properties are added to application.yaml file:">構成プロパティは<code>application.yaml</code>ファイルに追加されます:</span></p>

<div class="block-title"><span class="merged" id="all.117Lqg.1"  title="原文:: Configuration properties"><span>構成プロパティ</span></span></div>
...
<thead>
<tr>
<th><span class="merged" id="all.261WC8.8"  title="原文:: Property">プロパティ</span></th>
<th><span class="merged" id="all.4JM9z7.35"  title="原文:: Description">説明</span></th>
</tr>
</thead>
<tbody>
<tr>
<td class=""><span class="merged" id="all.R1T3Y.1"  title="原文:: cron">cron</span></td>
<td class=""><span class="merged" id="all.3NBxQV" title="原文 : String containing Cron setup">Cron設定を含む文字列</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.44ceUO.1"  title="原文:: concurrent">同時 </span></td>
<td class=""><span class="merged" id="all.9VJRj.1.spl1" title="原文 : Boolean, equivalent concurrentExecution property of @Scheduled."><code>@Scheduled</code>のブール、同等の<code>concurrentExecution</code>プロパティ。</span> <span class="merged" id="all.9VJRj.1.spl2"  title="原文:: Default true.">デフォルト <code>true</code></span> </td>
</tr>
</tbody>
</table>
</div>
...
<h3 id="_cron_expression_2"><span class="merged" id="all.1VkgWE.5"  title="原文:: Cron expression">Cron式</span></h3>
<div class="section">
...
<h3 id="_cron_expression_3"><span class="merged" id="all.1VkgWE.6"  title="原文:: Cron expression">Cron式</span></h3>
<div class="section">
<markup
...
<thead>
<tr>
<th><span class="merged" id="all.1VkgWE.7"  title="原文:: Cron expression">Cron式</span></th>
...
<li>
<p><span class="merged" id="all.3ERZnd" title="原文 : Helidon Scheduling JavaDoc"><a href="{scheduling-javadoc-base-url}/io/helidon/microprofile/scheduling/package-summary.html" target="_blank">HelidonスケジュールJavaDoc</a></span></p>
