...
<tr>
<td class=""><span class="merged" id="all.2sRt9f.20" title="原文 : Java&#160;SE&#160;17 (Open&#160;JDK&#160;17)"><a href="https://www.oracle.com/technetwork/java/javase/downloads" target="_blank">Java&#160;SE&#160;17</a> (<a href="http://jdk.java.net" target="_blank">Open&#160;JDK&#160;17</a>)</span></td>
<td class=""><span class="merged" id="all.3aBChT.20" title="原文 : Helidon requires Java 17+.">HelidonにはJava 17以上が必要です。</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.1DYqqk.21" title="原文 : Maven 3.6.1+"><a href="https://maven.apache.org/download.cgi" target="_blank">Maven 3.6.1+</a></span></td>
...
<div class="section">
<p><span class="merged" id="all.178sc6.2.spl1" title="原文 : If you don&rsquo;t have access to a Kubernetes cluster, you can install one on your desktop.">Kubernetesクラスタにアクセスできない場合は、<router-link to="/about/kubernetes">「デスクトップにインストール」</router-link>を使用できます。</span> <span class="merged" id="all.178sc6.2.spl2" title="原文 : Then deploy the example:">次に、例をデプロイします:</span> </p>
