...
<div class="section">
<p><span class="merged" id="all.3w4Ivq.1.spl1" title="原文 : JDK 9 introduced the jlink command that supports assembling a set of modules and their dependencies into a custom runtime image.">JDK 9では、一連のモジュールとその依存関係のカスタム・ランタイム・イメージへのアセンブルをサポートする<a href="https://docs.oracle.com/en/java/javase/17/docs/specs/man/jlink.html" target="_blank"><code>jlink</code></a>コマンドが導入されました。</span> <span class="merged" id="all.3w4Ivq.1.spl2" title="原文 : The helidon-maven-plugin has support for easily creating a custom runtime image for your Helidon application resulting in a smaller, better performing runtime."><code>helidon-maven-plugin</code>では、Helidonアプリケーションのカスタム・ランタイム・イメージの簡単な作成がサポートされているため、実行時間が小さくなり、パフォーマンスが向上します。</span> </p>
...
<tr>
<td class=""><span class="merged" id="all.2sRt9f.18" title="原文 : Java&#160;SE&#160;17 (Open&#160;JDK&#160;17)"><a href="https://www.oracle.com/technetwork/java/javase/downloads" target="_blank">Java&#160;SE&#160;17</a> (<a href="http://jdk.java.net" target="_blank">Open&#160;JDK&#160;17</a>)</span></td>
<td class=""><span class="merged" id="all.3aBChT.18" title="原文 : Helidon requires Java 17+.">HelidonにはJava 17以上が必要です。</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.1DYqqk.19" title="原文 : Maven 3.6.1+"><a href="https://maven.apache.org/download.cgi" target="_blank">Maven 3.6.1+</a></span></td>
...
<div class="section">
<p><span class="merged" id="all.2Ic8Sa.1" title="原文 : As noted in the prerequisites above, JDK 11 or newer is required.">前述の前提条件に示すように、JDK 11以降が必要です。</span></p>
...
<p><span class="merged" id="all.4BQywL.1" title="原文 : For more information on available configuration options see the helidon-maven-plugin documentation.">使用可能な構成オプションの詳細は、<a href="https://github.com/oracle/helidon-build-tools/blob/3.0.0-M3/maven-plugins/helidon-maven-plugin/README.md#goal-jlink-image" target="_blank">「<code>helidon-maven-plugin</code>のドキュメント」</a>を参照してください。</span></p>
