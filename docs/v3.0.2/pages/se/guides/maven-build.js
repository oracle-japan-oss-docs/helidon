...
<p><span class="merged" id="all.GpL1F.spl1" title="原文 : If you want to use your own parent POM, then take a look at the standalone quickstart example.">独自の親POMを使用する場合は、<a href="https://github.com/oracle/helidon/tree/master/examples/quickstarts/helidon-standalone-quickstart-se" target="_blank">「スタンドアロン・クイックスタートの例」</a>を参照してください。</span> <span class="merged" id="all.GpL1F.spl2" title="原文 : This example has a stand-alone POM that you can pattern your own application POM after.">この例には、独自のアプリケーションPOMを後からパターン化できるスタンドアロンPOMがあります。</span> </p>

<p><span class="merged" id="all.2ytNey.1" title="原文 : For more details on Helidon application POMs see the Helidon&rsquo;s Application POMS">HelidonアプリケーションPOMの詳細は、<a href="https://github.com/oracle/helidon/tree/master/docs-internal/application-pom.md" target="_blank">「HelidonアプリケーションPOMS」</a>を参照してください</span></p>
...
<ol style="margin-left: 15px;">
<li>
<span class="merged" id="all.3cOqyi" title="原文 : native-image: Build a GraalVM native image.">native-image: <router-link to="/se/guides/graalnative">「GraalVMネイティブ・イメージ」</router-link>を構築します。</span>
