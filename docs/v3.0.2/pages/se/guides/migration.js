...
<div class="section">
<p><span class="merged" id="all.3GmixI.1.spl1" title="原文 : Java 11 is no longer supported in Helidon 3.">Java 11は、Helidon 3ではサポートされなくなりました。</span> <span class="merged" id="all.3GmixI.1.spl2"  title="原文:: Java 17 or newer is required.">Java 17以上が必要です。</span> </p>
