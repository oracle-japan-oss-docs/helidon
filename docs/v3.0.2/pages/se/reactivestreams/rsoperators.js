...
<div class="section">
<p><span class="merged" id="all.3cjVKG.1.spl1" title="原文 : Helidon implements MicroProfile Reactive Streams Operators specification which defines reactive operators and provides a standartized tool for manipulation with Reactive Streams.">Helidonは、リアクティブ・オペレータを定義する<a href="https://download.eclipse.org/microprofile/microprofile-reactive-streams-operators-3.0-RC1/microprofile-reactive-streams-operators-spec-3.0-RC1.html" target="_blank">「MicroProfileリアクティブ・ストリーム・オペレータ」</a>仕様を実装し、<a href="https://www.reactive-streams.org/" target="_blank">「リアクティブ・ストリーム」</a>を使用した操作のための大幅なツールを提供します。</span> <span class="merged" id="all.3cjVKG.1.spl2" title="原文 : You can use the Helidon supported reactive operators and tooling when you want to maintain source-level portability between different implementations of the MicroProfile specifications.">MicroProfile仕様の様々な実装間でソース・レベルの移植性を維持する場合は、Helidonでサポートされているリアクティブ・オペレータおよびツールを使用できます。</span> </p>
...
<div class="section">
<p><span class="merged" id="all.1AWlFJ" title="原文 : To enable Reactive Streams add the following dependency to your project&rsquo;s pom.xml (see Managing Dependencies).">リアクティブ・ストリームを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<h2 id="_usage"><span class="merged" id="all.JUOSC.59"  title="原文:: Usage">使用方法</span></h2>
<div class="section">
...
<tr>
<td class=""><span class="merged" id="all.2Krit6.4"  title="原文:: limit">limit</span></td>
...
<ul class="ulist">
<li>
<p><span class="merged" id="all.4U6vSN.1" title="原文 : MicroProfile Reactive Streams Operators Specification"><a href="https://download.eclipse.org/microprofile/microprofile-reactive-streams-operators-3.0-RC1/microprofile-reactive-streams-operators-spec-3.0-RC1.html" target="_blank">MicroProfileリアクティブ・ストリーム・オペレータの指定</a></span></p>

</li>
<li>
<p><span class="merged" id="all.2oGreY.1" title="原文 : MicroProfile Reactive Streams Operators JavaDoc"><a href="https://download.eclipse.org/microprofile/microprofile-reactive-streams-operators-3.0-RC1/apidocs" target="_blank">MicroProfileリアクティブ・ストリーム・オペレータJavaDoc</a></span></p>
