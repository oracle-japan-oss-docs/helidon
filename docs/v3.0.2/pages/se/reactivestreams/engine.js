...
<div class="section">
<p><span class="merged" id="all.4ccNwb.1" title="原文 : To enable Reactive Engine add the following dependency to your project&rsquo;s pom.xml (see Managing Dependencies).">リアクティブ・エンジンを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<h2 id="_usage"><span class="merged" id="all.JUOSC.58"  title="原文:: Usage">使用方法</span></h2>
<div class="section">
...
<tr>
<td class=""><span class="merged" id="all.2Ml17q.4"  title="原文:: timeout">timeout</span></td>
