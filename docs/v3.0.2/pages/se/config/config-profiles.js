...
<p><span class="merged" id="all.3rh2Q6.spl1" title="原文 : Except for the system-properties and environment-variables types, the profile properties section for a source can also specify any optional settings for the corresponding config source type."><code>system-properties</code>および<code>environment-variables</code>型を除き、ソースのプロファイル<code>properties</code>セクションは、対応する構成ソース・オプションの設定を指定することもできます。</span> <span class="merged" id="all.3rh2Q6.spl2" title="原文 : The JavaDoc for the related config source type builders lists the supported properties for each type.">関連する構成ソース・タイプ・ビルダーのJavaDocには、各タイプでサポートされるプロパティがリストされています。</span> <span class="merged" id="all.3rh2Q6.spl3" title="原文 : (For example, FileConfigSource.FileBuilder.)">(たとえば、<a href="./apidocs/io.helidon.config/io/helidon/config/internal/FileConfigSource.FileBuilder.html" target="_blank"><code>FileConfigSource.FileBuilder</code></a>。)</span> </p>
...
<th><span class="merged" id="all.JUOSC.33"  title="原文:: Usage">使用方法</span></th>
...
<td class=""><span class="merged" id="all.2YDNJb" title="原文 : Periodic polling - See PollingStrategies.regular method">定期的なポーリング - <a href="./apidocs/io.helidon.config/io/helidon/config/PollingStrategies.html#regular-java.time.Duration-" target="_blank"><code>PollingStrategies.regular</code></a>メソッドを参照</span></td>
...
<th><span class="merged" id="all.JUOSC.34"  title="原文:: Usage">使用方法</span></th>
...
<td class=""><span class="merged" id="all.5B0gb" title="原文 : Filesystem monitoring - See PollingStrategies.watch method">ファイルシステムのモニタリング - <a href="./apidocs/io.helidon.config/io/helidon/config/PollingStrategies.html#watch-java.nio.file.Path-" target="_blank"><code>PollingStrategies.watch</code></a>メソッドを参照</span></td>
...
<th><span class="merged" id="all.JUOSC.35"  title="原文:: Usage">使用方法</span></th>
...
<td class=""><span class="merged" id="all.bjOP1" title="原文 : Regularly-scheduled - see RetryPolicies.repeat.">Regularly-scheduled - <a href="./apidocs/io.helidon.config/io/helidon/configRetryPolicies.html#repeat-int-" target="_blank"><code>RetryPolicies.repeat</code></a>を参照してください。</span></td>
<td class=""><doc-view>
...
<p><span class="merged" id="all.4aTxcF" title="原文 : See RetryPolicy, ChangeWatcher, and PollingStrategy JavaDoc sections."><a href="./apidocs/io.helidon.config/io/helidon/config/spi/RetryPolicy.html" target="_blank"><code>RetryPolicy</code></a>、<a href="./apidocs/io.helidon.config/io/helidon/config/spi/RetryPolicy.html" target="_blank"><code>ChangeWatcher</code></a>および<a href="./apidocs/io.helidon.config/io/helidon/config/spi/PollingStrategy.html" target="_blank"><code>PollingStrategy</code></a> JavaDocの各項を参照してください。</span></p>
