...
<div class="section">
<div class="block-title"><span class="merged" id="all.271SGn.40" title="原文 : Optional configuration options"><span>オプションの構成オプション</span></span></div>
...
<th><span class="merged" id="all.2ZwVVB.47"  title="原文:: type">type</span></th>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2XHIO8.48"  title="原文:: boolean">boolean</span></p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2uEvOb.94"  title="原文:: string">文字列</span></p>
