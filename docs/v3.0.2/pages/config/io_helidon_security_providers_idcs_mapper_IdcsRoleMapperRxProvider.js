...
<div class="section">
<div class="block-title"><span class="merged" id="all.271SGn.46" title="原文 : Optional configuration options"><span>オプションの構成オプション</span></span></div>
...
<thead>
<tr>
<th><span class="merged" id="all.2XKMH3.53"  title="原文:: key">キー</span></th>
<th><span class="merged" id="all.2ZwVVB.53"  title="原文:: type">type</span></th>
<th><span class="merged" id="all.G3u1e.53"  title="原文:: default value">デフォルト値</span></th>
<th><span class="merged" id="all.20ls8M.53"  title="原文:: description">説明</span></th>
</tr>
</thead>
<tbody>
<tr>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2uEvOb.104"  title="原文:: string">文字列</span></p>
