...
<dd slot="desc"><p><span class="merged" id="all.3Q6m1V.spl1" title="原文 : For development it&rsquo;s often convenient to run Kubernetes on your desktop.">開発には、多くの場合、デスクトップでKubernetesを実行すると便利です。</span> <span class="merged" id="all.3Q6m1V.spl2" title="原文 : Two popular ways to do this are with Kubernetes Minikube or Kubernetes support in Docker for Desktop.">これを行う一般的な方法は、<a href="https://kubernetes.io/docs/getting-started-guides/minikube/" target="_blank">Kubernetes Minikube</a>または<a href="https://docs.docker.com/docker-for-mac/kubernetes/" target="_blank">「Docker for DesktopでのKubernetesのサポート」</a>を使用する方法です。</span> </p>
