...
<p><span class="merged" id="all.35d1qn.spl1" title="原文 : For general pre-requisites like Java and Maven see Getting Started.">JavaやMavenなどの一般的な前提条件は、<router-link to="/about/prerequisites">「開始」</router-link>を参照してください。</span> <span class="merged" id="all.35d1qn.spl2" title="原文 : If you want to use the Helidon CLI you&rsquo;ll also need to install the Visual C++ Redistributable Runtime:"><router-link to="/about/cli">Helidon CLI</router-link>を使用する場合は、Visual C++再配布可能ランタイムもインストールする必要があります:</span> </p>
