...
<h2 id="_contents"><span class="merged" id="all.1Q34Zl.6"  title="原文:: Contents">目次</span></h2>
<div class="section">
<ul class="ulist">
<li>
...
<div class="section">
<p><span class="merged" id="all.3m97GA" title="原文 : To enable MicroProfile GraphQL add the following dependency to your project&rsquo;s pom.xml (see Managing Dependencies).">MicroProfile GraphQLを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<p><span class="merged" id="all.brUVw" title="原文 : After application startup, a GraphQL schema will be generated from your annotated API classes and POJO&rsquo;s and you will be able to access these via the URLs described below.">アプリケーションの起動後、注釈付きAPIクラスおよびPOJOからGraphQLスキーマが生成され、次に示すURLからアクセスできます。</span></p>
...
<p><span class="merged" id="all.4EDhQF" title="原文 : If you wish to use the GraphQL UI then please see the GraphQL MP Example."><a href="https://github.com/graphql/graphiql" target="_blank">GraphQL UI</a>を使用する場合は、<a href="https://github.com/oracle/helidon/tree/master/master/examples/microprofile/graphql" target="_blank">「GraphQL MPの例」</a>を参照してください。</span></p>
...
<thead>
<tr>
<th><span class="merged" id="all.2XKMH3.76"  title="原文:: key">キー</span></th>
<th><span class="merged" id="all.G3u1e.76"  title="原文:: default value">デフォルト値</span></th>
...
<th><span class="merged" id="all.20ls8M.79"  title="原文:: description">説明</span></th>
</tr>
</thead>
<tbody>
<tr>
...
<div class="section">
<p><span class="merged" id="all.3rPNBV" title="原文 : For a complete example, see GraphQL MP Example.">完全な例については、<a href="https://github.com/oracle/helidon/tree/master/master/examples/microprofile/graphql" target="_blank">「GraphQL MPの例」</a>を参照してください。</span></p>
