...
<div class="section">
<p><span class="merged" id="all.1UefFv" title="原文 : To enable Security add the following dependency to your project&rsquo;s pom.xml (see Managing Dependencies).">セキュリティを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<h3 id="_protecting_helidon_endpoints"><span class="merged" id="all.42i1fJ" title="原文 : Protecting Helidon Endpoints">Helidonエンドポイントの保護</span></h3>
<div class="section">
...
<h4 id="_configuring_endpoint_protection"><span class="merged" id="all.3VSIMo" title="原文 : Configuring Endpoint Protection">エンドポイント保護の構成</span></h4>
<div class="section">
...
<p><span class="merged" id="all.2j9UT5" title="原文 : The following example shows how to configure the application.yaml using customized setting:">次の例は、カスタマイズ設定を使用してapplication.yamlを構成する方法を示しています:</span></p>
