...
<h2 id="_contents"><span class="merged" id="all.1Q34Zl.4"  title="原文:: Contents">目次</span></h2>
<div class="section">
<ul class="ulist">
<li>
...
<div class="section">
<p><span class="merged" id="all.XVNqn" title="原文 : To enable CORS add the following dependency to your project&rsquo;s pom.xml (see Managing Dependencies).">CORSを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<h2 id="_usage"><span class="merged" id="all.JUOSC.1"  title="原文:: Usage">使用方法</span></h2>
<div class="section">
...
<th><span class="merged" id="all.2ZwVVB.76"  title="原文:: type">type</span></th>
<th><span class="merged" id="all.4A9clD"  title="原文:: default">default</span></th>
<th><span class="merged" id="all.20ls8M.76"  title="原文:: description">説明</span></th>
...
<td class=""><span class="merged" id="all.2XHIO8.102"  title="原文:: boolean">boolean</span></td>
<td class=""><span class="merged" id="all.42DdBS.42"  title="原文: false"><code>false</code></span></td>
...
<td class=""><span class="merged" id="all.15f2Ma.31"  title="原文:: long">long</span></td>
...
<td class=""><span class="merged" id="all.48UcwL.15"  title="原文: enabled"><code>enabled</code></span></td>
<td class=""><span class="merged" id="all.2XHIO8.103"  title="原文:: boolean">boolean</span></td>
...
<div class="section">
<p><span class="merged" id="all.13TxkF" title="原文 : The Helidon MP Quickstart application allows users to:"><a href="https://github.com/oracle/helidon/tree/master/examples/quickstarts/helidon-quickstart-mp" target="_blank">「Helidon MP Quickstartアプリケーション」</a>を使用すると、ユーザーは次を実行できます:</span></p>
...
<p><span class="merged" id="all.2m1of3" title="原文 : The Helidon MP CORS Example shows the basic quickstart example enhanced for CORS."><a href="https://github.com/oracle/helidon/tree/master/examples/microprofile/cors" target="_blank">「Helidon MP CORSの例」</a>は、CORS用に拡張された基本的なクイックスタート例を示しています。</span></p>
...
<div class="section">
<p><span class="merged" id="all.4eHPeu.spl1" title="原文 : Several built-in Helidon services-​health, metrics, and OpenAPI--have integrated CORS support.">組込みのHelidonサービス(<router-link to="/mp/health">health</router-link>、<router-link to="/mp/metrics/metrics">metrics</router-link>および<router-link to="/mp/openapi">OpenAPI</router-link>)には、CORSサポートが統合されています。</span> <span class="merged" id="all.4eHPeu.spl2" title="原文 : You can include these services in your application and control how those resources can be shared across origins.">これらのサービスをアプリケーションに組み込み、これらのリソースをオリジン間で共有する方法を制御できます。</span> </p>
...
<tr>
<td class=""><span class="merged" id="all.2aGlen" title="原文 : OpenAPI"><router-link to="/mp/openapi">OpenAPI</router-link></span></td>
...
<p><span class="merged" id="all.1M7j4x" title="原文 : The Helidon MP QuickStart example uses these services, so you can use that as a template for your own application, or use the example project itself to experiment with customizing the CORS behavior in the built-in services."><a href="https://github.com/oracle/helidon/tree/master/examples/quickstarts/helidon-quickstart-mp" target="_blank">「Helidon MP QuickStartの例」</a>ではこれらのサービスが使用されるため、独自のアプリケーションのテンプレートとして使用することも、サンプル・プロジェクト自体を使用して組込みサービスのCORS動作のカスタマイズを試すこともできます。</span></p>
