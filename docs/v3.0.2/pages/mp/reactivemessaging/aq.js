...
<div class="section">
<p><span class="merged" id="all.23QILI" title="原文 : To enable AQ Connector add the following dependency to your project&rsquo;s pom.xml (see Managing Dependencies).">AQコネクタを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<div class="section">
<p><span class="merged" id="all.2JUob4.spl1" title="原文 : Connecting streams to Oracle AQ with Reactive Messaging couldn&rsquo;t be easier.">リアクティブ・メッセージングを使用したOracle AQへのストリームの接続はより簡単にはできないでしょう。</span> <span class="merged" id="all.2JUob4.spl2" title="原文 : This connector extends Helidon&rsquo;s JMS connector with Oracle&rsquo;s AQ-specific API.">このコネクタは、OracleのAQ固有のAPIを使用してHelidonのJMSコネクタを拡張します。</span> </p>


<h3 id="_configuration"><span class="merged" id="all.Pfqvy.20"  title="原文:: Configuration">構成</span></h3>
<div class="section">
...
<tr>
<td class=""><span class="merged" id="all.xgZgv.2"  title="原文: password"><code>password</code></span></td>
