...
<div class="section">
<p><span class="merged" id="all.2ToW8R" title="原文 : To enable Reactive Kafka Connector add the following dependency to your project&rsquo;s pom.xml (see Managing Dependencies).">リアクティブKafkaコネクタを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<h2 id="_overview"><span class="merged" id="all.YrpRV.30"  title="原文:: Overview">概要</span></h2>
<div class="section">
...
<ul class="colist">
<li data-value="1"><span class="merged" id="all.4e457X" title="原文 : Kafka client consumer&rsquo;s property auto.offset.reset configuration for from-kafka channel only"><code>from-kafka</code>チャネルのKafkaクライアント・コンシューマのプロパティauto.offset.reset構成のみ</span></li>
<li data-value="2"><span class="merged" id="all.2t0BTW" title="原文 : Kafka client&rsquo;s property bootstrap.servers configuration for all channels using the connector">コネクタを使用するすべてのチャネルのKafkaクライアントのプロパティ<a href="https://kafka.apache.org/28/documentation.html#consumerconfigs_bootstrap.servers" target="_blank">bootstrap.servers</a>構成</span></li>
</ul>
...
<td class=""><span class="merged" id="all.4JM9z7.13"  title="原文:: Description">説明</span></td>
</tr>
<tr>
