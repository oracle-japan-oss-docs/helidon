...
<p><span class="merged" id="all.qyfSW" title="原文 : In Helidon 3.0.2, Micrometer support is separate from the Helidon MP metrics API and the built-in Helidon metrics.">Helidon 3.0.2では、マイクロメーターのサポートは、Helidon MPメトリクスAPIおよび組込みHelidonメトリクスとは異なります。</span></p>
...
<div class="section">
<p><span class="merged" id="all.4eQpnm" title="原文 : To enable Micrometer support add the following dependency to your project&rsquo;s pom.xml (see Managing Dependencies).">Micrometerサポートを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<h2 id="_usage"><span class="merged" id="all.JUOSC.14"  title="原文:: Usage">使用方法</span></h2>
<div class="section">
...
<p><span class="merged" id="all.1VPabO.1" title="原文 : Type: io.helidon.integrations.micrometer.MicrometerSupport">タイプ: <a href="./apidocs/io.helidon.integrations.micrometer/io/helidon/integrations/micrometer/MicrometerSupport.html" target="_blank">io.helidon.integrations.micrometer.MicrometerSupport</a></span></p>
...
<h3 id="_configuration_options"><span class="merged" id="all.3SKgM1.71"  title="原文:: Configuration options">構成オプション</span></h3>
<div class="section">
<div class="block-title"><span class="merged" id="all.271SGn.72" title="原文 : Optional configuration options"><span>オプションの構成オプション</span></span></div>
...
<thead>
<tr>
<th><span class="merged" id="all.2XKMH3.87"  title="原文:: key">キー</span></th>
<th><span class="merged" id="all.2ZwVVB.85"  title="原文:: type">type</span></th>
<th><span class="merged" id="all.G3u1e.87"  title="原文:: default value">デフォルト値</span></th>
<th><span class="merged" id="all.20ls8M.88"  title="原文:: description">説明</span></th>
</tr>
</thead>
<tbody>
<tr>
<td class=""><span class="merged" id="all.3UsoFV.12"  title="原文: cors"><code>cors</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.1Gn61H.12" title="原文 : CrossOriginConfig"><router-link to="/config/io_helidon_webserver_cors_CrossOriginConfig">CrossOriginConfig</router-link></span></p>

</doc-view>
</td>
<td class="">&#160;</td>
<td class=""><doc-view>
<p><span class="merged" id="all.4NniMS.7" title="原文 : Sets the cross-origin config builder for use in establishing CORS support for the service endpoints.">サービス・エンドポイントのCORSサポートの確立に使用するクロス・オリジン構成ビルダーを設定します。</span></p>

</doc-view>
</td>
</tr>
<tr>
<td class=""><span class="merged" id="all.2rpt0z.7"  title="原文: routing"><code>routing</code></span></td>
<td class=""><doc-view>
<p><span class="merged" id="all.2uEvOb.227"  title="原文:: string">文字列</span></p>

</doc-view>
</td>
<td class="">&#160;</td>
<td class=""><doc-view>
<p><span class="merged" id="all.1n2NdZ.7" title="原文 : Sets the routing name to use for setting up the service&rsquo;s endpoint.">サービスのエンドポイントの設定に使用するルーティング名を設定します。</span></p>
...
<td class=""><doc-view>
<p><span class="merged" id="all.2uEvOb.228"  title="原文:: string">文字列</span></p>

</doc-view>
</td>
<td class="">&#160;</td>
<td class=""><doc-view>
<p><span class="merged" id="all.3MWNIS.7" title="原文 : Sets the web context to use for the service&rsquo;s endpoint.">サービスのエンドポイントに使用するwebコンテキストを設定します。</span></p>
...
<div class="section">
<p><span class="merged" id="all.18zgu7" title="原文 : Helidon MP includes an example application which uses Micrometer support.">Helidon MPには、Micrometerサポートを使用する<a href="https://github.com/oracle/helidon/tree/master/examples/integrations/micrometer/mp" target="_blank">「サンプル・アプリケーション」</a>が含まれています。</span></p>
...
<p><span class="merged" id="all.j8Tsh.spl1" title="原文 : The configuration keys that are valid for the builtin-registries child entries depend on the type of Micrometer meter registry."><code>builtin-registries</code>の子エントリに対して有効な構成キーは、マイクロメーター・レジストリのタイプによって異なります。</span> <span class="merged" id="all.j8Tsh.spl2" title="原文 : For example, support in Helidon for the Prometheus meter registry respects the prefix configuration setting but other meter registries might not and might support other settings.">たとえば、<a href="https://javadoc.io/doc/io.micrometer/micrometer-registry-prometheus/1.6.6/io/micrometer/prometheus/PrometheusConfig.html" target="_blank">「Prometheusメーター・レジストリ」</a>に対するHelidonのサポートは<code>prefix</code>構成設定を尊重しますが、他のメーター・レジストリは他の設定をサポートしていない場合があります。</span> <span class="merged" id="all.j8Tsh.spl3" title="原文 : Refer to the documentation for the meter registry you want to configure to find out what items apply to that registry type.">構成するメーター・レジストリのドキュメントを参照して、そのレジストリ・タイプに適用される項目を確認してください。</span> </p>
