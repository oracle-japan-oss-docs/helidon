...
<h2 id="_contents"><span class="merged" id="all.1Q34Zl.1"  title="原文:: Contents">目次</span></h2>
<div class="section">
<ul class="ulist">
<li>
...
<div class="section">
<p><span class="merged" id="all.1pywOS.spl1" title="原文 : Helidon supports Bean Validation via its integration with JAX-RS/Jersey.">Helidonは、JAX-RS/Jerseyとの統合によるBeanバリデーションをサポートしています。</span> <span class="merged" id="all.1pywOS.spl2" title="原文 : The Jakarta Bean Validation specification defines an API to validate Java beans."><a href="https://jakarta.ee/specifications/bean-validation/2.0/bean-validation_2.0.html" target="_blank">「Jakarta Beanバリデーション仕様」</a>は、Java BeanをバリデートするAPIを定義します。</span> <span class="merged" id="all.1pywOS.spl3" title="原文 : Bean Validation is supported in REST resource classes as well as in regular application beans.">Beanバリデーションは、RESTリソース・クラスおよび通常のアプリケーションBeanでサポートされています。</span> </p>

<p><span class="merged" id="all.5nb9i.spl1" title="原文 : If bean validation is required outside JAX-RS/Jersey use cases, it is also available in Helidon.">JAX-RS/Jerseyユースケースの外部でBeanバリデーションが必要な場合は、Helidonでも使用できます。</span> <span class="merged" id="all.5nb9i.spl2" title="原文 : It follows the standard Jakarta Bean Validation specification which defines an API to validate Java beans.">これは、Java beansをバリデートするAPIを定義する標準の<a href="https://jakarta.ee/specifications/bean-validation/2.0/bean-validation_2.0.html" target="_blank">「Jakarta Beanバリデーション仕様」</a>に従います。</span> </p>
...
<div class="section">
<p><span class="merged" id="all.2MtXl4" title="原文 : To enable Bean Validation add the following dependency to your project&rsquo;s pom.xml (see Managing Dependencies).">Beanバリデーションを有効にするには、プロジェクトの<code>pom.xml</code>に次の依存関係を追加します(<router-link to="/about/managing-dependencies">「依存関係の管理」</router-link>を参照)。</span></p>
...
<p><span class="merged" id="all.1PKpRS" title="原文 : Examples are available in our official GitHub repository.">例は、<a href="https://github.com/oracle/helidon/tree/master}/examples/microprofile/bean-validation" target="_blank">「公式のGitHubリポジトリ」</a>にあります。</span></p>
...
<ul class="ulist">
<li>
<p><span class="merged" id="all.Fn8w5" title="原文 : Bean Validation Specification"><a href="https://jakarta.ee/specifications/bean-validation/2.0/bean-validation_2.0.html}" target="_blank">Beanバリデーション仕様</a></span></p>
