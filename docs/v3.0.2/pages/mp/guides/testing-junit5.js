...
<h2 id="_what_you_need"><span class="merged" id="all.27ZcMH.12"  title="原文:: What You Need">必要事項</span></h2>
<div class="section">
...
<tbody>
<tr>
<td class=""><span class="merged" id="all.3J4a7U.10" title="原文 : A Helidon MP Application">Helidon MPアプリケーション</span></td>
<td class=""><span class="merged" id="all.13muNj.10" title="原文 : You can use your own application or use the Helidon MP Quickstart to create a sample application.">独自のアプリケーションを使用するか、<router-link to="/mp/guides/quickstart">「Helidon MPクイックスタート」</router-link>を使用してサンプル・アプリケーションを作成できます。</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.2sRt9f.12" title="原文 : Java&#160;SE&#160;17 (Open&#160;JDK&#160;17)"><a href="https://www.oracle.com/technetwork/java/javase/downloads" target="_blank">Java&#160;SE&#160;17</a> (<a href="http://jdk.java.net" target="_blank">Open&#160;JDK&#160;17</a>)</span></td>
<td class=""><span class="merged" id="all.3aBChT.12" title="原文 : Helidon requires Java 17+.">HelidonにはJava 17以上が必要です。</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.1DYqqk.13" title="原文 : Maven 3.6.1+"><a href="https://maven.apache.org/download.cgi" target="_blank">Maven 3.6.1+</a></span></td>
<td class=""><span class="merged" id="all.3woDk0.12" title="原文 : Helidon requires Maven 3.6.1+.">Helidonには、Maven 3.6.1+が必要です。</span></td>
</tr>
<tr>
...
<div class="section">
<p><span class="merged" id="all.3bxUX" title="原文 : In this guide we will use the Helidon MP Quickstart project in our examples.">このガイドでは、例で<router-link to="/mp/guides/quickstart">「Helidon MPクイックスタート」</router-link>プロジェクトを使用します。</span></p>
...
<thead>
<tr>
<th><span class="merged" id="all.1mFIlG.2"  title="原文:: Annotation">注釈</span></th>
...
<ul class="ulist">
<li>
<p><span class="merged" id="all.1yTl5B" title="原文 : JUnit 5 User Guide"><a href="https://junit.org/junit5/docs/current/user-guide/" target="_blank">JUnit 5ユーザー・ガイド</a></span></p>

</li>
<li>
<p><span class="merged" id="all.1Jut0u" title="原文 : Testing with JUnit 5"><router-link to="/mp/testing">JUnit 5を使用したテスト</router-link></span></p>
