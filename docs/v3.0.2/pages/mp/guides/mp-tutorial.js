...
<tr>
<td class=""><span class="merged" id="all.2sRt9f.8" title="原文 : Java&#160;SE&#160;17 (Open&#160;JDK&#160;17)"><a href="https://www.oracle.com/technetwork/java/javase/downloads" target="_blank">Java&#160;SE&#160;17</a> (<a href="http://jdk.java.net" target="_blank">Open&#160;JDK&#160;17</a>)</span></td>
<td class=""><span class="merged" id="all.3aBChT.8" title="原文 : Helidon requires Java 17+.">HelidonにはJava 17以上が必要です。</span></td>
</tr>
<tr>
<td class=""><span class="merged" id="all.1DYqqk.9" title="原文 : Maven 3.6.1+"><a href="https://maven.apache.org/download.cgi" target="_blank">Maven 3.6.1+</a></span></td>
<td class=""><span class="merged" id="all.3woDk0.8" title="原文 : Helidon requires Maven 3.6.1+.">Helidonには、Maven 3.6.1+が必要です。</span></td>
</tr>
<tr>
...
<li data-value="2"><span class="merged" id="all.4ejqrE.spl1" title="原文 : The RequestScoped annotation defines that this bean is request scoped."><code>RequestScoped</code>注釈は、このBeanがリクエスト・スコープであることを定義します。</span> <span class="merged" id="all.4ejqrE.spl2" title="原文 : The request scope is active only for the duration of one web service invocation and it is destroyed at the end of that invocation.">リクエスト・スコープは、1つのwebサービス呼出しの間のみアクティブになり、その呼出しの最後に破棄されます。</span> <span class="merged" id="all.4ejqrE.spl3" title="原文 : You can learn more about scopes and contexts, and how they are used from the Specification.">スコープとコンテキスト、およびそれらの使用方法の詳細は、<a href="https://jakarta.ee/specifications/cdi/3.0/jakarta-cdi-spec-3.0.html" target="_blank">「仕様」</a>を参照してください。</span> </li>
...
<h2 id="_metrics"><span class="merged" id="all.4LL0ot.6"  title="原文:: Metrics">メトリクス</span></h2>
<div class="section">
...
>FROM maven:3.8.4-openjdk-17-slim as build <span class="conum" data-value="1" />
WORKDIR /helidon
...
FROM openjdk:17-jdk-slim <span class="conum" data-value="4" />
WORKDIR /helidon
...
<div class="section">
<p><span class="merged" id="all.178sc6.spl1" title="原文 : If you don&rsquo;t have access to a Kubernetes cluster, you can install one on your desktop.">Kubernetesクラスタにアクセスできない場合は、<router-link to="/about/kubernetes">「デスクトップにインストール」</router-link>を使用できます。</span> <span class="merged" id="all.178sc6.spl2" title="原文 : Then deploy the example:">次に、例をデプロイします:</span> </p>
...
<li>
<p><span class="merged" id="all.2uc25V" title="原文 : Contexts and Dependency Injection Specification"><a href="https://jakarta.ee/specifications/cdi/3.0/jakarta-cdi-spec-3.0.html" target="_blank">Contexts and Dependency Injection仕様</a></span></p>
